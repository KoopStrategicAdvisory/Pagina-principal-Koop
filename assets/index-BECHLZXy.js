 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(P,$){var Q=P.length;P.push($);e:for(;0<Q;){var se=Q-1>>>1,M=P[se];if(0<i(M,$))P[se]=$,P[Q]=M,Q=se;else break e}}function t(P){return P.length===0?null:P[0]}function a(P){if(P.length===0)return null;var $=P[0],Q=P.pop();if(Q!==$){P[0]=Q;e:for(var se=0,M=P.length,G=M>>>1;se<G;){var W=2*(se+1)-1,A=P[W],T=W+1,Y=P[T];if(0>i(A,Q))T<M&&0>i(Y,A)?(P[se]=Y,P[T]=Q,se=T):(P[se]=A,P[W]=Q,se=W);else if(T<M&&0>i(Y,Q))P[se]=Y,P[T]=Q,se=T;else break e}}return $}function i(P,$){var Q=P.sortIndex-$.sortIndex;return Q!==0?Q:P.id-$.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var s=Date,l=s.now();e.unstable_now=function(){return s.now()-l}}var c=[],d=[],p=1,u=null,g=3,y=!1,v=!1,x=!1,w=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,h=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function b(P){for(var $=t(d);$!==null;){if($.callback===null)a(d);else if($.startTime<=P)a(d),$.sortIndex=$.expirationTime,n(c,$);else break;$=t(d)}}function k(P){if(x=!1,b(P),!v)if(t(c)!==null)v=!0,ye(E);else{var $=t(d);$!==null&&Oe(k,$.startTime-P)}}function E(P,$){v=!1,x&&(x=!1,f(z),z=-1),y=!0;var Q=g;try{for(b($),u=t(c);u!==null&&(!(u.expirationTime>$)||P&&!ee());){var se=u.callback;if(typeof se=="function"){u.callback=null,g=u.priorityLevel;var M=se(u.expirationTime<=$);$=e.unstable_now(),typeof M=="function"?u.callback=M:u===t(c)&&a(c),b($)}else a(c);u=t(c)}if(u!==null)var G=!0;else{var W=t(d);W!==null&&Oe(k,W.startTime-$),G=!1}return G}finally{u=null,g=Q,y=!1}}var I=!1,L=null,z=-1,F=5,_=-1;function ee(){return!(e.unstable_now()-_<F)}function de(){if(L!==null){var P=e.unstable_now();_=P;var $=!0;try{$=L(!0,P)}finally{$?ce():(I=!1,L=null)}}else I=!1}var ce;if(typeof h=="function")ce=function(){h(de)};else if(typeof MessageChannel<"u"){var K=new MessageChannel,an=K.port2;K.port1.onmessage=de,ce=function(){an.postMessage(null)}}else ce=function(){w(de,0)};function ye(P){L=P,I||(I=!0,ce())}function Oe(P,$){z=w(function(){P(e.unstable_now())},$)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(P){P.callback=null},e.unstable_continueExecution=function(){v||y||(v=!0,ye(E))},e.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):F=0<P?Math.floor(1e3/P):5},e.unstable_getCurrentPriorityLevel=function(){return g},e.unstable_getFirstCallbackNode=function(){return t(c)},e.unstable_next=function(P){switch(g){case 1:case 2:case 3:var $=3;break;default:$=g}var Q=g;g=$;try{return P()}finally{g=Q}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(P,$){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var Q=g;g=P;try{return $()}finally{g=Q}},e.unstable_scheduleCallback=function(P,$,Q){var se=e.unstable_now();switch(typeof Q=="object"&&Q!==null?(Q=Q.delay,Q=typeof Q=="number"&&0<Q?se+Q:se):Q=se,P){case 1:var M=-1;break;case 2:M=250;break;case 5:M=1073741823;break;case 4:M=1e4;break;default:M=5e3}return M=Q+M,P={id:p++,callback:$,priorityLevel:P,startTime:Q,expirationTime:M,sortIndex:-1},Q>se?(P.sortIndex=Q,n(d,P),t(c)===null&&P===t(d)&&(x?(f(z),z=-1):x=!0,Oe(k,Q-se))):(P.sortIndex=M,n(c,P),v||y||(v=!0,ye(E))),P},e.unstable_shouldYield=ee,e.unstable_wrapCallback=function(P){var $=g;return function(){var Q=g;g=$;try{return P.apply(this,arguments)}finally{g=Q}}}})(dp);cp.exports=dp;var zf=cp.exports;/**
 * @license React
 ...
 *
 * @license MIT
 */function Aa(){return Aa=Object.assign?Object.assign.bind():function(e){for(var n=1;n<arguments.length;n++){var t=arguments[n];for(var a in t)Object.prototype.hasOwnProperty.call(t,a)&&(e[a]=t[a])}return e},Aa.apply(this,arguments)}const ac=m.createContext(null),cg=m.createContext(null),Or=m.createContext(null),mo=m.createContext(null),Dr=m.createContext({outlet:null,matches:[],isDataRoute:!1}),fh=m.createContext(null);function dg(e,n){let{relative:t}=n===void 0?{}:n;Pt()||Re(!1);let{basename:a,navigator:i}=m.useContext(Or),{hash:o,pathname:s,search:l}=gh(e,{relative:t}),c=s;return a!=="/"&&(c=s==="/"?a:Er([a,s])),i.createHref({pathname:c,search:l,hash:o})}function Pt(){return m.useContext(mo)!=null}function Vn(){return Pt()||Re(!1),m.useContext(mo).location}function mh(e){m.useContext(Or).static||m.useLayoutEffect(e)}function Lr(){let{isDataRoute:e}=m.useContext(Dr);return e?kg():pg()}function pg(){Pt()||Re(!1);let e=m.useContext(ac),{basename:n,future:t,navigator:a}=m.useContext(Or),{matches:i}=m.useContext(Dr),{pathname:o}=Vn(),s=JSON.stringify(rc(i,t.v7_relativeSplatPath)),l=m.useRef(!1);return mh(()=>{l.current=!0}),m.useCallback(function(d,p){if(p===void 0&&(p={}),!l.current)return;if(typeof d=="number"){a.go(d);return}let u=tc(d,JSON.parse(s),o,p.relative==="path");e==null&&n!=="/"&&(u.pathname=u.pathname==="/"?n:Er([n,u.pathname])),(p.replace?a.replace:a.push)(u,p.state,p)},[n,a,s,o,e])}function gh(e,n){let{relative:t}=n===void 0?{}:n,{future:a}=m.useContext(Or),{matches:i}=m.useContext(Dr),{pathname:o}=Vn(),s=JSON.stringify(rc(i,a.v7_relativeSplatPath));return m.useMemo(()=>tc(e,JSON.parse(s),o,t==="path"),[e,s,o,t])}function ug(e,n){return hg(e,n)}function hg(e,n,t,a){Pt()||Re(!1);let{navigator:i}=m.useContext(Or),{matches:o}=m.useContext(Dr),s=o[o.length-1],l=s?s.params:{};s&&s.pathname;let c=s?s.pathnameBase:"/";s&&s.route;let d=Vn(),p;if(n){var u;let w=typeof n=="string"?Lt(n):n;c==="/"||(u=w.pathname)!=null&&u.startsWith(c)||Re(!1),p=w}else p=d;let g=p.pathname||"/",y=g;if(c!=="/"){let w=c.replace(/^\//,"").split("/");y="/"+g.replace(/^\//,"").split("/").slice(w.length).join("/")}let v=B0(e,{pathname:y}),x=vg(v&&v.map(w=>Object.assign({},w,{params:Object.assign({},l,w.params),pathname:Er([c,i.encodeLocation?i.encodeLocation(w.pathname).pathname:w.pathname]),pathnameBase:w.pathnameBase==="/"?c:Er([c,i.encodeLocation?i.encodeLocation(w.pathnameBase).pathname:w.pathnameBase])})),o,t,a);return n&&x?m.createElement(mo.Provider,{value:{location:Aa({pathname:"/",search:"",hash:"",state:null,key:"default"},p),navigationType:vr.Pop}},x):x}function fg(){let e=jg(),n=sg(e)?e.status+" "+e.statusText:e instanceof Error?e.message:JSON.stringify(e),t=e instanceof Error?e.stack:null,i={padding:"0.5rem",backgroundColor:"rgba(200,200,200, 0.5)"};return m.createElement(m.Fragment,null,m.createElement("h2",null,"Unexpected Application Error!"),m.createElement("h3",{style:{fontStyle:"italic"}},n),t?m.createElement("pre",{style:i},t):null,null)}const mg=m.createElement(fg,null);class gg extends m.Component{constructor(n){super(n),this.state={location:n.location,revalidation:n.revalidation,error:n.error}}static getDerivedStateFromError(n){return{error:n}}static getDerivedStateFromProps(n,t){return t.location!==n.location||t.revalidation!=="idle"&&n.revalidation==="idle"?{error:n.error,location:n.location,revalidation:n.revalidation}:{error:n.error!==void 0?n.error:t.error,location:t.location,revalidation:n.revalidation||t.revalidation}}componentDidCatch(n,t){console.error("React Router caught the following error during render",n,t)}render(){return this.state.error!==void 0?m.createElement(Dr.Provider,{value:this.props.routeContext},m.createElement(fh.Provider,{value:this.state.error,children:this.props.component})):this.props.children}}function xg(e){let{routeContext:n,match:t,children:a}=e,i=m.useContext(ac);return i&&i.static&&i.staticContext&&(t.route.errorElement||t.route.ErrorBoundary)&&(i.staticContext._deepestRenderedBoundaryId=t.route.id),m.createElement(Dr.Provider,{value:n},a)}function vg(e,n,t,a){var i;if(n===void 0&&(n=[]),t===void 0&&(t=null),a===void 0&&(a=null),e==null){var o;if(!t)return null;if(t.errors)e=t.matches;else if((o=a)!=null&&o.v7_partialHydration&&n.length===0&&!t.initialized&&t.matches.length>0)e=t.matches;else return null}let s=e,l=(i=t)==null?void 0:i.errors;if(l!=null){let p=s.findIndex(u=>u.route.id&&(l==null?void 0:l[u.route.id])!==void 0);p>=0||Re(!1),s=s.slice(0,Math.min(s.length,p+1))}let c=!1,d=-1;if(t&&a&&a.v7_partialHydration)for(let p=0;p<s.length;p++){let u=s[p];if((u.route.HydrateFallback||u.route.hydrateFallbackElement)&&(d=p),u.route.id){let{loaderData:g,errors:y}=t,v=u.route.loader&&g[u.route.id]===void 0&&(!y||y[u.route.id]===void 0);if(u.route.lazy||v){c=!0,d>=0?s=s.slice(0,d+1):s=[s[0]];break}}}return s.reduceRight((p,u,g)=>{let y,v=!1,x=null,w=null;t&&(y=l&&u.route.id?l[u.route.id]:void 0,x=u.route.errorElement||mg,c&&(d<0&&g===0?(Cg("route-fallback"),v=!0,w=null):d===g&&(v=!0,w=u.route.hydrateFallbackElement||null)));let f=n.concat(s.slice(0,g+1)),h=()=>{let b;return y?b=x:v?b=w:u.route.Component?b=m.createElement(u.route.Component,null):u.route.element?b=u.route.element:b=p,m.createElement(xg,{match:u,routeContext:{outlet:p,matches:f,isDataRoute:t!=null},children:b})};return t&&(u.route.ErrorBoundary||u.route.errorElement||g===0)?m.createElement(gg,{location:t.location,revalidation:t.revalidation,component:x,error:y,children:h(),routeContext:{outlet:null,matches:f,isDataRoute:!0}}):h()},null)}var xh=function(e){return e.UseBlocker="useBlocker",e.UseRevalidator="useRevalidator",e.UseNavigateStable="useNavigate",e}(xh||{}),vh=function(e){return e.UseBlocker="useBlocker",e.UseLoaderData="useLoaderData",e.UseActionData="useActionData",e.UseRouteError="useRouteError",e.UseNavigation="useNavigation",e.UseRouteLoaderData="useRouteLoaderData",e.UseMatches="useMatches",e.UseRevalidator="useRevalidator",e.UseNavigateStable="useNavigate",e.UseRouteId="useRouteId",e}(vh||{});function bg(e){let n=m.useContext(ac);return n||Re(!1),n}function yg(e){let n=m.useContext(cg);return n||Re(!1),n}function wg(e){let n=m.useContext(Dr);return n||Re(!1),n}function bh(e){let n=wg(),t=n.matches[n.matches.length-1];return t.route.id||Re(!1),t.route.id}function jg(){var e;let n=m.useContext(fh),t=yg(),a=bh();return n!==void 0?n:(e=t.errors)==null?void 0:e[a]}function kg(){let{router:e}=bg(xh.UseNavigateStable),n=bh(vh.UseNavigateStable),t=m.useRef(!1);return mh(()=>{t.current=!0}),m.useCallback(function(i,o){o===void 0&&(o={}),t.current&&(typeof i=="number"?e.navigate(i):e.navigate(i,Aa({fromRouteId:n},o)))},[e,n])}const Cd={};function Cg(e,n,t){Cd[e]||(Cd[e]=!0)}function Ng(e,n){e==null||e.v7_startTransition,e==null||e.v7_relativeSplatPath}function Fe(e){let{to:n,replace:t,state:a,relative:i}=e;Pt()||Re(!1);let{future:o,static:s}=m.useContext(Or),{matches:l}=m.useContext(Dr),{pathname:c}=Vn(),d=Lr(),p=tc(n,rc(l,o.v7_relativeSplatPath),c,i==="path"),u=JSON.stringify(p);return m.useEffect(()=>d(JSON.parse(u),{replace:t,state:a,relative:i}),[d,u,i,t,a]),null}function oe(e){Re(!1)}function Sg(e){let{basename:n="/",children:t=null,location:a,navigationType:i=vr.Pop,navigator:o,static:s=!1,future:l}=e;Pt()&&Re(!1);let c=n.replace(/^\/*/,"/"),d=m.useMemo(()=>({basename:c,navigator:o,static:s,future:Aa({v7_relativeSplatPath:!1},l)}),[c,l,o,s]);typeof a=="string"&&(a=Lt(a));let{pathname:p="/",search:u="",hash:g="",state:y=null,key:v="default"}=a,x=m.useMemo(()=>{let w=nc(p,c);return w==null?null:{location:{pathname:w,search:u,hash:g,state:y,key:v},navigationType:i}},[c,p,u,g,y,v,i]);return x==null?null:m.createElement(Or.Provider,{value:d},m.createElement(mo.Provider,{children:t,value:x}))}function Eg(e){let{children:n,location:t}=e;return ug(qs(n),t)}new Promise(()=>{});function qs(e,n){n===void 0&&(n=[]);let t=[];return m.Children.forEach(e,(a,i)=>{if(!m.isValidElement(a))return;let o=[...n,i];if(a.type===m.Fragment){t.push.apply(t,qs(a.props.children,o));return}a.type!==oe&&Re(!1),!a.props.index||!a.props.children||Re(!1);let s={id:a.props.id||o.join("-"),caseSensitive:a.props.caseSensitive,element:a.props.element,Component:a.props.Component,index:a.props.index,path:a.props.path,loader:a.props.loader,action:a.props.action,errorElement:a.props.errorElement,ErrorBoundary:a.props.ErrorBoundary,hasErrorBoundary:a.props.ErrorBoundary!=null||a.props.errorElement!=null,shouldRevalidate:a.props.shouldRevalidate,handle:a.props.handle,lazy:a.props.lazy};a.props.children&&(s.children=qs(a.props.children,o)),t.push(s)}),t}/**
...
`+o):a.stack=o}catch{}}throw a}}_request(n,t){typeof n=="string"?(t=t||{},t.url=n):t=n||{},t=Jr(this.defaults,t);const{transitional:a,paramsSerializer:i,headers:o}=t;a!==void 0&&ki.assertOptions(a,{silentJSONParsing:Zn.transitional(Zn.boolean),forcedJSONParsing:Zn.transitional(Zn.boolean),clarifyTimeoutError:Zn.transitional(Zn.boolean)},!1),i!=null&&(N.isFunction(i)?t.paramsSerializer={serialize:i}:ki.assertOptions(i,{encode:Zn.function,serialize:Zn.function},!0)),t.allowAbsoluteUrls!==void 0||(this.defaults.allowAbsoluteUrls!==void 0?t.allowAbsoluteUrls=this.defaults.allowAbsoluteUrls:t.allowAbsoluteUrls=!0),ki.assertOptions(t,{baseUrl:Zn.spelling("baseURL"),withXsrfToken:Zn.spelling("withXSRFToken")},!0),t.method=(t.method||this.defaults.method||"get").toLowerCase();let s=o&&N.merge(o.common,o[t.method]);o&&N.forEach(["delete","get","head","post","put","patch","common"],v=>{delete o[v]}),t.headers=un.concat(s,o);const l=[];let c=!0;this.interceptors.request.forEach(function(x){typeof x.runWhen=="function"&&x.runWhen(t)===!1||(c=c&&x.synchronous,l.unshift(x.fulfilled,x.rejected))});const d=[];this.interceptors.response.forEach(function(x){d.push(x.fulfilled,x.rejected)});let p,u=0,g;if(!c){const v=[Vd.bind(this),void 0];for(v.unshift(...l),v.push(...d),g=v.length,p=Promise.resolve(t);u<g;)p=p.then(v[u++],v[u++]);return p}g=l.length;let y=t;for(u=0;u<g;){const v=l[u++],x=l[u++];try{y=v(y)}catch(w){x.call(this,w);break}}try{p=Vd.call(this,y)}catch(v){return Promise.reject(v)}for(u=0,g=d.length;u<g;)p=p.then(d[u++],d[u++]);return p}getUri(n){n=Jr(this.defaults,n);const t=_h(n.baseURL,n.url,n.allowAbsoluteUrls);return Oh(t,n.params,n.paramsSerializer)}};N.forEach(["delete","get","head","options"],function(n){Wr.prototype[n]=function(t,a){return this.request(Jr(a||{},{method:n,url:t,data:(a||{}).data}))}});N.forEach(["post","put","patch"],function(n){function t(a){return function(o,s,l){return this.request(Jr(l||{},{method:n,headers:a?{"Content-Type":"multipart/form-data"}:{},url:o,data:s}))}}Wr.prototype[n]=t(),Wr.prototype[n+"Form"]=t(!0)});let Yx=class Kh{constructor(n){if(typeof n!="function")throw new TypeError("executor must be a function.");let t;this.promise=new Promise(function(o){t=o});const a=this;this.promise.then(i=>{if(!a._listeners)return;let o=a._listeners.length;for(;o-- >0;)a._listeners[o](i);a._listeners=null}),this.promise.then=i=>{let o;const s=new Promise(l=>{a.subscribe(l),o=l}).then(i);return s.cancel=function(){a.unsubscribe(o)},s},n(function(o,s,l){a.reason||(a.reason=new _t(o,s,l),t(a.reason))})}throwIfRequested(){if(this.reason)throw this.reason}subscribe(n){if(this.reason){n(this.reason);return}this._listeners?this._listeners.push(n):this._listeners=[n]}unsubscribe(n){if(!this._listeners)return;const t=this._listeners.indexOf(n);t!==-1&&this._listeners.splice(t,1)}toAbortSignal(){const n=new AbortController,t=a=>{n.abort(a)};return this.subscribe(t),n.signal.unsubscribe=()=>this.unsubscribe(t),n.signal}static source(){let n;return{token:new Kh(function(i){n=i}),cancel:n}}};function Gx(e){return function(t){return e.apply(null,t)}}function Jx(e){return N.isObject(e)&&e.isAxiosError===!0}const rl={Continue:100,SwitchingProtocols:101,Processing:102,EarlyHints:103,Ok:200,Created:201,Accepted:202,NonAuthoritativeInformation:203,NoContent:204,ResetContent:205,PartialContent:206,MultiStatus:207,AlreadyReported:208,ImUsed:226,MultipleChoices:300,MovedPermanently:301,Found:302,SeeOther:303,NotModified:304,UseProxy:305,Unused:306,TemporaryRedirect:307,PermanentRedirect:308,BadRequest:400,Unauthorized:401,PaymentRequired:402,Forbidden:403,NotFound:404,MethodNotAllowed:405,NotAcceptable:406,ProxyAuthenticationRequired:407,RequestTimeout:408,Conflict:409,Gone:410,LengthRequired:411,PreconditionFailed:412,PayloadTooLarge:413,UriTooLong:414,UnsupportedMediaType:415,RangeNotSatisfiable:416,ExpectationFailed:417,ImATeapot:418,MisdirectedRequest:421,UnprocessableEntity:422,Locked:423,FailedDependency:424,TooEarly:425,UpgradeRequired:426,PreconditionRequired:428,TooManyRequests:429,RequestHeaderFieldsTooLarge:431,UnavailableForLegalReasons:451,InternalServerError:500,NotImplemented:501,BadGateway:502,ServiceUnavailable:503,GatewayTimeout:504,HttpVersionNotSupported:505,VariantAlsoNegotiates:506,InsufficientStorage:507,LoopDetected:508,NotExtended:510,NetworkAuthenticationRequired:511};Object.entries(rl).forEach(([e,n])=>{rl[n]=e});function Wh(e){const n=new Wr(e),t=wh(Wr.prototype.request,n);return N.extend(t,Wr.prototype,n,{allOwnKeys:!0}),N.extend(t,n,null,{allOwnKeys:!0}),t.create=function(i){return Wh(Jr(e,i))},t}const Ee=Wh(_a);Ee.Axios=Wr;Ee.CanceledError=_t;Ee.CancelToken=Yx;Ee.isCancel=Ph;Ee.VERSION=Zh;Ee.toFormData=bo;Ee.AxiosError=re;Ee.Cancel=Ee.CanceledError;Ee.all=function(n){return Promise.all(n)};Ee.spread=Gx;Ee.isAxiosError=Jx;Ee.mergeConfig=Jr;Ee.AxiosHeaders=un;Ee.formToJSON=e=>Lh(N.isHTMLForm(e)?new FormData(e):e);Ee.getAdapter=Uh.getAdapter;Ee.HttpStatusCode=rl;Ee.default=Ee;const{Axios:t2,AxiosError:a2,CanceledError:i2,isCancel:o2,CancelToken:s2,VERSION:l2,all:c2,Cancel:d2,isAxiosError:p2,spread:u2,toFormData:h2,AxiosHeaders:f2,HttpStatusCode:m2,formToJSON:g2,getAdapter:x2,mergeConfig:v2}=Ee,$h="https://koop-api-a28ac382dd56.herokuapp.com/api",je=Ee.create({baseURL:$h,withCredentials:!0}),Qx=Ee.create({baseURL:$h,withCredentials:!0});let es=!1,tl=[];function Xx(e){tl.push(e)}function ev(e){tl.forEach(n=>{try{n(e)}catch{}}),tl=[]}function nv({getAccessToken:e,setAccessToken:n,onLogout:t}){je.interceptors.request.use(a=>{var i,o;try{let s;try{s=e==null?void 0:e()}catch{}if(!s&&typeof window<"u")try{s=(i=window.localStorage)==null?void 0:i.getItem("accessToken")}catch{}s&&!((o=a.headers)!=null&&o.Authorization)&&(a.headers=a.headers||{},a.headers.Authorization=`Bearer ${s}`)}catch(s){console.error("[axios] Request interceptor error:",s)}return a}),je.interceptors.response.use(a=>a,async a=>{var p,u;const{response:i,config:o}=a||{},s=i==null?void 0:i.status,l=o||{},c=String((l==null?void 0:l.url)||""),d=c.includes("/auth/login")||c.includes("/auth/register")||c.includes("/auth/refresh");if(s!==401||d||l._retry)return Promise.reject(a);if(l._retry=!0,es)return new Promise((g,y)=>{Xx(v=>{try{l.headers=l.headers||{},v&&(l.headers.Authorization=`Bearer ${v}`),g(je(l))}catch(x){y(x)}})});es=!0;try{const g=await Qx.post("/auth/refresh"),y=(p=g==null?void 0:g.data)==null?void 0:p.accessToken;if(!y)throw new Error("No accessToken in refresh");try{n==null||n(y)}catch{}return ev(y),l.headers=l.headers||{},l.headers.Authorization=`Bearer ${y}`,je(l)}catch(g){const y=(u=g==null?void 0:g.response)==null?void 0:u.status;if(y===401||y===403)try{await(t==null?void 0:t())}catch{}return Promise.reject(g)}finally{es=!1}})}const Hh=m.createContext(null),Fd=["admin","user"];function al(e,{defaultRole:n="user"}={}){const t=String(n||"user").trim().toLowerCase(),a=Fd.includes(t)?t:"user",o=(Array.isArray(e)?e:[e]).map(s=>String(s||"").trim().toLowerCase()).filter(s=>Fd.includes(s));return o.includes("admin")?["admin"]:o.includes("user")?["user"]:[a]}function si(e){try{const n=e.split(".")[1],t=atob(n.replace(/-/g,"+").replace(/_/g,"/"));return JSON.parse(t)}catch{return null}}function li(e,n){return e?{id:e.sub,name:e.name,email:e.email,roles:al(e.roles),active:e.active!==!1,driveFolders:e.driveFolders||[]}:n?{id:n.id,name:n.name,email:n.email,roles:al(n.roles),active:n.active!==!1,driveFolders:n.driveFolders||[]}:null}function rv({children:e}){const[n,t]=m.useState(()=>localStorage.getItem("accessToken")||null),[a,i]=m.useState(()=>{const y=localStorage.getItem("accessToken");if(!y)return null;const v=si(y);return li(v,null)}),[o,s]=m.useState(!1),l=!!n;m.useEffect(()=>{if(!n)localStorage.removeItem("accessToken"),i(null);else{localStorage.setItem("accessToken",n);const y=si(n);y&&i(li(y,null))}},[n]);const c=async(y,v)=>{s(!0);try{const{accessToken:x,user:w}=await y1({email:y,password:v});t(x);const f=si(x);return i(li(f,w)),{ok:!0}}catch(x){return{ok:!1,error:x.message}}finally{s(!1)}},d=async(y,v,x,w)=>{s(!0);try{const f=Array.isArray(w)&&w.length>0,h=await v1({name:y,email:v,password:x,roles:f?al(w):void 0});if(h!=null&&h.accessToken){t(h.accessToken);const b=si(h.accessToken);i(li(b,h.user))}return{ok:!0,data:h}}catch(f){return{ok:!1,error:f.message}}finally{s(!1)}},p=async()=>{try{await w1()}catch{}finally{t(null),i(null)}},u=m.useMemo(()=>({accessToken:n,user:a,isAuthenticated:l,loading:o,login:c,register:d,logout:p,refresh:b1}),[n,a,l,o]),g=m.useRef(!1);return m.useEffect(()=>{g.current||(nv({getAccessToken:()=>n,setAccessToken:y=>t(y),onLogout:()=>p()}),g.current=!0)},[]),r.jsx(Hh.Provider,{value:u,children:e})}function We(){const e=m.useContext(Hh);if(!e)throw new Error("useAuth debe usarse dentro de AuthProvider");return e}const qh="/assets/Koop%20Logo-DEFOyNWT.png";function tv(){var g,y;const{login:e,loading:n}=We(),t=Lr(),i=((y=(g=Vn().state)==null?void 0:g.from)==null?void 0:y.pathname)||"/dashboard",[o,s]=m.useState(""),[l,c]=m.useState(""),[d,p]=m.useState(""),u=async v=>{v.preventDefault(),p(""),console.log("Submitting login form, Hola q ac",o);const x=await e(o,l);if(!x.ok){p(x.error||"Error al iniciar sesión");return}t(i,{replace:!0})};return m.useEffect(()=>(document.body.classList.add("no-scroll"),()=>{document.body.classList.remove("no-scroll")}),[]),r.jsxs("div",{className:"auth-page",children:[r.jsx("video",{className:"auth-bg-video",autoPlay:!0,muted:!0,loop:!0,playsInline:!0,preload:"auto",children:r.jsx("source",{src:"/KoopCentroInternacional.mp4",type:"video/mp4"})}),r.jsx("div",{className:"auth-bg-overlay"}),r.jsxs("div",{className:"auth-card",children:[r.jsx(D,{to:"/",children:r.jsx("img",{src:qh,alt:"Logo KOOP",className:"logo"})}),r.jsx("h2",{children:"Login KOOP"}),d&&r.jsx("div",{className:"auth-error",children:d}),r.jsxs("form",{onSubmit:u,children:[r.jsxs("div",{className:"input-group",children:[r.jsx("label",{htmlFor:"email",children:"Correo"}),r.jsx("input",{id:"email",type:"email",placeholder:"Ingrese su correo",value:o,onChange:v=>s(v.target.value),required:!0})]}),r.jsxs("div",{className:"input-group",children:[r.jsx("label",{htmlFor:"password",children:"Contraseña"}),r.jsx("input",{id:"password",type:"password",placeholder:"Ingrese su contraseña",value:l,onChange:v=>c(v.target.value),required:!0})]}),r.jsx("button",{type:"submit",className:"login-button",disabled:n,children:n?"Ingresando...":"Iniciar sesión"})]}),r.jsxs("div",{className:"auth-actions",children:["¿No tienes cuenta? ",r.jsx(D,{to:"/register",children:"Regístrate"})," · ",r.jsx(D,{to:"/",children:"Volver al inicio"})]})]})]})}function av(){const[e,n]=m.useState({name:"",email:"",password:""}),[t,a]=m.useState(!1),[i,o]=m.useState(""),[s,l]=m.useState(""),{register:c}=We(),d=Lr(),p=g=>n({...e,[g.target.name]:g.target.value}),u=async g=>{g.preventDefault(),o(""),l(""),a(!0);try{const y=await c(e.name,e.email,e.password);if(y.ok){const v=y.data||{ok:!0};v!=null&&v.accessToken?d("/dashboard"):(l("Tu registro fue recibido. Un administrador activara tu cuenta y te avisaremos por correo."),n({name:"",email:"",password:""}))}else o(y.error||"Error en registro")}catch(y){const v=(y==null?void 0:y.message)||"Error en registro";o(v)}finally{a(!1)}};return m.useEffect(()=>(document.body.classList.add("no-scroll"),()=>{document.body.classList.remove("no-scroll")}),[]),r.jsxs("div",{className:"auth-page",children:[r.jsx("video",{className:"auth-bg-video",autoPlay:!0,muted:!0,loop:!0,playsInline:!0,preload:"auto",children:r.jsx("source",{src:"/KoopCentroInternacional.mp4",type:"video/mp4"})}),r.jsx("div",{className:"auth-bg-overlay"}),r.jsxs("div",{className:"auth-card",children:[r.jsx("img",{src:qh,alt:"Logo KOOP",className:"logo"}),r.jsx("h2",{children:"Crear Cuenta"}),i&&r.jsx("div",{className:"auth-error",children:i}),s&&r.jsx("div",{className:"auth-info",children:s}),r.jsxs("form",{onSubmit:u,children:[r.jsxs("div",{className:"input-group",children:[r.jsx("label",{htmlFor:"name",children:"Nombre"}),r.jsx("input",{id:"name",name:"name",type:"text",placeholder:"Tu nombre",value:e.name,onChange:p})]}),r.jsxs("div",{className:"input-group",children:[r.jsx("label",{htmlFor:"email",children:"Correo"}),r.jsx("input",{id:"email",name:"email",type:"email",placeholder:"tu@email.com",value:e.email,onChange:p,required:!0})]}),r.jsxs("div",{className:"input-group",children:[r.jsx("label",{htmlFor:"password",children:"Contrasena"}),r.jsx("input",{id:"password",name:"password",type:"password",placeholder:"Minimo 8 caracteres",value:e.password,onChange:p,required:!0})]}),r.jsx("button",{type:"submit",className:"login-button",disabled:t,children:t?"Creando...":"Registrarme"})]}),r.jsxs("div",{className:"auth-actions",children:["Ya tienes cuenta? ",r.jsx(D,{to:"/login",children:"Inicia sesion"})]})]})]})}function iv(e){return e!=null&&e.roles?(Array.isArray(e.roles)?e.roles:[e.roles]).map(n=>String(n||"").toLowerCase()).includes("admin"):!1}function ov(){const{user:e,logout:n}=We(),t=iv(e);return e?r.jsxs("div",{style:{padding:24,display:"flex",flexDirection:"column",gap:16},children:[r.jsx("h1",{children:"Panel Privado"}),r.jsxs("div",{children:[r.jsxs("p",{children:["Bienvenido: ",e.email]}),r.jsxs("p",{children:["Roles: ",Array.isArray(e.roles)?e.roles.join(", "):"N/A"]}),r.jsxs("p",{children:["Estado: ",e.active===!1?"Inactivo":"Activo"]})]}),t&&r.jsx("div",{style:{display:"flex",gap:12},children:r.jsx(D,{className:"btn btn-primary",to:"/admin/usuarios",children:"Gestionar usuarios"})}),r.jsx("div",{children:r.jsx("button",{className:"btn btn-secondary",onClick:n,children:"Cerrar sesion"})})]}):r.jsxs("div",{style:{padding:24},children:[r.jsx("h1",{children:"Panel Privado"}),r.jsx("p",{children:"No hay usuario."})]})}async function Yh(){const{data:e}=await je.get("/admin/users");return e}async function sv(e,n){const{data:t}=await je.patch(`/admin/users/${e}/active`,{active:n});return t}async function lv(e){const{data:n}=await je.post(`/admin/users/${e}/grant-admin`);return n}async function cv(e){const{data:n}=await je.post(`/admin/users/${e}/revoke-admin`);return n}async function dv(e){const{data:n}=await je.delete(`/admin/users/${e}`);return n}async function lc(){const{data:e}=await je.get("/admin/clients/active");return e}async function pv(e,n){const{data:t}=await je.patch(`/admin/clients/${e}`,n);return t}async function uv(e,n){const{data:t}=await je.patch(`/admin/clients/${e}/assign`,{adminUserId:n});return t}async function hv(e,n){const{data:t}=await je.post(`/admin/clients/from-user/${e}`,n);return t}async function fv(e,n){const t={};n&&(t["x-delete-pass"]=n);const{data:a}=await je.delete(`/admin/clients/${e}`,{headers:t});return a}const Ud={success:{bg:"#064e3b",fg:"#a7f3d0",border:"rgba(16,185,129,0.35)"},danger:{bg:"#7f1d1d",fg:"#fecaca",border:"rgba(248,113,113,0.35)"}};function Gh({kind:e="success",children:n,autoHideMs:t,onClose:a,style:i,className:o}){const[s,l]=m.useState(!1);m.useEffect(()=>{const u=setTimeout(()=>l(!0),10);return()=>clearTimeout(u)},[]),m.useEffect(()=>{if(!t)return;const u=setTimeout(()=>{l(!1);const g=setTimeout(()=>a==null?void 0:a(),220);return()=>clearTimeout(g)},t);return()=>clearTimeout(u)},[t,a]);const c=Ud[e]||Ud.success,d={background:c.bg,color:c.fg,border:`1px solid ${c.border}`,padding:12,borderRadius:8,marginBottom:16,boxShadow:"0 6px 18px rgba(0,0,0,0.25) inset",transition:"opacity 200ms ease, transform 200ms ease",opacity:s?1:0,transform:s?"translateY(0)":"translateY(-6px)",display:"flex",alignItems:"center",justifyContent:"space-between",gap:10},p=()=>{l(!1),setTimeout(()=>a==null?void 0:a(),200)};return r.jsxs("div",{role:"alert",className:o,style:{...d,...i||{}},children:[r.jsx("div",{style:{lineHeight:1.4},children:n}),a&&r.jsx("button",{type:"button",onClick:p,"aria-label":"Cerrar aviso",style:{background:"transparent",color:c.fg,border:"none",fontSize:18,lineHeight:1,cursor:"pointer",padding:"2px 4px"},children:"×"})]})}function Jh(e){return r.jsx(Gh,{kind:"success",...e})}function Ji(e){return r.jsx(Gh,{kind:"danger",...e})}const Qh={background:"#1b263b",color:"#e2e8f0",border:"1px solid rgba(148,163,184,0.35)",borderRadius:8,padding:"8px 10px"};function Xh({children:e,style:n}){return r.jsx("div",{style:{display:"grid",gap:10,...n||{}},children:e})}function il({children:e,cols:n=2,style:t}){return r.jsx("div",{style:{display:"grid",gap:10,gridTemplateColumns:`repeat(${n}, 1fr)`,...t||{}},children:e})}function Dn({label:e,type:n="text",value:t,onChange:a,placeholder:i,readOnly:o,inputProps:s,children:l}){return r.jsxs("label",{style:{display:"grid",gap:6},children:[e!=null&&r.jsx("span",{children:e}),l||r.jsx("input",{type:n,value:t,onChange:a,placeholder:i,readOnly:o,style:Qh,...s||{}})]})}function mv({label:e,value:n,onChange:t,rows:a=3,placeholder:i,textareaProps:o}){return r.jsxs("label",{style:{display:"grid",gap:6},children:[e!=null&&r.jsx("span",{children:e}),r.jsx("textarea",{rows:a,value:n,onChange:t,placeholder:i,style:{...Qh,resize:"vertical"},...o||{}})]})}const Zd=["admin","user"];function at(e,{defaultRole:n="user"}={}){const t=String(n||"user").trim().toLowerCase(),a=Zd.includes(t)?t:"user",o=(Array.isArray(e)?e:[e]).map(s=>String(s||"").trim().toLowerCase()).filter(s=>Zd.includes(s));return o.includes("admin")?["admin"]:o.includes("user")?["user"]:[a]}function gv(e){return at(e==null?void 0:e.roles).includes("admin")}function xv(){const{user:e}=We(),n=gv(e),[t,a]=m.useState([]),[i,o]=m.useState(!1),[s,l]=m.useState(null),[c,d]=m.useState(null),[p,u]=m.useState(null),[g,y]=m.useState(null),[v,x]=m.useState(null),[w,f]=m.useState(!1),[h,b]=m.useState(null),[k,E]=m.useState(null),[I,L]=m.useState(!0),[z,F]=m.useState(!1),[_,ee]=m.useState(""),[de,ce]=m.useState(null),K=e==null?void 0:e.id,an=async()=>{var M,G;if(n){o(!0),l(null);try{const W=await Yh();a(Array.isArray(W==null?void 0:W.items)?W.items.map(A=>({...A,roles:at(A.roles)})):[])}catch(W){l(((G=(M=W==null?void 0:W.response)==null?void 0:M.data)==null?void 0:G.message)||(W==null?void 0:W.message)||"No se pudo cargar la lista")}finally{o(!1)}}};m.useEffect(()=>{an()},[n]);const ye=async(M,G)=>{var W,A;try{d(M),await sv(M,G),a(T=>T.map(Y=>Y.id===M?{...Y,active:G}:Y))}catch(T){l(((A=(W=T==null?void 0:T.response)==null?void 0:W.data)==null?void 0:A.message)||(T==null?void 0:T.message)||"No se pudo actualizar el usuario")}finally{d(null)}},Oe=async M=>{var W,A;if(window.confirm("Deseas otorgar rol de administrador a este usuario?"))try{l(null),u(M);const T=await lv(M);T!=null&&T.user&&a(Y=>Y.map(pe=>pe.id===M?{...pe,...T.user,roles:at(T.user.roles)}:pe))}catch(T){l(((A=(W=T==null?void 0:T.response)==null?void 0:W.data)==null?void 0:A.message)||(T==null?void 0:T.message)||"No se pudo actualizar los roles")}finally{u(null)}},P=async M=>{var W,A;if(window.confirm("Deseas quitar el rol de administrador a este usuario?"))try{l(null),u(M);const T=await cv(M);T!=null&&T.user&&a(Y=>Y.map(pe=>pe.id===M?{...pe,...T.user,roles:at(T.user.roles)}:pe))}catch(T){l(((A=(W=T==null?void 0:T.response)==null?void 0:W.data)==null?void 0:A.message)||(T==null?void 0:T.message)||"No se pudo actualizar los roles")}finally{u(null)}},$=async M=>{var W,A;if(window.confirm("Deseas eliminar este usuario? Esta accion es permanente."))try{y(M),await dv(M),a(T=>T.filter(Y=>Y.id!==M))}catch(T){l(((A=(W=T==null?void 0:T.response)==null?void 0:W.data)==null?void 0:A.message)||(T==null?void 0:T.message)||"No se pudo eliminar el usuario")}finally{y(null)}},Q=M=>{b(null),x({userId:M.id,fullName:M.name||"",documentType:"",documentNumber:"",birthDate:"",phone:"",email:M.email||"",address:"",contactInfo:""})},se=async()=>{var M,G;if(v!=null&&v.userId){b(null);try{f(!0);const W={fullName:String(v.fullName||"").trim(),documentType:String(v.documentType||"").trim(),documentNumber:String(v.documentNumber||"").trim(),birthDate:v.birthDate?new Date(v.birthDate).toISOString():void 0,phone:String(v.phone||"").trim(),email:String(v.email||"").trim(),address:String(v.address||"").trim(),contactInfo:String(v.contactInfo||"").trim()};if(!W.fullName){b("El nombre completo es requerido"),f(!1);return}await hv(v.userId,W),x(null);try{clearTimeout(se._t)}catch{}ce("Cliente creado y carpeta asignada"),se._t=setTimeout(()=>ce(null),3500);try{window.scrollTo({top:0,behavior:"smooth"})}catch{}}catch(W){b(((G=(M=W==null?void 0:W.response)==null?void 0:M.data)==null?void 0:G.message)||(W==null?void 0:W.message)||"No se pudo crear el cliente")}finally{f(!1)}}};return n?r.jsxs("div",{className:"dash-page",style:{backgroundImage:"linear-gradient(rgba(13,27,42,0.65), rgba(27,38,59,0.65)), url('/fondodashboard.jpg')",backgroundSize:"cover",backgroundAttachment:"fixed",backgroundPosition:"center",paddingLeft:16,paddingRight:16,paddingBottom:16},children:[r.jsxs("div",{className:"dash-card",style:{width:"100%",maxWidth:1200},children:[r.jsx("style",{children:`
        ...
        `}),r.jsxs("div",{className:"dash-header",style:{marginBottom:16,gap:12},children:[r.jsx("div",{className:"dash-title",children:"Administrar usuarios"}),r.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[r.jsx("input",{className:"input",placeholder:"Buscar por nombre, cédula o correo",value:_,onChange:M=>ee(M.target.value),style:{width:260}}),_&&r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>ee(""),children:"Limpiar"}),r.jsx("button",{className:"btn btn-secondary",onClick:an,disabled:i,children:i?"Actualizando...":"Refrescar"})]})]}),de&&r.jsx(Jh,{autoHideMs:3500,children:de}),s&&r.jsx(Ji,{children:s}),(()=>{const M=j=>String(j||"").toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,""),G=M(_),W=j=>{if(!G)return!0;const Z=[j.document,j.documentNumber,j.cedula,j.dni,j.idNumber,j.numeroDocumento];return[j.name,j.email,...Z].some(Be=>M(Be).includes(G))},A=t.filter(W),T=(j,Z)=>{const te=j!=null&&j.createdAt?new Date(j.createdAt).getTime():0;return(Z!=null&&Z.createdAt?new Date(Z.createdAt).getTime():0)-te},Y=j=>(j==null?void 0:j.active)===!1||(j==null?void 0:j.isActive)===!1,pe=A.filter(Y).sort(T),ge=A.filter(j=>!Y(j)).sort(T),R=j=>{const Z=j.createdAt?new Date(j.createdAt):null,te=at(j.roles),Be=te.includes("admin"),ae=j.active!==!1&&j.isActive!==!1,$e=K===j.id,Qe=te.length>0?te.join(", "):"-";return r.jsxs("tr",{children:[r.jsx("td",{children:j.name||"-"}),r.jsx("td",{children:j.email}),r.jsx("td",{children:Qe}),r.jsx("td",{children:r.jsx("span",{className:`me-badge ${ae?"me-badge-success":"me-badge-error"}`,children:ae?"Activo":"Inactivo"})}),r.jsx("td",{children:Z?Z.toLocaleString():"-"}),r.jsx("td",{children:r.jsxs("div",{style:{display:"flex",flexWrap:"wrap",gap:8},children:[r.jsx("button",{className:"btn btn-primary btn-sm",onClick:()=>ye(j.id,!ae),disabled:c===j.id,children:c===j.id?"Guardando...":ae?"Desactivar":"Activar"}),r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>Q(j),children:"Convertir a cliente"}),Be?r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>P(j.id),disabled:p===j.id||$e,title:$e?"No puedes modificar tu propio rol":"Quitar rol admin",children:p===j.id?"Quitando...":"Quitar admin"}):r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>Oe(j.id),disabled:p===j.id,children:p===j.id?"Asignando...":"Hacer admin"}),r.jsx("button",{className:"btn btn-danger btn-sm",onClick:()=>$(j.id),disabled:g===j.id||$e,title:$e?"No puedes eliminar tu propio usuario":"Eliminar usuario",children:g===j.id?"Eliminando...":"Eliminar"})]})})]},j.id)};return r.jsxs(r.Fragment,{children:[r.jsxs("div",{className:"dash-item only-desktop",style:{marginBottom:16},children:[r.jsxs("div",{className:"dash-header",style:{marginBottom:8},children:[r.jsxs("h4",{style:{margin:0},children:["Usuarios creados (no activados)",pe.length?` · ${pe.length}`:""]}),r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>L(j=>!j),children:I?"Ocultar":"Mostrar"})]}),I&&r.jsx("div",{style:{overflowX:"auto"},children:r.jsxs("table",{className:"me-table",style:{minWidth:720},children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:"Nombre"}),r.jsx("th",{children:"Email"}),r.jsx("th",{children:"Roles"}),r.jsx("th",{children:"Activo"}),r.jsx("th",{children:"Creado"}),r.jsx("th",{children:"Acciones"})]})}),r.jsxs("tbody",{children:[pe.length===0&&r.jsx("tr",{children:r.jsx("td",{colSpan:6,style:{textAlign:"center",padding:16},children:i?"Cargando...":"No hay usuarios no activados"})}),pe.map(R)]})]})})]}),r.jsxs("div",{className:"dash-item only-desktop",children:[r.jsxs("div",{className:"dash-header",style:{marginBottom:8},children:[r.jsxs("h4",{style:{margin:0},children:["Usuarios activados",ge.length?` · ${ge.length}`:""]}),r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>F(j=>!j),children:z?"Ocultar":"Mostrar"})]}),z&&r.jsx("div",{style:{overflowX:"auto"},children:r.jsxs("table",{className:"me-table",style:{minWidth:720},children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:"Nombre"}),r.jsx("th",{children:"Email"}),r.jsx("th",{children:"Roles"}),r.jsx("th",{children:"Activo"}),r.jsx("th",{children:"Creado"}),r.jsx("th",{children:"Acciones"})]})}),r.jsxs("tbody",{children:[ge.length===0&&r.jsx("tr",{children:r.jsx("td",{colSpan:6,style:{textAlign:"center",padding:16},children:i?"Cargando...":"No hay usuarios activados"})}),ge.map(R)]})]})})]})]})})(),(()=>{const M=j=>String(j||"").toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,""),G=M(_),W=j=>{if(!G)return!0;const Z=[j.document,j.documentNumber,j.cedula,j.dni,j.idNumber,j.numeroDocumento];return[j.name,j.email,...Z].some(Be=>M(Be).includes(G))},A=t.filter(W),T=(j,Z)=>{const te=j!=null&&j.createdAt?new Date(j.createdAt).getTime():0;return(Z!=null&&Z.createdAt?new Date(Z.createdAt).getTime():0)-te},Y=j=>(j==null?void 0:j.active)===!1||(j==null?void 0:j.isActive)===!1,pe=A.filter(Y).sort(T),ge=A.filter(j=>!Y(j)).sort(T),R=j=>{const Z=j.createdAt?new Date(j.createdAt):null,te=at(j.roles),Be=te.includes("admin"),ae=j.active!==!1&&j.isActive!==!1,$e=K===j.id,Qe=k===j.id,Xe=te.length>0?te.join(", "):"-";return r.jsxs("div",{className:"mobile-item",children:[r.jsxs("button",{type:"button",className:"btn btn-primary btn-sm mobile-item-header",onClick:()=>E(Cn=>Cn===j.id?null:j.id),"aria-expanded":Qe,style:{width:"100%",display:"flex",alignItems:"center",justifyContent:"space-between"},children:[r.jsx("div",{className:"mobile-item-title",children:j.name||"-"}),r.jsx("div",{style:{opacity:.9,fontSize:12,paddingRight:10},children:Qe?"−":"+"})]}),Qe&&r.jsxs("div",{className:"mobile-item-details",children:[r.jsxs("div",{className:"kv",children:[r.jsx("span",{children:"Email"}),r.jsx("div",{children:j.email||"-"})]}),r.jsxs("div",{className:"kv",style:{marginTop:6},children:[r.jsx("span",{children:"Roles"}),r.jsx("div",{children:Xe})]}),r.jsxs("div",{className:"kv",style:{marginTop:6},children:[r.jsx("span",{children:"Estado"}),r.jsx("div",{children:r.jsx("span",{className:`me-badge ${ae?"me-badge-success":"me-badge-error"}`,children:ae?"Activo":"Inactivo"})})]}),r.jsxs("div",{className:"kv",style:{marginTop:6},children:[r.jsx("span",{children:"Creado"}),r.jsx("div",{children:Z?Z.toLocaleString():"-"})]}),r.jsxs("div",{style:{display:"flex",flexWrap:"wrap",gap:8,marginTop:10,justifyContent:"flex-end"},children:[r.jsx("button",{className:"btn btn-primary btn-sm",onClick:()=>ye(j.id,!ae),disabled:c===j.id,children:c===j.id?"Guardando...":ae?"Desactivar":"Activar"}),r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>Q(j),children:"Convertir a cliente"}),Be?r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>P(j.id),disabled:p===j.id||$e,title:$e?"No puedes modificar tu propio rol":"Quitar rol admin",children:p===j.id?"Quitando...":"Quitar admin"}):r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>Oe(j.id),disabled:p===j.id,children:p===j.id?"Asignando...":"Hacer admin"}),r.jsx("button",{className:"btn btn-danger btn-sm",onClick:()=>$(j.id),disabled:g===j.id||$e,title:$e?"No puedes eliminar tu propio usuario":"Eliminar usuario",children:g===j.id?"Eliminando...":"Eliminar"})]})]})]},j.id)};return r.jsxs(r.Fragment,{children:[r.jsxs("div",{className:"dash-item only-mobile",style:{marginBottom:16},children:[r.jsxs("div",{className:"dash-header",style:{marginBottom:8},children:[r.jsxs("h4",{style:{margin:0},children:["Usuarios creados (no activados)",pe.length?` · ${pe.length}`:""]}),r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>L(j=>!j),children:I?"Ocultar":"Mostrar"})]}),I&&r.jsxs("div",{className:"mobile-list",children:[pe.length===0&&r.jsx("div",{style:{textAlign:"center",padding:8},children:i?"Cargando...":"No hay usuarios no activados"}),pe.map(R)]})]}),r.jsxs("div",{className:"dash-item only-mobile",children:[r.jsxs("div",{className:"dash-header",style:{marginBottom:8},children:[r.jsxs("h4",{style:{margin:0},children:["Usuarios activados",ge.length?` · ${ge.length}`:""]}),r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>F(j=>!j),children:z?"Ocultar":"Mostrar"})]}),z&&r.jsxs("div",{className:"mobile-list",children:[ge.length===0&&r.jsx("div",{style:{textAlign:"center",padding:8},children:i?"Cargando...":"No hay usuarios activados"}),ge.map(R)]})]})]})})()]}),v&&r.jsx("div",{role:"dialog","aria-modal":"true",className:"modal-overlay",onClick:M=>{M.target===M.currentTarget&&x(null)},children:r.jsxs("div",{className:"modal-card",role:"document",children:[r.jsxs("div",{className:"modal-header",children:[r.jsx("div",{className:"dash-title",children:"Convertir usuario en cliente"}),r.jsx("button",{type:"button",className:"btn btn-secondary btn-sm",onClick:()=>x(null),"aria-label":"Cerrar",children:"Cerrar"})]}),h&&r.jsx(Ji,{onClose:()=>b(null),children:h}),r.jsx("style",{children:`
        ...
        `}),r.jsxs("div",{className:"tasks-container",children:[r.jsxs("div",{className:"tasks-header",children:[r.jsxs("div",{className:"brand","aria-label":"Koop Strategic Advisory",children:[r.jsx("div",{className:"logo","aria-hidden":"true",children:r.jsxs("svg",{width:"22",height:"22",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[r.jsx("path",{d:"M12 2L20 6V18L12 22L4 18V6L12 2Z",stroke:"white",strokeWidth:"2"}),r.jsx("path",{d:"M12 7V17",stroke:"white",strokeWidth:"2"}),r.jsx("path",{d:"M7 9L12 12L17 9",stroke:"white",strokeWidth:"2"})]})}),r.jsx("h1",{children:"Tablero de Tareas"})]}),r.jsxs("div",{className:"toolbar",role:"search",children:[r.jsx("div",{className:"field",children:r.jsx("input",{className:"tasks-input",type:"search",placeholder:"Buscar por asunto, cliente o radicado…","aria-label":"Buscar",value:t,onChange:x=>a(x.target.value)})}),r.jsx("div",{className:"field",children:r.jsxs("select",{className:"tasks-select","aria-label":"Usuario actual",value:i,onChange:x=>o(x.target.value),children:[r.jsx("option",{value:"derly",children:"Derly Ramírez (Abogada)"}),r.jsx("option",{value:"juan",children:"Juan F. Rey (Socio)"}),r.jsx("option",{value:"valentina",children:"Valentina Martínez (Asistente)"})]})}),r.jsx("div",{className:"field",children:r.jsxs("select",{className:"tasks-select","aria-label":"Estado",value:s,onChange:x=>l(x.target.value),children:[r.jsx("option",{value:"all",children:"Todos los estados"}),r.jsx("option",{value:"pendiente",children:"Pendiente"}),r.jsx("option",{value:"en-curso",children:"En curso"}),r.jsx("option",{value:"hecho",children:"Hecho"})]})})]})]}),r.jsxs("main",{className:"grid","aria-live":"polite",children:[r.jsxs("aside",{className:"sidebar panel",children:[r.jsx("h2",{children:"Filtros rápidos"}),r.jsxs("div",{className:"chips",children:[r.jsx("button",{className:"chip",onClick:()=>l("all"),children:"Hoy"}),r.jsx("button",{className:"chip",onClick:()=>l("all"),children:"Vencidos"}),r.jsx("button",{className:"chip",onClick:()=>l("all"),children:"Alta prioridad"}),r.jsx("button",{className:"chip",onClick:()=>l("all"),children:"Cliente corporativo"})]}),r.jsx("h2",{style:{marginTop:18},children:"Vistas"}),r.jsxs("div",{className:"chips",children:[r.jsx("button",{className:"chip","data-active":c?"true":"false",onClick:()=>d(!0),children:"Mis tareas"}),r.jsx("button",{className:"chip","data-active":c?"false":"true",onClick:()=>d(!1),children:"Todas"})]})]}),r.jsxs("section",{className:"board panel",children:[r.jsxs("div",{className:"board-header",children:[r.jsx("h3",{children:c?"Mis tareas":"Todas las tareas"}),r.jsx("span",{className:"count",children:v})]}),y.length===0?r.jsxs("div",{className:"empty",children:[r.jsxs("svg",{width:"72",height:"72",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[r.jsx("path",{d:"M4 7H20V19C20 20.1046 19.1046 21 18 21H6C4.89543 21 4 20.1046 4 19V7Z",stroke:"#67e8f9",strokeWidth:"1.5"}),r.jsx("path",{d:"M9 3H15V7H9V3Z",stroke:"#67e8f9",strokeWidth:"1.5"}),r.jsx("path",{d:"M8 12H16",stroke:"#94a3b8",strokeWidth:"1.5"}),r.jsx("path",{d:"M8 16H13",stroke:"#94a3b8",strokeWidth:"1.5"})]}),r.jsxs("div",{children:[r.jsx("strong",{children:"No tienes tareas asignadas"}),r.jsx("p",{style:{margin:".35rem 0 0",fontSize:14,color:"#a5b4fc"},children:"Cuando te asignen una tarea aparecerá aquí."})]})]}):r.jsx("div",{className:"cards",children:y.map(x=>{const w=yv[x.assignee]||{name:x.assignee,initials:(x.assignee||"?").slice(0,2).toUpperCase(),color:"#0ea5e9"},f=x.priority==="alta"?"high":x.priority==="media"?"medium":"low",h=x.status==="en-curso"?"En curso":x.status==="hecho"?"Hecho":"Pendiente";return r.jsxs("article",{className:"card",role:"article","aria-label":x.title,children:[r.jsx("h4",{className:"title",children:x.title}),r.jsxs("div",{className:"meta",children:[r.jsxs("span",{className:"badge","data-variant":f,children:["Prioridad: ",x.priority]}),r.jsxs("span",{className:"badge","data-variant":"due",children:[kv(x.due)?"Vencida":"Vence",": ",jv(x.due)]}),r.jsxs("span",{className:"badge",children:["Estado: ",h]}),x.radicado?r.jsxs("span",{className:"badge",children:["Radicado: ",x.radicado]}):null,r.jsxs("span",{className:"badge",children:["Cliente: ",x.client]}),(x.tags||[]).map(b=>r.jsx("span",{className:"badge",children:b},b))]}),r.jsxs("div",{className:"assignee","aria-label":"Responsable",children:[r.jsx("div",{className:"avatar",style:{background:w.color},"aria-hidden":"true",children:w.initials}),r.jsxs("small",{children:["Asignada a ",r.jsx("strong",{children:w.name})]})]})]},x.id)})}),r.jsx("div",{className:"footer-actions",children:r.jsx("button",{className:"link",onClick:()=>u(x=>!x),children:"(Demo) Alternar escenario sin tareas"})})]})]})]})]})}):r.jsx("div",{className:"dash-page",style:{padding:40},children:r.jsxs("div",{className:"dash-card",style:{maxWidth:560},children:[r.jsx("h2",{className:"dash-title",children:"Acceso restringido"}),r.jsx("p",{style:{marginTop:12},children:"Esta sección está disponible solo para administradores."})]})})}async function it({limit:e,subfolder:n}={}){const t={};typeof e=="number"&&(t.limit=e),n&&(t.subfolder=n);const{data:a}=await je.get("/docs/recent",{params:t});return a}async function ef(e,{subfolder:n}={}){if(!e)throw new Error("Archivo requerido");const t=new FormData;t.append("file",e),n&&t.append("subfolder",n);const{data:a}=await je.post("/docs/upload",t,{headers:{"Content-Type":"multipart/form-data"}});return a}async function Nv(e,n=600){if(!e)throw new Error("Key requerida");const t={key:e,expires:n},{data:a}=await je.get("/docs/download-url",{params:t});return a}async function Sv({subfolder:e}={}){const n={};e&&(n.subfolder=e);const{data:t}=await je.get("/docs/diag",{params:n});return t}function jo(e){if(e==null)return"";try{return String(e).normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/[\u0000-\u001F\u007F-\u009F]/g,"").replace(/\u00A0/g," ").replace(/[\u200B-\u200D\uFEFF]/g,"").replace(/\uFFFD/g,"").replace(/\s+/g," ").trim().toUpperCase()}catch{return String(e).toUpperCase()}}function ol({selectedClient:e,isModal:n=!1,onClose:t}){var lr,cr,nt;const[a,i]=m.useState("docs"),{user:o,accessToken:s}=We(),l=jo((o==null?void 0:o.name)||""),c="clientes",p=(Array.isArray(o==null?void 0:o.roles)?o.roles:o!=null&&o.roles?[o==null?void 0:o.roles]:[]).map(C=>String(C||"").trim().toLowerCase()).includes("admin"),[u,g]=m.useState([]),[y,v]=m.useState(!1),[x,w]=m.useState(null),[f,h]=m.useState([]),[b,k]=m.useState(!1),[E,I]=m.useState(null),[L,z]=m.useState(null),F=m.useRef(null),[_,ee]=m.useState(e||null),[de,ce]=m.useState({}),[K,an]=m.useState(null),[ye,Oe]=m.useState(!1),[P,$]=m.useState(new Set),[Q,se]=m.useState([]),[M,G]=m.useState(null),[W,A]=m.useState(!1),[T,Y]=m.useState(new Set),[pe,ge]=m.useState(!1),[R,j]=m.useState(!1),[Z,te]=m.useState(!1),[Be,ae]=m.useState(!1),[$e,Qe]=m.useState(!1),[Xe,Cn]=m.useState(null),[Pr,et]=m.useState(""),[Fn,sr]=m.useState({radicado:"",clase:"",demandante:"",demandado:"",juzgado:"",estado:""}),Vt=async()=>{k(!0),I(null),z(null);try{const C=await it({limit:20,subfolder:c});h(Array.isArray(C==null?void 0:C.items)?C.items:[]),C!=null&&C.warning&&z(C.warning)}catch(C){I((C==null?void 0:C.message)||"Error cargando documentos")}finally{k(!1)}};m.useEffect(()=>{a==="docs"&&(p?Vt():J())},[a,p]),m.useEffect(()=>{e&&n&&(ee(e),Ba(e))},[e,n]),m.useEffect(()=>{if(!p)return;let C=!1;return(async()=>{var B,H;try{v(!0),w(null);const q=await lc();if(C)return;const ie=Array.isArray(q==null?void 0:q.items)?q.items:[],hn=String((o==null?void 0:o.id)||(o==null?void 0:o.sub)||"").trim();g(ie.filter(Ae=>{var Te;return String(((Te=Ae==null?void 0:Ae.assignedAdmin)==null?void 0:Te.id)||"").trim()===hn}))}catch(q){C||w(((H=(B=q==null?void 0:q.response)==null?void 0:B.data)==null?void 0:H.message)||(q==null?void 0:q.message)||"No se pudo cargar clientes asignados")}finally{C||v(!1)}})(),()=>{C=!0}},[p,o]);const ko=()=>{var C;return(C=F.current)==null?void 0:C.click()},Va=async C=>{var H,q;const B=(q=(H=C.target)==null?void 0:H.files)==null?void 0:q[0];if(B)try{k(!0),I(null);const ie=await ef(B,{subfolder:c});ie!=null&&ie.file&&h(hn=>[ie.file,...hn]),await Vt()}catch(ie){I((ie==null?void 0:ie.message)||"Error subiendo documento")}finally{k(!1);try{C.target.value=null}catch{}}},qn=async(C,B)=>{try{const{url:H}=await Nv(C,600);window.open(H||B,"_blank")}catch{B&&window.open(B,"_blank")}},Ba=async C=>{if(C!=null&&C.documentNumber){Oe(!0);try{const B=await it({limit:100,subfolder:`clientes/${C.documentNumber}`}),H={},q=`clientes/${C.documentNumber}`;Array.isArray(B==null?void 0:B.items)&&B.items.forEach(ie=>{var hn,Ae;if(ie.isFolder){const Te=(hn=ie.key)==null?void 0:hn.replace(/\/$/,"");if(Te&&Te!==q&&Te.startsWith(q+"/")){const fe=Te.replace(q+"/","").split("/").pop()||"Carpeta";H[Te]={name:fe,path:Te,documents:[],isFolder:!0}}}else{const Te=((Ae=ie.key)==null?void 0:Ae.split("/").slice(0,-1).join("/"))||"root";if(Te&&Te!==q&&Te.startsWith(q+"/")){if(!H[Te]){const fe=Te.replace(q+"/","").split("/").pop()||"Carpeta";H[Te]={name:fe,path:Te,documents:[],isFolder:!1}}H[Te].documents.push(ie)}}}),ce(ie=>({...ie,[C.id]:H}))}catch(B){console.error("Error cargando carpetas del cliente:",B),ce(H=>({...H,[C.id]:{}}))}finally{Oe(!1)}}},Fa=async C=>{P.has(C.id)?($(H=>{const q=new Set(H);return q.delete(C.id),q}),ee(null),an(null)):($(H=>new Set(H).add(C.id)),ee(C),an(null),de[C.id]||await Ba(C))},S=async C=>{if(an(C),C.documents&&C.documents.length>0)h(C.documents);else{k(!0);try{const B=await it({limit:100,subfolder:C.path}),H=Array.isArray(B==null?void 0:B.items)?B.items.filter(q=>!q.isFolder):[];h(H),ce(q=>({...q,[_.id]:{...q[_.id],[C.path]:{...C,documents:H}}}))}catch(B){console.error("Error cargando documentos de la carpeta:",B),h([])}finally{k(!1)}}},J=async()=>{var C,B,H;A(!0);try{console.log("Usuario actual:",o),console.log("Token de acceso:",s?"Presente":"Ausente"),console.log("Roles del usuario:",o==null?void 0:o.roles),console.log("Intentando verificar conectividad...");try{const fe=await Sv();console.log("Health check exitoso:",fe)}catch(fe){throw console.error("Health check falló:",fe),new Error("No se puede conectar con el servidor de documentos")}console.log("Intentando cargar documentos del usuario...");const q=await it({limit:100,subfolder:"clientes"});console.log("Datos de la API para usuario:",q);const ie=Array.isArray(q==null?void 0:q.items)?q.items:[];console.log("Items procesados:",ie);const hn=new Map;let Ae="clientes";const Te=ie.find(fe=>fe.isFolder&&fe.key&&fe.key.includes("clientes/"));if(Te){const fe=Te.key.split("/");fe.length>=2&&(Ae=`${fe[0]}/${fe[1]}/`)}console.log("Ruta base del cliente:",Ae),console.log("Items encontrados:",ie.map(fe=>({key:fe.key,isFolder:fe.isFolder,name:fe.name}))),ie.forEach(fe=>{if(fe.isFolder){const Gn=fe.key;if(Gn&&Gn.startsWith(Ae)&&Gn!==Ae){const rt=Gn.replace(Ae,"").replace(/^\/+|\/+$/g,"");rt&&!rt.includes("/")&&hn.set(Gn,{name:rt,path:Gn,documents:[],isFolder:!0})}}}),ie.forEach(fe=>{var Gn;if(!fe.isFolder){const rt=((Gn=fe.key)==null?void 0:Gn.split("/"))||[];if(rt.length>2){const Za=rt.slice(0,-1).join("/");if(Za.startsWith(Ae)&&Za!==Ae){const cc=Za.replace(Ae,"").replace(/^\/+|\/+$/g,"");if(cc&&!cc.includes("/")){const dc=hn.get(Za);dc&&!fe.isFolder&&dc.documents.push(fe)}}}}});const Ua=Array.from(hn.values());console.log("Carpetas del usuario cargadas:",Ua),se(Ua)}catch(q){console.error("Error cargando carpetas del usuario:",q),console.error("Detalles del error:",{message:q.message,status:(C=q.response)==null?void 0:C.status,data:(B=q.response)==null?void 0:B.data}),((H=q.response)==null?void 0:H.status)===401?I("Error de autenticación. Por favor, cierra sesión y vuelve a iniciar sesión."):I("Error cargando carpetas: "+(q.message||"Error desconocido"))}finally{A(!1)}},X=async C=>{if(G(C),C.documents&&C.documents.length>0)h(C.documents);else try{k(!0);const B=await it({limit:50,subfolder:C.path}),H=Array.isArray(B==null?void 0:B.items)?B.items.filter(q=>!q.isFolder):[];h(H),se(q=>q.map(ie=>ie.path===C.path?{...ie,documents:H}:ie))}catch(B){console.error("Error cargando documentos de la carpeta:",B),I("Error cargando documentos de la carpeta")}finally{k(!1)}},V=C=>{T.has(C.path)?(Y(H=>{const q=new Set(H);return q.delete(C.path),q}),G(null)):(Y(H=>new Set(H).add(C.path)),X(C))},ne=async()=>{try{console.log("Creando nuevo proceso..."),ge(!1),I(null)}catch(C){I("Error creando proceso: "+C.message)}},De=()=>{j(!0)},Ne=C=>{var B;Cn(C),et(C.name||((B=C.key)==null?void 0:B.split("/").pop())||""),te(!0)},Le=C=>{Cn(C),ae(!0)},Yn=async()=>{try{console.log("Guardando información del proceso:",Fn),Qe(!1),I(null)}catch(C){I("Error guardando información: "+C.message)}};return r.jsxs("div",{className:"dash-page",style:{backgroundImage:"linear-gradient(rgba(13,27,42,0.65), rgba(27,38,59,0.65)), url('/fondodashboard.jpg')",backgroundSize:"cover",backgroundAttachment:"fixed",backgroundPosition:"center"},children:[r.jsxs("div",{className:"dash-card",style:{width:"100%",maxWidth:1320},children:[r.jsxs("div",{className:"dash-header",children:[r.jsx("div",{className:"dash-title",children:n?`Expediente - ${(_==null?void 0:_.name)||"Cliente"}`:p?"Mis expedientes":"Mi expediente"}),n&&t&&r.jsx("button",{className:"btn btn-secondary",onClick:t,style:{marginLeft:"auto"},children:"✕ Cerrar"})]}),r.jsxs("div",{className:"dash-item me-subbar",children:[r.jsxs("div",{className:"me-hello",children:["Bienvenido: ",l]}),r.jsxs("select",{className:"me-select","aria-label":"Tipo de b?squeda",children:[r.jsx("option",{children:"Procesos judiciales"}),r.jsx("option",{children:"Demandas"}),r.jsx("option",{children:"Audiencias"})]}),r.jsx("input",{className:"me-input",placeholder:"Buscar..."}),r.jsxs("div",{className:"me-actions",children:[r.jsx("input",{ref:F,type:"file",style:{display:"none"},onChange:Va}),r.jsx("button",{className:"btn btn-primary",onClick:ko,disabled:b,children:b?"Subiendo...":"Radicar documento"}),r.jsx("button",{className:"btn btn-secondary",children:"Ver informaci?n"})]})]}),r.jsxs("div",{className:"me-layout",children:[r.jsxs("aside",{className:"me-left dash-item",children:[r.jsx("div",{className:"me-head",children:p?n?"CARPETAS":"CLIENTE":"CARPETAS"}),r.jsxs("div",{className:"me-tree",children:[!p&&r.jsx(r.Fragment,{children:W?r.jsx("div",{className:"me-leaf",style:{opacity:.8},children:"Cargando carpetas..."}):Q.length===0?r.jsx("div",{className:"me-leaf",style:{opacity:.8},children:"No hay carpetas disponibles"}):Q.map(C=>{var H;const B=T.has(C.path);return r.jsxs("div",{style:{marginBottom:"8px"},children:[r.jsxs("div",{style:{cursor:"pointer",color:B?"#4fd1c5":"#e5edf7",fontWeight:"600",padding:"8px 4px",borderRadius:"4px",backgroundColor:B?"#2a3a51":"transparent",display:"flex",alignItems:"center",gap:"8px",transition:"all 0.2s ease"},onClick:()=>V(C),children:[r.jsx("span",{style:{display:"inline-block",transform:B?"rotate(90deg)":"rotate(0deg)",transition:"transform 0.2s ease",fontSize:"12px",color:B?"#4fd1c5":"#9fb3cc"},children:"▼"}),C.name]}),B&&r.jsx("div",{style:{marginLeft:"16px",marginTop:"4px"},children:r.jsxs("div",{style:{color:"#9fb3cc",fontSize:"12px"},children:[((H=C.documents)==null?void 0:H.length)||0," documentos"]})})]},C.path)})}),p&&n&&_&&r.jsx(r.Fragment,{children:ye?r.jsx("div",{className:"me-leaf",style:{opacity:.8},children:"Cargando carpetas..."}):r.jsxs("div",{children:[Object.values(de[_.id]||{}).map((C,B)=>{var H,q;return r.jsxs("div",{style:{cursor:"pointer",backgroundColor:(K==null?void 0:K.path)===C.path?"#2a3a51":"#1e2a3a",borderRadius:"8px",margin:"4px 0",padding:"12px 16px",border:(K==null?void 0:K.path)===C.path?"1px solid #4fd1c5":"1px solid #394b61",transition:"all 0.2s ease",display:"flex",alignItems:"center",gap:"12px"},onClick:()=>S(C),onMouseEnter:ie=>{(K==null?void 0:K.path)!==C.path&&(ie.target.style.backgroundColor="#2a3a51",ie.target.style.borderColor="#4fd1c5")},onMouseLeave:ie=>{(K==null?void 0:K.path)!==C.path&&(ie.target.style.backgroundColor="#1e2a3a",ie.target.style.borderColor="#394b61")},children:[r.jsx("div",{style:{width:"24px",height:"24px",display:"flex",alignItems:"center",justifyContent:"center",color:(K==null?void 0:K.path)===C.path?"#4fd1c5":"#fc771c"},children:r.jsx("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"currentColor",children:r.jsx("path",{d:"M10 4H4c-1.11 0-2 .89-2 2v12c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2h-8l-2-2z"})})}),r.jsxs("div",{style:{flex:1},children:[r.jsx("div",{style:{color:(K==null?void 0:K.path)===C.path?"#4fd1c5":"#e5edf7",fontSize:"14px",fontWeight:"500",marginBottom:"2px"},children:C.name}),r.jsxs("div",{style:{color:"#9fb3cc",fontSize:"11px",display:"flex",alignItems:"center",gap:"4px"},children:[r.jsx("span",{style:{display:"inline-block",width:"4px",height:"4px",borderRadius:"50%",backgroundColor:((H=C.documents)==null?void 0:H.length)>0?"#10b981":"#6b7280"}}),((q=C.documents)==null?void 0:q.length)||0," documentos"]})]})]},B)}),Object.keys(de[_.id]||{}).length===0&&!ye&&r.jsx("div",{style:{color:"#9fb3cc",fontSize:"12px"},children:"No hay carpetas disponibles"})]})}),p&&!n&&x&&r.jsx("div",{className:"me-leaf",style:{color:"#fecaca"},children:x}),p&&!n&&!x&&y&&r.jsx("div",{className:"me-leaf",style:{opacity:.8},children:"Cargando clientes�"}),p&&!n&&!y&&u.length===0&&r.jsx("div",{className:"me-leaf",style:{opacity:.8},children:"No tienes clientes asignados"}),p&&!n&&u.length>0&&r.jsx(r.Fragment,{children:u.map(C=>{const B=P.has(C.id);return r.jsxs("div",{style:{marginBottom:"8px"},children:[r.jsxs("div",{style:{cursor:"pointer",color:B?"#4fd1c5":"#e5edf7",fontWeight:"600",padding:"8px 4px",borderRadius:"4px",backgroundColor:B?"#2a3a51":"transparent",display:"flex",alignItems:"center",gap:"8px",transition:"all 0.2s ease"},onClick:()=>Fa(C),children:[r.jsx("span",{style:{display:"inline-block",transform:B?"rotate(90deg)":"rotate(0deg)",transition:"transform 0.2s ease",fontSize:"12px",color:B?"#4fd1c5":"#9fb3cc"},children:"▼"}),C.name]}),B&&r.jsx("div",{style:{marginLeft:"16px",marginTop:"4px"},children:ye?r.jsx("div",{style:{color:"#9fb3cc",fontSize:"12px"},children:"Cargando carpetas..."}):r.jsxs("div",{children:[Object.values(de[C.id]||{}).map((H,q)=>{var ie,hn;return r.jsxs("div",{style:{cursor:"pointer",backgroundColor:(K==null?void 0:K.path)===H.path?"#2a3a51":"#1e2a3a",borderRadius:"8px",margin:"4px 0",padding:"12px 16px",border:(K==null?void 0:K.path)===H.path?"1px solid #4fd1c5":"1px solid #394b61",transition:"all 0.2s ease",display:"flex",alignItems:"center",gap:"12px"},onClick:()=>S(H),onMouseEnter:Ae=>{(K==null?void 0:K.path)!==H.path&&(Ae.target.style.backgroundColor="#2a3a51",Ae.target.style.borderColor="#4fd1c5")},onMouseLeave:Ae=>{(K==null?void 0:K.path)!==H.path&&(Ae.target.style.backgroundColor="#1e2a3a",Ae.target.style.borderColor="#394b61")},children:[r.jsx("div",{style:{width:"24px",height:"24px",display:"flex",alignItems:"center",justifyContent:"center",color:(K==null?void 0:K.path)===H.path?"#4fd1c5":"#fc771c"},children:r.jsx("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"currentColor",children:r.jsx("path",{d:"M10 4H4c-1.11 0-2 .89-2 2v12c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2h-8l-2-2z"})})}),r.jsxs("div",{style:{flex:1},children:[r.jsx("div",{style:{color:(K==null?void 0:K.path)===H.path?"#4fd1c5":"#e5edf7",fontSize:"14px",fontWeight:"500",marginBottom:"2px"},children:H.name}),r.jsxs("div",{style:{color:"#9fb3cc",fontSize:"11px",display:"flex",alignItems:"center",gap:"4px"},children:[r.jsx("span",{style:{display:"inline-block",width:"4px",height:"4px",borderRadius:"50%",backgroundColor:((ie=H.documents)==null?void 0:ie.length)>0?"#10b981":"#6b7280"}}),((hn=H.documents)==null?void 0:hn.length)||0," documentos"]})]})]},q)}),Object.keys(de[C.id]||{}).length===0&&!ye&&r.jsx("div",{style:{color:"#9fb3cc",fontSize:"12px"},children:"No hay carpetas disponibles"})]})})]},C.id)})})]})]}),r.jsxs("main",{className:"me-center dash-item",children:[r.jsxs("div",{className:"me-tabs",children:[r.jsx("div",{className:`me-tab ${a==="docs"?"active":""}`,onClick:()=>i("docs"),role:"button",tabIndex:0,children:"Documentos del Proceso"}),r.jsx("div",{className:`me-tab ${a==="aud"?"active":""}`,onClick:()=>i("aud"),role:"button",tabIndex:0,children:"Audiencias"})]}),a==="docs"&&r.jsxs("div",{className:"me-table-wrap",children:[_&&K&&r.jsxs("div",{style:{background:"#1e2a3a",padding:"12px 16px",borderBottom:"1px solid #34465a",color:"#e2e8f0",fontSize:"14px"},children:[r.jsx("strong",{children:"Cliente:"})," ",_.name," |",r.jsx("strong",{children:" Carpeta:"})," ",K.name,r.jsxs("span",{style:{color:"#9fb3cc",marginLeft:"8px"},children:["(",((lr=K.documents)==null?void 0:lr.length)||0," documentos)"]})]}),_&&!K&&r.jsxs("div",{style:{background:"#1e2a3a",padding:"12px 16px",borderBottom:"1px solid #34465a",color:"#e2e8f0",fontSize:"14px"},children:[r.jsx("strong",{children:"Cliente seleccionado:"})," ",_.name," -",r.jsx("span",{style:{color:"#9fb3cc"},children:" Selecciona una carpeta para ver sus documentos"})]}),p&&!_&&r.jsx("div",{style:{background:"#1e2a3a",padding:"12px 16px",borderBottom:"1px solid #34465a",color:"#9fb3cc",fontSize:"14px"},children:"Selecciona un cliente para ver sus carpetas y documentos"}),!p&&!M&&r.jsx("div",{style:{background:"#1e2a3a",padding:"12px 16px",borderBottom:"1px solid #34465a",color:"#9fb3cc",fontSize:"14px"},children:"Selecciona una carpeta para ver sus documentos"}),E&&r.jsx("div",{style:{color:"#ef4444",padding:"8px 12px"},children:String(E)}),L&&r.jsxs("div",{style:{color:"#f59e0b",padding:"8px 12px"},children:["Aviso: ",String(L)==="S3_LIST_FORBIDDEN"?"No hay permisos para listar el bucket. Tus documentos siguen disponibles si conservas el enlace.":String(L)]}),r.jsxs("table",{className:"me-table",children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{style:{width:42},children:r.jsx("input",{type:"checkbox"})}),r.jsx("th",{children:"Fecha de registro"}),r.jsx("th",{children:"Documento"}),r.jsx("th",{children:"Tipo"}),r.jsx("th",{children:"Tama?o"}),r.jsx("th",{children:"Acciones"})]})}),r.jsxs("tbody",{children:[f.length===0&&r.jsx("tr",{children:r.jsx("td",{colSpan:6,style:{color:"#9fb3cc",textAlign:"center",padding:"20px"},children:b?"Cargando...":p?_&&K?`No hay documentos en la carpeta "${K.name}"`:_?"Selecciona una carpeta para ver sus documentos":"Selecciona un cliente para ver sus documentos":M?`No hay documentos en la carpeta "${M.name}"`:"Selecciona una carpeta para ver sus documentos"})}),f.map(C=>{const B=C.lastModified?new Date(C.lastModified):C.createdTime?new Date(C.createdTime):null,H=C.name||(C.key||"").split("/").pop(),q=typeof C.size=="number"?Math.max(1,Math.round(C.size/1024)):null,ie=C.mimeType||(H&&H.toLowerCase().endsWith(".pdf")?"application/pdf":void 0);return r.jsxs("tr",{children:[r.jsx("td",{children:r.jsx("input",{type:"checkbox"})}),r.jsx("td",{children:B?B.toLocaleString():"-"}),r.jsx("td",{title:H,children:H}),r.jsx("td",{children:ie?ie.split("/")[1]||ie:"-"}),r.jsx("td",{children:q?`${q} KB`:"-"}),r.jsx("td",{children:r.jsxs("div",{style:{display:"flex",gap:"4px",flexWrap:"wrap"},children:[r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>qn(C.key,C.downloadURL||C.downloadUrl||C.webContentLink||C.webViewLink),title:"Descargar archivo",children:n?"📥":"Descargar"}),n&&r.jsxs(r.Fragment,{children:[r.jsx("button",{className:"btn btn-primary btn-sm",onClick:()=>Ne(C),title:"Renombrar archivo",children:"✏️"}),r.jsx("button",{className:"btn btn-danger btn-sm",onClick:()=>Le(C),title:"Eliminar archivo",children:"🗑️"})]})]})})]},C.key||C.id)})]})]})]}),a==="aud"&&r.jsx("div",{className:"me-table-wrap",children:r.jsxs("table",{className:"me-table",children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:"Fecha"}),r.jsx("th",{children:"Actuaci?n"}),r.jsx("th",{children:"Juzgado"}),r.jsx("th",{children:"Estado"})]})}),r.jsx("tbody",{children:r.jsxs("tr",{children:[r.jsx("td",{children:"2025-09-03 08:00"}),r.jsx("td",{children:"Audiencia inicial"}),r.jsx("td",{children:"JDO 003 Laboral"}),r.jsx("td",{children:r.jsx("span",{className:"me-badge me-badge-success",children:"Agendada"})})]})})]})})]}),r.jsx("aside",{className:"me-right dash-item",children:n?r.jsxs(r.Fragment,{children:[r.jsx("div",{className:"me-head",children:"Herramientas del Expediente"}),r.jsxs("div",{className:"me-right-content",style:{display:"flex",flexDirection:"column",gap:"12px"},children:[r.jsx("button",{className:"btn btn-primary",onClick:De,style:{width:"100%",padding:"12px"},children:"📁 Agregar Archivo"}),r.jsx("button",{className:"btn btn-secondary",onClick:()=>ge(!0),style:{width:"100%",padding:"12px"},children:"📋 Crear Proceso"}),r.jsx("button",{className:"btn btn-secondary",onClick:()=>Qe(!0),style:{width:"100%",padding:"12px"},children:"ℹ️ Información del Expediente"}),r.jsx("hr",{className:"me-hr"}),r.jsx("div",{style:{fontSize:"12px",color:"#9fb3cc",textAlign:"center"},children:"Selecciona un archivo en la tabla para renombrar o eliminar"})]})]}):r.jsxs(r.Fragment,{children:[r.jsx("div",{className:"me-head",children:"Datos del Proceso Judicial"}),r.jsxs("div",{className:"me-right-content",children:[r.jsxs("div",{className:"me-proc-grid",children:[r.jsx("div",{className:"me-tag",children:"Radicado"}),r.jsx("div",{children:"110014105009-20250011400"}),r.jsx("div",{className:"me-tag",children:"Clase"}),r.jsx("div",{children:"Laboral - Ordinario"}),r.jsx("div",{className:"me-tag",children:"Demandante"}),r.jsx("div",{children:"Juan Pérez"}),r.jsx("div",{className:"me-tag",children:"Demandado"}),r.jsx("div",{children:"Acme S.A.S."}),r.jsx("div",{className:"me-tag",children:"Juzgado"}),r.jsx("div",{children:"JDO 009 MPC"}),r.jsx("div",{className:"me-tag",children:"Estado"}),r.jsx("div",{children:"En trámite"})]}),r.jsx("hr",{className:"me-hr"}),r.jsx("button",{className:"btn btn-primary",style:{width:"100%"},children:"Descargar expediente"})]})]})})]})]}),n&&pe&&r.jsx("div",{style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:60,padding:16},onClick:()=>ge(!1),children:r.jsxs("div",{className:"dash-card",style:{maxWidth:"500px",width:"100%"},onClick:C=>C.stopPropagation(),children:[r.jsx("div",{className:"dash-header",style:{marginBottom:8},children:r.jsx("div",{className:"dash-title",children:"Crear Nuevo Proceso"})}),r.jsxs("div",{className:"dash-item",style:{display:"grid",gap:16},children:[r.jsxs("div",{children:[r.jsx("label",{style:{display:"block",marginBottom:"8px",fontWeight:"500"},children:"Nombre del Proceso:"}),r.jsx("input",{type:"text",className:"me-input",placeholder:"Ej: Demanda por despido injustificado",style:{width:"100%"}})]}),r.jsxs("div",{children:[r.jsx("label",{style:{display:"block",marginBottom:"8px",fontWeight:"500"},children:"Tipo de Proceso:"}),r.jsxs("select",{className:"me-select",style:{width:"100%"},children:[r.jsx("option",{value:"",children:"Selecciona un tipo..."}),r.jsx("option",{value:"laboral",children:"Proceso Laboral"}),r.jsx("option",{value:"penal",children:"Proceso Penal"}),r.jsx("option",{value:"civil",children:"Proceso Civil"}),r.jsx("option",{value:"administrativo",children:"Proceso Administrativo"})]})]})]}),r.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",gap:8,marginTop:12},children:[r.jsx("button",{className:"btn btn-secondary",onClick:()=>ge(!1),children:"Cancelar"}),r.jsx("button",{className:"btn btn-primary",onClick:ne,children:"Crear Proceso"})]})]})}),n&&R&&r.jsx("div",{style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:60,padding:16},onClick:()=>j(!1),children:r.jsxs("div",{className:"dash-card",style:{maxWidth:"500px",width:"100%"},onClick:C=>C.stopPropagation(),children:[r.jsx("div",{className:"dash-header",style:{marginBottom:8},children:r.jsx("div",{className:"dash-title",children:"Agregar Archivo"})}),r.jsxs("div",{className:"dash-item",style:{display:"grid",gap:16},children:[r.jsxs("div",{children:[r.jsx("label",{style:{display:"block",marginBottom:"8px",fontWeight:"500"},children:"Seleccionar Archivo:"}),r.jsx("input",{type:"file",className:"me-input",style:{width:"100%"},onChange:C=>{var H;const B=(H=C.target.files)==null?void 0:H[0];B&&et(B.name)}})]}),r.jsxs("div",{children:[r.jsx("label",{style:{display:"block",marginBottom:"8px",fontWeight:"500"},children:"Nombre del Archivo (opcional):"}),r.jsx("input",{type:"text",className:"me-input",value:Pr,onChange:C=>et(C.target.value),placeholder:"Dejar vacío para usar el nombre original",style:{width:"100%"}})]})]}),r.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",gap:8,marginTop:12},children:[r.jsx("button",{className:"btn btn-secondary",onClick:()=>j(!1),children:"Cancelar"}),r.jsx("button",{className:"btn btn-primary",onClick:()=>{console.log("Subiendo archivo con nombre:",Pr),j(!1)},children:"Subir Archivo"})]})]})}),n&&Z&&Xe&&r.jsx("div",{style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:60,padding:16},onClick:()=>te(!1),children:r.jsxs("div",{className:"dash-card",style:{maxWidth:"500px",width:"100%"},onClick:C=>C.stopPropagation(),children:[r.jsx("div",{className:"dash-header",style:{marginBottom:8},children:r.jsx("div",{className:"dash-title",children:"Renombrar Archivo"})}),r.jsxs("div",{className:"dash-item",style:{display:"grid",gap:16},children:[r.jsxs("div",{children:[r.jsx("label",{style:{display:"block",marginBottom:"8px",fontWeight:"500"},children:"Archivo actual:"}),r.jsx("div",{style:{background:"#1e2a3a",padding:"8px 12px",borderRadius:"6px",color:"#9fb3cc",fontSize:"14px"},children:Xe.name||((cr=Xe.key)==null?void 0:cr.split("/").pop())})]}),r.jsxs("div",{children:[r.jsx("label",{style:{display:"block",marginBottom:"8px",fontWeight:"500"},children:"Nuevo nombre:"}),r.jsx("input",{type:"text",className:"me-input",value:Pr,onChange:C=>et(C.target.value),style:{width:"100%"}})]})]}),r.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",gap:8,marginTop:12},children:[r.jsx("button",{className:"btn btn-secondary",onClick:()=>te(!1),children:"Cancelar"}),r.jsx("button",{className:"btn btn-primary",onClick:()=>{console.log("Renombrando archivo:",Xe.key,"a:",Pr),te(!1)},children:"Renombrar"})]})]})}),n&&Be&&Xe&&r.jsx("div",{style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:60,padding:16},onClick:()=>ae(!1),children:r.jsxs("div",{className:"dash-card",style:{maxWidth:"500px",width:"100%"},onClick:C=>C.stopPropagation(),children:[r.jsx("div",{className:"dash-header",style:{marginBottom:8},children:r.jsx("div",{className:"dash-title",children:"Confirmar Eliminación"})}),r.jsxs("div",{className:"dash-item",style:{display:"grid",gap:16},children:[r.jsx("div",{children:"¿Estás seguro de que quieres eliminar el archivo?"}),r.jsxs("div",{style:{background:"#1e2a3a",padding:"12px",borderRadius:"6px",color:"#e5edf7",fontSize:"14px"},children:[r.jsx("strong",{children:"Archivo:"})," ",Xe.name||((nt=Xe.key)==null?void 0:nt.split("/").pop())]}),r.jsx("div",{style:{background:"#7f1d1d",color:"#fecaca",padding:"8px 12px",borderRadius:"6px",fontSize:"12px"},children:"⚠️ Esta acción no se puede deshacer"})]}),r.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",gap:8,marginTop:12},children:[r.jsx("button",{className:"btn btn-secondary",onClick:()=>ae(!1),children:"Cancelar"}),r.jsx("button",{className:"btn btn-danger",onClick:()=>{console.log("Eliminando archivo:",Xe.key),ae(!1)},children:"Eliminar"})]})]})}),n&&$e&&r.jsx("div",{style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:60,padding:16},onClick:()=>Qe(!1),children:r.jsxs("div",{className:"dash-card",style:{maxWidth:"600px",width:"100%"},onClick:C=>C.stopPropagation(),children:[r.jsx("div",{className:"dash-header",style:{marginBottom:8},children:r.jsx("div",{className:"dash-title",children:"Información del Expediente"})}),r.jsxs("div",{className:"dash-item",style:{display:"grid",gap:16},children:[r.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"16px"},children:[r.jsxs("div",{children:[r.jsx("label",{style:{display:"block",marginBottom:"8px",fontWeight:"500"},children:"Radicado:"}),r.jsx("input",{type:"text",className:"me-input",value:Fn.radicado,onChange:C=>sr(B=>({...B,radicado:C.target.value})),placeholder:"110014105009-20250011400",style:{width:"100%"}})]}),r.jsxs("div",{children:[r.jsx("label",{style:{display:"block",marginBottom:"8px",fontWeight:"500"},children:"Clase:"}),r.jsx("input",{type:"text",className:"me-input",value:Fn.clase,onChange:C=>sr(B=>({...B,clase:C.target.value})),placeholder:"Laboral - Ordinario",style:{width:"100%"}})]})]}),r.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"16px"},children:[r.jsxs("div",{children:[r.jsx("label",{style:{display:"block",marginBottom:"8px",fontWeight:"500"},children:"Demandante:"}),r.jsx("input",{type:"text",className:"me-input",value:Fn.demandante,onChange:C=>sr(B=>({...B,demandante:C.target.value})),placeholder:"Juan Pérez",style:{width:"100%"}})]}),r.jsxs("div",{children:[r.jsx("label",{style:{display:"block",marginBottom:"8px",fontWeight:"500"},children:"Demandado:"}),r.jsx("input",{type:"text",className:"me-input",value:Fn.demandado,onChange:C=>sr(B=>({...B,demandado:C.target.value})),placeholder:"Acme S.A.S.",style:{width:"100%"}})]})]}),r.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"16px"},children:[r.jsxs("div",{children:[r.jsx("label",{style:{display:"block",marginBottom:"8px",fontWeight:"500"},children:"Juzgado:"}),r.jsx("input",{type:"text",className:"me-input",value:Fn.juzgado,onChange:C=>sr(B=>({...B,juzgado:C.target.value})),placeholder:"JDO 009 MPC",style:{width:"100%"}})]}),r.jsxs("div",{children:[r.jsx("label",{style:{display:"block",marginBottom:"8px",fontWeight:"500"},children:"Estado:"}),r.jsxs("select",{className:"me-select",value:Fn.estado,onChange:C=>sr(B=>({...B,estado:C.target.value})),style:{width:"100%"},children:[r.jsx("option",{value:"",children:"Selecciona un estado..."}),r.jsx("option",{value:"en-tramite",children:"En trámite"}),r.jsx("option",{value:"sentencia",children:"Sentencia"}),r.jsx("option",{value:"archivado",children:"Archivado"}),r.jsx("option",{value:"suspension",children:"Suspensión"})]})]})]})]}),r.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",gap:8,marginTop:12},children:[r.jsx("button",{className:"btn btn-secondary",onClick:()=>Qe(!1),children:"Cancelar"}),r.jsx("button",{className:"btn btn-primary",onClick:Yn,children:"Guardar Información"})]})]})})]})}const Wd=["admin","user"];function Ev(e,{defaultRole:n="user"}={}){const t=String(n||"user").trim().toLowerCase(),a=Wd.includes(t)?t:"user",o=(Array.isArray(e)?e:[e]).map(s=>String(s||"").trim().toLowerCase()).filter(s=>Wd.includes(s));return o.includes("admin")?["admin"]:o.includes("user")?["user"]:[a]}function Av(e){return Ev(e==null?void 0:e.roles).includes("admin")}function Tv(){const{user:e}=We(),n=Av(e),[t,a]=m.useState([]),[i,o]=m.useState(!1),[s,l]=m.useState(null),[c,d]=m.useState(null),[p,u]=m.useState(!1),[g,y]=m.useState(""),[v,x]=m.useState(null),[w,f]=m.useState(!1),[h,b]=m.useState(null),[k,E]=m.useState([]),[I,L]=m.useState(!1),[z,F]=m.useState(null),[_,ee]=m.useState(""),[de,ce]=m.useState(!1),[K,an]=m.useState(null),[ye,Oe]=m.useState(null),[P,$]=m.useState({}),[Q,se]=m.useState({}),[M,G]=m.useState(!1),[W,A]=m.useState(null),[T,Y]=m.useState(!1),[pe,ge]=m.useState(null),[R,j]=m.useState(""),[Z,te]=m.useState(null),[Be,ae]=m.useState("success"),$e=(S,J="success")=>{te(String(S||"")),ae(J);try{clearTimeout($e._t)}catch{}$e._t=setTimeout(()=>te(null),3500)},Qe=async()=>{var S,J;if(n){o(!0),l(null);try{const X=await lc(),V=Array.isArray(X==null?void 0:X.items)?X.items:[];a(V)}catch(X){l(((J=(S=X==null?void 0:X.response)==null?void 0:S.data)==null?void 0:J.message)||(X==null?void 0:X.message)||"No se pudo cargar la lista de clientes")}finally{o(!1)}}};m.useEffect(()=>{Qe()},[n]);const Xe=m.useMemo(()=>{const S=String(g||"").trim().toLowerCase();return S?t.filter(J=>[J.name,J.email,J.documentNumber,J.phone,J.id].map(X=>String(X||"").toLowerCase()).some(X=>X.includes(S))):t},[t,g]),Cn=S=>{const J=t.find(X=>X.id===S);return(J==null?void 0:J.assignedAdmin)||null},Pr=async S=>{var J,X;b(S),f(!0),F(null),L(!0);try{const V=await Yh(),De=(Array.isArray(V==null?void 0:V.items)?V.items:[]).filter(Le=>(Array.isArray(Le.roles)?Le.roles:[Le.roles]).map(Yn=>String(Yn||"").toLowerCase()).includes("admin"));E(De.map(Le=>({id:Le.id,name:Le.name||Le.email||Le.id,email:Le.email})));const Ne=Cn(S.id);ee((Ne==null?void 0:Ne.id)||"")}catch(V){F(((X=(J=V==null?void 0:V.response)==null?void 0:J.data)==null?void 0:X.message)||(V==null?void 0:V.message)||"No se pudo cargar administradores")}finally{L(!1)}},et=async()=>{var S,J;try{const X=_||"";await uv(h.id,X),await Qe(),f(!1),b(null)}catch(X){F(((J=(S=X==null?void 0:X.response)==null?void 0:S.data)==null?void 0:J.message)||(X==null?void 0:X.message)||"No se pudo asignar")}},Fn=S=>{d({id:S.id,name:S.name||"",email:S.email||"",documentNumber:S.documentNumber||"",phone:S.phone||""})},sr=async()=>{var J,X;if(!c)return;const S={name:String(c.name||"").trim(),documentNumber:String(c.documentNumber||"").trim(),phone:String(c.phone||"").trim()};try{u(!0),l(null);const V=await pv(c.id,S),ne=(V==null?void 0:V.client)||null;ne&&a(De=>De.map(Ne=>Ne.id===ne.id?{...Ne,...ne}:Ne)),d(null)}catch(V){l(((X=(J=V==null?void 0:V.response)==null?void 0:J.data)==null?void 0:X.message)||(V==null?void 0:V.message)||"No se pudo guardar la informacion")}finally{u(!1)}},Vt=S=>{A(S),G(!0),ge(null),j("")},ko=async()=>{var S,J,X;if(W)try{Y(!0),ge(null);const V=await fv(W.id,R);await Qe(),G(!1),A(null);const ne=(S=V==null?void 0:V.s3)==null?void 0:S.deleted;$e(typeof ne=="number"?`Cliente eliminado. Archivos S3 eliminados: ${ne}`:"Cliente eliminado correctamente","danger")}catch(V){ge(((X=(J=V==null?void 0:V.response)==null?void 0:J.data)==null?void 0:X.message)||(V==null?void 0:V.message)||"No se pudo eliminar el cliente")}finally{Y(!1)}},Va=async S=>{an(S),ce(!0)},qn=S=>{const J=String((S==null?void 0:S.documentNumber)||(S==null?void 0:S.id)||"").trim();return J?`clientes/${J}/`:"clientes/sin-id/"},Ba=async S=>{const J=S.id,X=qn(S);se(V=>({...V,[J]:!0}));try{const V=X.startsWith("clientes/")?X.replace(/\/$/,""):X,ne=await it({limit:50,subfolder:V}),De=Array.isArray(ne==null?void 0:ne.items)?ne.items:[];$(Ne=>({...Ne,[J]:De}))}catch(V){console.error("Error al cargar archivos:",V),$(ne=>({...ne,[J]:[]}))}finally{se(V=>({...V,[J]:!1}))}},Fa=async S=>{const J=S.id;ye===J?Oe(null):(Oe(J),P[J]||await Ba(S))};return n?r.jsxs("div",{className:"dash-page",style:{backgroundImage:"linear-gradient(rgba(13,27,42,0.65), rgba(27,38,59,0.65)), url('/fondodashboard.jpg')",backgroundSize:"cover",backgroundAttachment:"fixed",backgroundPosition:"center",paddingLeft:16,paddingRight:16,paddingBottom:16},children:[r.jsxs("div",{className:"dash-card",style:{width:"100%",maxWidth:1200},children:[r.jsx("style",{children:`
           @keyframes spin {
         ...
         `}),r.jsxs("div",{className:"dash-header clients-header",style:{marginBottom:16},children:[r.jsx("div",{className:"dash-title",children:"Clientes activos"}),r.jsxs("div",{className:"clients-actions",children:[r.jsx("input",{type:"search",name:"q",autoComplete:"off",placeholder:"Buscar por nombre, email, cedula o celular",value:g,onChange:S=>y(S.target.value),style:{background:"#1b263b",color:"#e2e8f0",border:"1px solid rgba(148,163,184,0.35)",borderRadius:8,padding:"6px 10px"}}),r.jsx("button",{className:"btn btn-secondary",onClick:Qe,disabled:i,children:i?"Actualizando...":"Refrescar"})]})]}),Z&&(Be==="danger"?r.jsx(Ji,{autoHideMs:3500,children:Z}):r.jsx(Jh,{autoHideMs:3500,children:Z})),s&&r.jsx(Ji,{children:s}),r.jsx("div",{className:"dash-item only-desktop",style:{overflowX:"auto"},children:r.jsxs("table",{className:"me-table",style:{minWidth:820},children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:"Nombre"}),r.jsx("th",{children:"Email"}),r.jsx("th",{children:"Cedula"}),r.jsx("th",{children:"Celular"}),r.jsx("th",{children:"Acciones"})]})}),r.jsxs("tbody",{children:[Xe.length===0&&r.jsx("tr",{children:r.jsx("td",{colSpan:5,style:{textAlign:"center",padding:16},children:i?"Cargando...":"No hay clientes activos para mostrar"})}),Xe.map(S=>{var J,X;return r.jsxs(r.Fragment,{children:[r.jsxs("tr",{children:[r.jsxs("td",{children:[r.jsxs("div",{style:{cursor:"pointer",color:"#4fd1c5",fontWeight:"500",textDecoration:"underline"},onClick:()=>Fa(S),onMouseOver:V=>V.target.style.color="#6ee7d7",onMouseOut:V=>V.target.style.color="#4fd1c5",children:[S.name||"-"," ",ye===S.id?"▼":"▶"]}),r.jsxs("div",{style:{fontSize:12,opacity:.75},children:["Admin asignado: ",((J=S.assignedAdmin)==null?void 0:J.name)||"—"]})]}),r.jsx("td",{children:S.email||"-"}),r.jsx("td",{children:S.documentNumber||"-"}),r.jsx("td",{children:S.phone||"-"}),r.jsx("td",{children:r.jsxs("div",{style:{display:"flex",flexWrap:"wrap",gap:8},children:[r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>Pr(S),title:Cn(S.id)?`Asignado a ${((X=Cn(S.id))==null?void 0:X.name)||""}`:"Asignar administrador",children:Cn(S.id)?"Asignado":"Asignar"}),r.jsx("button",{className:"btn btn-primary btn-sm",onClick:()=>Va(S),children:"Archivos"}),r.jsx("button",{className:"btn btn-primary btn-sm",onClick:()=>Fn(S),children:"Editar"}),r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>Vt(S),children:"Eliminar"})]})})]},S.id),ye===S.id&&r.jsx("tr",{children:r.jsx("td",{colSpan:5,style:{padding:0,background:"#0c1530"},children:r.jsxs("div",{style:{padding:"20px"},children:[r.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"16px"},children:[r.jsxs("h4",{style:{margin:0,color:"#e2e8f0"},children:["Archivos y Carpetas - ",S.name]}),r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>Oe(null),children:"Cerrar"})]}),Q[S.id]?r.jsxs("div",{style:{textAlign:"center",padding:"40px",color:"#cbd5e1"},children:[r.jsx("div",{style:{display:"inline-block",width:"20px",height:"20px",border:"2px solid #4fd1c5",borderTop:"2px solid transparent",borderRadius:"50%",animation:"spin 1s linear infinite",marginRight:"8px"}}),"Cargando archivos..."]}):r.jsx("div",{style:{border:"1px solid #394b61",borderRadius:"8px",overflow:"hidden",background:"#1b263b"},children:r.jsxs("table",{style:{width:"100%",borderCollapse:"collapse"},children:[r.jsx("thead",{style:{background:"#0c1530"},children:r.jsxs("tr",{children:[r.jsx("th",{style:{padding:"12px 16px",fontWeight:"600",textAlign:"left"},children:"Nombre"}),r.jsx("th",{style:{padding:"12px 16px",fontWeight:"600",textAlign:"left"},children:"Tipo"}),r.jsx("th",{style:{padding:"12px 16px",fontWeight:"600",textAlign:"left"},children:"Fecha"}),r.jsx("th",{style:{padding:"12px 16px",fontWeight:"600",textAlign:"left"},children:"Tamaño"})]})}),r.jsx("tbody",{children:!P[S.id]||P[S.id].length===0?r.jsx("tr",{children:r.jsx("td",{colSpan:4,style:{textAlign:"center",padding:"40px",color:"#cbd5e1"},children:r.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:"8px"},children:[r.jsx("div",{children:"No hay archivos o carpetas para mostrar"}),r.jsx("div",{style:{fontSize:"14px",opacity:.7},children:'Haz clic en "Archivos" para gestionar documentos'})]})})}):P[S.id].filter(V=>{const ne=V.key||"",De=qn(S);return!(ne===De&&V.isFolder)}).map(V=>{var Yn,lr;const ne=V.lastModified?new Date(V.lastModified):V.createdTime?new Date(V.createdTime):null,De=V.isFolder||((Yn=V.key)==null?void 0:Yn.endsWith("/"))||((lr=V.name)==null?void 0:lr.endsWith("/"));let Ne=V.name||(V.key||"").split("/").pop();if(De&&Ne&&qn(S)){const cr=qn(S).replace(/\/$/,"");V.key&&V.key.startsWith(cr)&&(Ne=V.key.replace(cr+"/","").replace(/\/$/,""))}const Le=typeof V.size=="number"?Math.max(1,Math.round(V.size/1024)):null;return r.jsxs("tr",{style:{borderBottom:"1px solid #394b61"},children:[r.jsx("td",{style:{padding:"12px 16px"},children:r.jsx("span",{style:{color:De?"#fc771c":"#e2e8f0",fontWeight:"500"},children:Ne})}),r.jsx("td",{style:{padding:"12px 16px"},children:r.jsx("span",{style:{color:De?"#fc771c":"#4fd1c5",fontWeight:"500"},children:De?"Carpeta":"Archivo"})}),r.jsx("td",{style:{padding:"12px 16px",color:"#cbd5e1"},children:ne?ne.toLocaleDateString("es-CO"):"-"}),r.jsx("td",{style:{padding:"12px 16px",color:"#cbd5e1"},children:Le?`${Le} KB`:"-"})]},V.key||V.id)})})]})})]})})})]})})]})]})}),r.jsxs("div",{className:"dash-item only-mobile mobile-list",children:[Xe.length===0&&r.jsx("div",{style:{textAlign:"center",padding:8},children:i?"Cargando...":"No hay clientes activos para mostrar"}),Xe.map(S=>{var X,V;const J=v===S.id;return r.jsxs("div",{className:"mobile-item",children:[r.jsxs("button",{type:"button",className:"btn btn-primary btn-sm mobile-item-header",onClick:()=>{x(ne=>ne===S.id?null:S.id),J||Fa(S)},"aria-expanded":J,style:{width:"100%",display:"flex",alignItems:"center",justifyContent:"space-between"},children:[r.jsx("div",{className:"mobile-item-title",children:S.name||"-"}),r.jsx("div",{style:{opacity:.9,fontSize:12,paddingRight:10},children:J?"▼":"▶"})]}),J&&r.jsxs("div",{className:"mobile-item-details",children:[r.jsxs("div",{className:"kv",children:[r.jsx("span",{children:"Email"}),r.jsx("div",{children:S.email||"-"})]}),r.jsxs("div",{className:"kv",style:{marginTop:6},children:[r.jsx("span",{children:"Cédula"}),r.jsx("div",{children:S.documentNumber||"-"})]}),r.jsxs("div",{className:"kv",style:{marginTop:6},children:[r.jsx("span",{children:"Celular"}),r.jsx("div",{children:S.phone||"-"})]}),r.jsxs("div",{className:"kv",style:{marginTop:6},children:[r.jsx("span",{children:"Admin asignado"}),r.jsx("div",{children:((X=S.assignedAdmin)==null?void 0:X.name)||"—"})]}),r.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",marginTop:10},children:[r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>Pr(S),style:{marginRight:8},title:Cn(S.id)?`Asignado a ${((V=Cn(S.id))==null?void 0:V.name)||""}`:"Asignar administrador",children:Cn(S.id)?"Asignado":"Asignar"}),r.jsx("button",{className:"btn btn-primary btn-sm",onClick:()=>Va(S),style:{marginRight:8},children:"Archivos"}),r.jsx("button",{className:"btn btn-primary btn-sm",onClick:()=>Fn(S),style:{marginRight:8},children:"Editar"}),r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>Vt(S),children:"Eliminar"})]}),r.jsxs("div",{style:{marginTop:"16px",paddingTop:"16px",borderTop:"1px solid #394b61"},children:[r.jsx("h5",{style:{margin:"0 0 12px 0",color:"#e2e8f0",fontSize:"16px"},children:"Archivos y Carpetas"}),Q[S.id]?r.jsxs("div",{style:{textAlign:"center",padding:"20px",color:"#cbd5e1"},children:[r.jsx("div",{style:{display:"inline-block",width:"16px",height:"16px",border:"2px solid #4fd1c5",borderTop:"2px solid transparent",borderRadius:"50%",animation:"spin 1s linear infinite",marginRight:"8px"}}),"Cargando archivos..."]}):r.jsx("div",{children:!P[S.id]||P[S.id].length===0?r.jsxs("div",{style:{textAlign:"center",padding:"20px",color:"#cbd5e1",fontSize:"14px"},children:[r.jsx("div",{children:"No hay archivos o carpetas para mostrar"}),r.jsx("div",{style:{fontSize:"12px",opacity:.7,marginTop:"4px"},children:'Haz clic en "Archivos" para gestionar documentos'})]}):r.jsx("div",{style:{border:"1px solid #394b61",borderRadius:"6px",overflow:"hidden",background:"#1b263b"},children:P[S.id].filter(ne=>{const De=ne.key||"",Ne=qn(S);return!(De===Ne&&ne.isFolder)}).map(ne=>{var lr,cr;const De=ne.lastModified?new Date(ne.lastModified):ne.createdTime?new Date(ne.createdTime):null,Ne=ne.isFolder||((lr=ne.key)==null?void 0:lr.endsWith("/"))||((cr=ne.name)==null?void 0:cr.endsWith("/"));let Le=ne.name||(ne.key||"").split("/").pop();if(Ne&&Le&&qn(S)){const nt=qn(S).replace(/\/$/,"");ne.key&&ne.key.startsWith(nt)&&(Le=ne.key.replace(nt+"/","").replace(/\/$/,""))}const Yn=typeof ne.size=="number"?Math.max(1,Math.round(ne.size/1024)):null;return r.jsx("div",{style:{padding:"12px",borderBottom:"1px solid #394b61",display:"flex",justifyContent:"space-between",alignItems:"center"},children:r.jsxs("div",{children:[r.jsx("div",{style:{color:Ne?"#fc771c":"#e2e8f0",fontWeight:"500",fontSize:"14px"},children:Le}),r.jsxs("div",{style:{color:"#cbd5e1",fontSize:"12px",marginTop:"2px"},children:[Ne?"Carpeta":"Archivo"," • ",De?De.toLocaleDateString("es-CO"):"-"," • ",Yn?`${Yn} KB`:"-"]})]})},ne.key||ne.id)})})})]})]})]},S.id)})]})]}),c&&r.jsx("div",{role:"dialog","aria-modal":"true",style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:50},onClick:S=>{S.target===S.currentTarget&&d(null)},children:r.jsxs("div",{className:"dash-card",style:{width:"100%",maxWidth:560,padding:16},children:[r.jsx("div",{className:"dash-header",style:{marginBottom:12},children:r.jsx("div",{className:"dash-title",children:"Editar cliente"})}),r.jsx("div",{className:"dash-item",children:r.jsxs(Xh,{children:[r.jsx(Dn,{label:"Nombre",value:c.name,onChange:S=>d(J=>({...J,name:S.target.value})),placeholder:"Nombre y apellidos"}),r.jsx(Dn,{label:"Email",type:"email",value:c.email,onChange:()=>{},inputProps:{readOnly:!0}}),r.jsxs(il,{cols:2,children:[r.jsx(Dn,{label:"Cédula",value:c.documentNumber,onChange:S=>d(J=>({...J,documentNumber:S.target.value})),placeholder:"Ej: 80153356"}),r.jsx(Dn,{label:"Celular",value:c.phone,onChange:S=>d(J=>({...J,phone:S.target.value})),placeholder:"Ej: 300 123 4567"})]})]})}),r.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",gap:8,marginTop:12},children:[r.jsx("button",{className:"btn btn-secondary",onClick:()=>d(null),disabled:p,children:"Cancelar"}),r.jsx("button",{className:"btn btn-primary",onClick:sr,disabled:p,children:p?"Guardando...":"Guardar cambios"})]})]})}),de&&r.jsx("div",{style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:60,padding:16},onClick:()=>ce(!1),children:r.jsx("div",{style:{width:"100%",maxWidth:"95vw",maxHeight:"95vh",background:"transparent"},onClick:S=>S.stopPropagation(),children:r.jsx(ol,{selectedClient:K,isModal:!0,onClose:()=>ce(!1)})})}),w&&h&&r.jsx("div",{role:"dialog","aria-modal":"true",style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:60,padding:16},onClick:S=>{S.target===S.currentTarget&&(f(!1),b(null))},children:r.jsxs("div",{className:"dash-card",style:{width:"100%",maxWidth:560},children:[r.jsx("div",{className:"dash-header",style:{marginBottom:8},children:r.jsx("div",{className:"dash-title",children:"Asignar administrador"})}),r.jsxs("div",{className:"dash-item",style:{display:"grid",gap:10},children:[r.jsxs("div",{style:{fontSize:14,opacity:.85},children:["Cliente: ",r.jsx("strong",{children:h.name})," ",r.jsxs("span",{style:{opacity:.7},children:["(",h.id,")"]})]}),z&&r.jsx("div",{style:{background:"#7f1d1d",color:"#fecaca",padding:8,borderRadius:6},children:z}),r.jsxs("label",{style:{display:"grid",gap:6},children:[r.jsx("span",{children:"Selecciona un admin"}),r.jsxs("select",{value:_,onChange:S=>ee(S.target.value),disabled:I,style:{background:"#1b263b",color:"#e2e8f0",border:"1px solid rgba(148,163,184,0.35)",borderRadius:8,padding:"8px 10px"},children:[r.jsx("option",{value:"",children:"— Sin asignar —"}),k.map(S=>r.jsxs("option",{value:S.id,children:[S.name," — ",S.email]},S.id))]})]})]}),r.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",gap:8,marginTop:12},children:[r.jsx("button",{className:"btn btn-secondary",onClick:()=>{f(!1),b(null)},disabled:I,children:"Cancelar"}),r.jsx("button",{className:"btn btn-primary",onClick:et,disabled:I,children:"Guardar"})]})]})}),M&&W&&r.jsx("div",{role:"dialog","aria-modal":"true",style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:65,padding:16},onClick:S=>{S.target===S.currentTarget&&(G(!1),A(null))},children:r.jsxs("div",{className:"dash-card",style:{width:"100%",maxWidth:520},children:[r.jsx("div",{className:"dash-header",style:{marginBottom:8},children:r.jsx("div",{className:"dash-title",children:"Confirmar eliminación"})}),r.jsxs("div",{className:"dash-item",style:{display:"grid",gap:10},children:[r.jsxs("div",{children:["¿Eliminar al cliente ",r.jsx("strong",{children:W.name||W.email||W.id}),"?"]}),r.jsxs("div",{style:{fontSize:13,opacity:.85},children:["Esta acción eliminará el contenedor del cliente y su carpeta S3 asociada (clientes/",String(W.documentNumber||"").trim(),")."]}),r.jsx("input",{type:"text",autoComplete:"username",value:" ",readOnly:!0,"aria-hidden":"true",style:{position:"absolute",opacity:0,height:0,width:0,pointerEvents:"none"}}),r.jsxs("label",{style:{display:"grid",gap:6},children:[r.jsx("span",{children:"Contraseña de eliminación"}),r.jsx("input",{type:"password",name:"delete-confirm",autoComplete:"new-password","data-lpignore":"true","data-1p-ignore":"true",value:R,onChange:S=>j(S.target.value),placeholder:"eliminarclientekoop",style:{background:"#1b263b",color:"#e2e8f0",border:"1px solid rgba(148,163,184,0.35)",borderRadius:8,padding:"8px 10px"}})]}),pe&&r.jsx("div",{style:{background:"#7f1d1d",color:"#fecaca",padding:8,borderRadius:6},children:pe})]}),r.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",gap:8,marginTop:12},children:[r.jsx("button",{className:"btn btn-secondary",onClick:()=>{G(!1),A(null)},disabled:T,children:"Cancelar"}),r.jsx("button",{className:"btn btn-primary",onClick:ko,disabled:T||!R,children:T?"Eliminando...":"Eliminar"})]})]})}),r.jsx("style",{children:`
        @keyframes spin {
          0% { transform: rotate(0deg); }
          100% { transform: rotate(360deg); }
        }
      `})]}):r.jsx("div",{className:"dash-page",style:{padding:40},children:r.jsxs("div",{className:"dash-card",style:{maxWidth:560},children:[r.jsx("h2",{className:"dash-title",children:"Acceso restringido"}),r.jsx("p",{style:{marginTop:12},children:"Esta seccion esta disponible solo para administradores."})]})})}const nf="koop.calendar.events";function $d(){if(typeof window>"u")return[];try{const e=window.localStorage.getItem(nf);if(!e)return[];const n=JSON.parse(e);return Array.isArray(n)?n.filter(Boolean):[]}catch(e){return console.warn("[calendarStorage] load error",e),[]}}function Iv(e){if(!(typeof window>"u"))try{window.localStorage.setItem(nf,JSON.stringify(e??[]))}catch(n){console.warn("[calendarStorage] save error",n)}}const Rv="koop.calendar.events";function rf(){const[e,n]=m.useState(()=>$d());m.useEffect(()=>{const a=i=>{(i==null?void 0:i.key)===Rv&&n($d())};return typeof window<"u"&&window.addEventListener("storage",a),()=>{typeof window<"u"&&window.removeEventListener("storage",a)}},[]);const t=m.useCallback(a=>{n(i=>{const o=typeof a=="function"?a(i):a;return Iv(o),o})},[]);return[e,t]}const zv="documentos_iniciales";function Hd(e){return String(e||"").trim()}function tf({buttonLabel:e="Subir documento",buttonClassName:n="btn btn-primary",defaultFolder:t=zv,allowFolderInput:a=!0,onUploaded:i}){const[o,s]=m.useState(!1),[l,c]=m.useState(null),[d,p]=m.useState(t||""),[u,g]=m.useState(()=>Date.now()),[y,v]=m.useState(null),[x,w]=m.useState(null),[f,h]=m.useState(!1),b=()=>{c(null),p(t||""),g(Date.now()),v(null),w(null),h(!1)},k=()=>{b(),s(!0)},E=()=>{s(!1),b()},I=z=>{var _;const F=((_=z.target.files)==null?void 0:_[0])||null;c(F),v(null),F&&w(null)},L=async z=>{var _,ee,de;if(z.preventDefault(),!l){v("Selecciona un archivo");return}const F=Hd(a?d:t);try{h(!0),v(null);const ce=await ef(l,{subfolder:F||void 0});if(w((_=ce==null?void 0:ce.file)!=null&&_.key?"Archivo subido correctamente":"Archivo subido"),c(null),g(Date.now()),typeof i=="function")try{i(ce)}catch{}}catch(ce){v(((de=(ee=ce==null?void 0:ce.response)==null?void 0:ee.data)==null?void 0:de.message)||(ce==null?void 0:ce.message)||"No se pudo subir el archivo")}finally{h(!1)}};return r.jsxs(r.Fragment,{children:[r.jsx("button",{type:"button",className:n,onClick:k,children:e}),o&&r.jsx("div",{style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:1e3,padding:16},children:r.jsxs("div",{className:"dash-card",style:{width:"100%",maxWidth:480,position:"relative"},children:[r.jsx("button",{type:"button",onClick:E,style:{position:"absolute",top:12,right:12,background:"transparent",border:"none",color:"#334155",fontSize:20,cursor:"pointer"},"aria-label":"Cerrar",children:"X"}),r.jsx("h3",{className:"dash-title",style:{marginBottom:16},children:"Subir documento"}),r.jsxs("form",{onSubmit:L,children:[r.jsxs("div",{style:{marginBottom:12},children:[r.jsx("label",{style:{display:"block",marginBottom:6,fontWeight:600},children:"Archivo"}),r.jsx("input",{type:"file",onChange:I,disabled:f,required:!0,style:{width:"100%"}},u)]}),a?r.jsxs("div",{style:{marginBottom:16},children:[r.jsx("label",{style:{display:"block",marginBottom:6,fontWeight:600},children:"Subcarpeta (opcional)"}),r.jsx("input",{type:"text",placeholder:t||"documentos_iniciales",value:d,onChange:z=>p(z.target.value),disabled:f,style:{width:"100%",padding:"8px 12px",borderRadius:8,border:"1px solid #cbd5f5"}})]}):r.jsxs("div",{style:{marginBottom:16},children:[r.jsx("label",{style:{display:"block",marginBottom:6,fontWeight:600},children:"Carpeta destino"}),r.jsx("input",{type:"text",value:t||"",readOnly:!0,style:{width:"100%",padding:"8px 12px",borderRadius:8,border:"1px solid #cbd5f5",background:"#1f2937",color:"#e2e8f0"}})]}),y&&r.jsx("div",{style:{background:"#7f1d1d",color:"#fecaca",padding:8,borderRadius:6,marginBottom:12},children:y}),x&&r.jsx("div",{style:{background:"#14532d",color:"#bbf7d0",padding:8,borderRadius:6,marginBottom:12},children:x}),r.jsxs("div",{style:{display:"flex",gap:12,justifyContent:"flex-end"},children:[r.jsx("button",{type:"button",className:"btn btn-secondary",onClick:E,disabled:f,children:"Cancelar"}),r.jsx("button",{type:"submit",className:"btn btn-primary",disabled:f||!l,children:f?"Subiendo...":"Subir"})]})]})]})})]})}const Ov=["Lun","Mar","Mie","Jue","Vie","Sab","Dom"];function Dv(e){const n=e.getFullYear(),t=e.getMonth(),i=(new Date(n,t,1).getDay()+6)%7,o=new Date(n,t+1,0).getDate(),s=[];let l=1-i;for(let c=0;c<6;c+=1){const d=[];for(let p=0;p<7;p+=1){const u=new Date(n,t,l),g=l>=1&&l<=o;d.push({date:u,inCurrentMonth:g}),l+=1}s.push(d)}return s}function Lv(e){if(!e)return null;const n=e.getFullYear(),t=`${e.getMonth()+1}`.padStart(2,"0"),a=`${e.getDate()}`.padStart(2,"0");return`${n}-${t}-${a}`}function af({value:e,onChange:n,onDateSelect:t,events:a=[],className:i=""}){const o=m.useMemo(()=>new Date,[]),[s,l]=m.useState(()=>new Date(o.getFullYear(),o.getMonth(),1)),[c,d]=m.useState(o);m.useEffect(()=>{e instanceof Date&&(d(e),l(new Date(e.getFullYear(),e.getMonth(),1)))},[e]);const p=e instanceof Date?e:c,u=typeof n=="function"?n:t,g=m.useMemo(()=>s.toLocaleDateString("es-ES",{month:"long",year:"numeric"}),[s]),y=m.useMemo(()=>Dv(s),[s]),v=m.useMemo(()=>{const h=new Map;return(a||[]).forEach(b=>{const k=(b==null?void 0:b.date)||(b==null?void 0:b.dateKey);k&&(h.has(k)||h.set(k,[]),h.get(k).push(b))}),h},[a]),x=h=>{h instanceof Date&&(e instanceof Date||d(h),typeof u=="function"&&u(h))},w=h=>{l(b=>new Date(b.getFullYear(),b.getMonth()+h,1))},f=["dash-item",i].filter(Boolean).join(" ").trim();return r.jsxs("div",{className:f,children:[r.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:12},children:[r.jsx("button",{type:"button",className:"btn btn-secondary btn-sm",onClick:()=>w(-1),"aria-label":"Mes anterior",children:"◀"}),r.jsx("div",{style:{fontWeight:600,textTransform:"capitalize"},children:g}),r.jsx("button",{type:"button",className:"btn btn-secondary btn-sm",onClick:()=>w(1),"aria-label":"Mes siguiente",children:"▶"})]}),r.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(7, 1fr)",gap:6,marginBottom:8},children:Ov.map(h=>r.jsx("div",{style:{textAlign:"center",fontSize:12,fontWeight:600,opacity:.75},children:h},h))}),r.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(7, 1fr)",gap:6},children:y.map((h,b)=>h.map(({date:k,inCurrentMonth:E},I)=>{const L=Lv(k),z=k.toDateString()===o.toDateString(),F=k.toDateString()===p.toDateString(),_=v.get(L)||[],ee={position:"relative",borderRadius:8,border:"1px solid rgba(148, 163, 184, 0.25)",padding:"8px 0",textAlign:"center",fontSize:13,cursor:E?"pointer":"default",opacity:E?1:.35,background:"#1f2937",color:"#e2e8f0",transition:"transform 0.12s ease"};return z&&(ee.border="1px solid #38bdf8"),F&&(ee.background="linear-gradient(135deg, #38b2ac, #0ea5e9)",ee.color="#0f172a",ee.fontWeight=700),E&&_.length>0&&!F&&(ee.background="#f5b891",ee.color="#0f172a",ee.border="1px solid rgba(245, 184, 145, 0.65)",ee.fontWeight=600),r.jsxs("button",{type:"button",style:ee,disabled:!E,onClick:()=>E&&x(k),children:[k.getDate(),_.length>0&&r.jsx("span",{style:{position:"absolute",bottom:4,left:"50%",transform:"translateX(-50%)",width:6,height:6,borderRadius:"999px",background:F?"#0f172a":E?"#7c3a00":"#38bdf8"}})]},`${b}-${I}`)}))})]})}function Pv({title:e="Asistente IA",systemPrompt:n}){const[t,a]=m.useState(()=>[]),[i,o]=m.useState(""),[s,l]=m.useState(!1),c=m.useRef(null),d=m.useMemo(()=>i.trim().length>0&&!s,[i,s]),p=()=>{try{const y=c.current;y&&(y.scrollTop=y.scrollHeight)}catch{}},u=async()=>{var x,w,f,h,b,k,E,I,L;const y=i.trim();if(!y)return;const v=[...t,{role:"user",content:y}];a(v),o(""),l(!0),setTimeout(p,0);try{const z={messages:[...n?[{role:"system",content:n}]:[],...v]},{data:F}=await je.post("/ai/chat",z),_=(F==null?void 0:F.reply)||((x=F==null?void 0:F.message)==null?void 0:x.content)||((h=(f=(w=F==null?void 0:F.choices)==null?void 0:w[0])==null?void 0:f.message)==null?void 0:h.content)||((E=(k=(b=F==null?void 0:F.choices)==null?void 0:b[0])==null?void 0:k.delta)==null?void 0:E.content)||"",ee=String(_||"").trim()||"Lo siento, no obtuve respuesta.";a(de=>[...de,{role:"assistant",content:ee}]),setTimeout(p,0)}catch(z){const F=((L=(I=z==null?void 0:z.response)==null?void 0:I.data)==null?void 0:L.message)||(z==null?void 0:z.message)||"Error al consultar el asistente";a(_=>[..._,{role:"assistant",content:`⚠️ ${F}`}]),setTimeout(p,0)}finally{l(!1)}},g=y=>{y.key==="Enter"&&!y.shiftKey&&(y.preventDefault(),d&&u())};return r.jsxs("div",{className:"dash-item",style:{display:"flex",flexDirection:"column",gap:10},children:[r.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between"},children:[r.jsx("div",{style:{fontWeight:600},children:e}),r.jsx("button",{type:"button",className:"btn btn-secondary btn-sm",onClick:()=>a([]),disabled:s,children:"Limpiar"})]}),r.jsxs("div",{ref:c,style:{background:"#0f172a",border:"1px solid rgba(148,163,184,0.25)",borderRadius:12,padding:10,minHeight:180,maxHeight:260,overflowY:"auto",display:"flex",flexDirection:"column",gap:8},children:[t.length===0&&r.jsx("div",{style:{opacity:.7},children:"Haz una pregunta para comenzar…"}),t.map((y,v)=>r.jsx("div",{style:{display:"flex",justifyContent:y.role==="user"?"flex-end":"flex-start"},children:r.jsx("div",{style:{maxWidth:"80%",background:y.role==="user"?"rgba(34,211,238,0.12)":"rgba(148,163,184,0.12)",border:"1px solid rgba(148,163,184,0.25)",color:"#e2e8f0",padding:"8px 10px",borderRadius:12,whiteSpace:"pre-wrap"},children:y.content})},v))]}),r.jsxs("div",{style:{display:"grid",gap:8},children:[r.jsx("textarea",{className:"textarea",rows:3,placeholder:"Escribe tu mensaje (Enter para enviar)",value:i,onChange:y=>o(y.target.value),onKeyDown:g,disabled:s}),r.jsxs("div",{style:{display:"flex",gap:8,justifyContent:"flex-end"},children:[r.jsx("button",{type:"button",className:"btn btn-secondary btn-sm",onClick:()=>o(""),disabled:s,children:"Borrar"}),r.jsx("button",{type:"button",className:"btn btn-primary",onClick:u,disabled:!d,children:s?"Enviando…":"Enviar"})]})]})]})}function Mv({label:e,value:n,hint:t}){return r.jsxs("div",{className:"dash-item",children:[r.jsx("div",{className:"text-sm opacity-70",style:{fontSize:12,opacity:.8},children:e}),r.jsx("div",{className:"text-2xl font-semibold",style:{fontSize:28,fontWeight:700},children:n}),t&&r.jsx("div",{className:"text-xs opacity-60",style:{fontSize:12,opacity:.7},children:t})]})}function of({refreshKey:e=0}){const{user:n}=We(),t=m.useMemo(()=>{var s,l,c,d;const a=Array.isArray(n==null?void 0:n.driveFolders)?n.driveFolders.filter(p=>p&&p.url):[],i=(l=(s=import.meta)==null?void 0:s.env)==null?void 0:l.VITE_DEFAULT_DRIVE_FOLDER_URL,o=((d=(c=import.meta)==null?void 0:c.env)==null?void 0:d.VITE_DEFAULT_DRIVE_FOLDER_NAME)||"Carpeta KOOP";return(!a||a.length===0)&&i?[{name:o,url:i}]:a},[n,e]);return r.jsxs("div",{className:"dash-item",children:[r.jsx("div",{className:"font-semibold mb-2",style:{fontWeight:600,marginBottom:8},children:"Documentos recientes"}),t.length===0&&r.jsx("div",{className:"text-sm opacity-60",style:{fontSize:14,opacity:.8},children:"Sin carpetas asignadas."}),t.length>0&&r.jsx("ul",{style:{listStyle:"none",padding:0,margin:0,display:"flex",flexDirection:"column",gap:8},children:t.map((a,i)=>r.jsxs("li",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:12},children:[r.jsxs("div",{style:{minWidth:0},children:[r.jsx("div",{style:{fontWeight:600,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:a.name||"Carpeta de Drive"}),r.jsx("div",{className:"muted",style:{fontSize:12,opacity:.8},children:a.url})]}),r.jsx("a",{className:"btn btn-primary",href:a.url,target:"_blank",rel:"noreferrer","data-drive-folder-url":a.url,children:"Abrir carpeta"})]},(a.url||"")+i))})]})}function _v(e){if(!(e instanceof Date))return null;const n=e.getFullYear(),t=`${e.getMonth()+1}`.padStart(2,"0"),a=`${e.getDate()}`.padStart(2,"0");return`${n}-${t}-${a}`}function Vv(){return typeof crypto<"u"&&crypto.randomUUID?crypto.randomUUID():`evt-${Date.now()}-${Math.random().toString(16).slice(2)}`}function Bv(){const{user:e}=We(),n=jo((e==null?void 0:e.name)||"Dashboard"),[t,a]=m.useState(null),[i,o]=m.useState(!0),[s,l]=m.useState(null),[c,d]=m.useState(0),[p,u]=rf(),[g,y]=m.useState(()=>new Date),v=m.useMemo(()=>_v(g),[g]),[x,w]=m.useState(""),[f,h]=m.useState(!0),[b,k]=m.useState(""),[E,I]=m.useState([]),[L,z]=m.useState(!1),[F,_]=m.useState(0),[ee,de]=m.useState(!1),ce=m.useRef(null),[K,an]=m.useState([]),[ye,Oe]=m.useState(!1),[P,$]=m.useState(null),Q=m.useMemo(()=>Array.isArray(p)?p.length:0,[p]);m.useEffect(()=>{(async()=>{var R;try{const{data:j}=await je.get("/kpis/overview");a(j)}catch(j){l(((R=j==null?void 0:j.response)==null?void 0:R.data)||(j==null?void 0:j.message))}finally{o(!1)}})()},[]),m.useEffect(()=>{let R=!1;return(async()=>{var j,Z;try{Oe(!0),$(null);const te=await lc();if(R)return;const Be=Array.isArray(te==null?void 0:te.items)?te.items:[];an(Be.map(ae=>({id:String((ae==null?void 0:ae.id)||(ae==null?void 0:ae._id)||(ae==null?void 0:ae.documentNumber)||"").trim(),name:(ae==null?void 0:ae.name)||(ae==null?void 0:ae.fullName)||(ae==null?void 0:ae.email)||"Cliente sin nombre",email:ae==null?void 0:ae.email})).filter(ae=>ae.id))}catch(te){R||$(((Z=(j=te==null?void 0:te.response)==null?void 0:j.data)==null?void 0:Z.message)||(te==null?void 0:te.message)||"No se pudo cargar clientes")}finally{R||Oe(!1)}})(),()=>{R=!0}},[]),m.useEffect(()=>{if(!ee)return;const R=Z=>{try{ce.current&&!ce.current.contains(Z.target)&&de(!1)}catch{}},j=Z=>{Z.key==="Escape"&&de(!1)};return typeof window<"u"&&(window.addEventListener("click",R),window.addEventListener("keydown",j)),()=>{typeof window<"u"&&(window.removeEventListener("click",R),window.removeEventListener("keydown",j))}},[ee]);const se=m.useMemo(()=>{if(!b)return K;const R=b.trim().toLowerCase();return K.filter(j=>[j.id,j.name,j.email].some(Z=>String(Z||"").toLowerCase().includes(R)))},[K,b]),M=m.useMemo(()=>p.filter(j=>(j==null?void 0:j.date)===v).sort((j,Z)=>(j.createdAt||"").localeCompare(Z.createdAt||"")),[p,v]),G=R=>{const j=String(R);I(Z=>Z.includes(j)?Z.filter(te=>te!==j):[...Z,j])},W=()=>{const R=x.trim();if(!v||!R||!f&&E.length===0)return;const j={id:Vv(),date:v,note:R,audience:f?{type:"all"}:{type:"clients",clientIds:E.map(Z=>String(Z).trim())},createdAt:new Date().toISOString(),createdBy:(e==null?void 0:e.id)||(e==null?void 0:e.sub)||"admin"};u(Z=>[...Z,j]),w(""),I([]),h(!0),z(!1)},A={padding:"10px 14px",fontSize:"14px",minHeight:"52px",borderRadius:"10px",fontWeight:600,display:"flex",alignItems:"center",justifyContent:"center",width:"100%"},T=[{key:"clientes",label:"Clientes",to:"/admin/clientes-activos"},{key:"procesos",label:"Procesos",to:"/mis-casos"},{key:"publicaciones",label:"Publicaciones Procesales",href:"https://koop.com/publicaciones-procesales"}],Y=m.useMemo(()=>g==null?void 0:g.toLocaleDateString("es-ES",{weekday:"long",day:"numeric",month:"long",year:"numeric"}),[g]),pe=R=>{y(R),typeof window<"u"&&window.innerWidth<1024&&z(!0)},ge=()=>{if(!v||M.length===0)return;const R=`¿Borrar todas las anotaciones del ${Y}?`;typeof window<"u"&&!window.confirm(R)||u(j=>j.filter(Z=>(Z==null?void 0:Z.date)!==v))};return m.useEffect(()=>{if(!L){_(0);return}const R=()=>{try{const Z=window.visualViewport;if(Z){const te=Math.max(0,Math.round(window.innerHeight-Z.height));_(te)}else _(0)}catch{_(0)}};R();const j=window.visualViewport;return j&&j.addEventListener("resize",R),window.addEventListener("resize",R),()=>{j&&j.removeEventListener("resize",R),window.removeEventListener("resize",R)}},[L]),r.jsxs("div",{className:"dash-page",style:{backgroundImage:"linear-gradient(rgba(13,27,42,0.65), rgba(27,38,59,0.65)), url('/fondodashboard.jpg')",backgroundSize:"cover",backgroundAttachment:"fixed",backgroundPosition:"center"},children:[r.jsxs("div",{className:"dash-card",style:{maxWidth:1200},children:[r.jsx("style",{children:`
        ...
        `}),r.jsxs("div",{className:"dash-header",children:[r.jsx("div",{className:"dash-title",children:n}),r.jsx("div",{style:{display:"flex",gap:12,flexWrap:"wrap",justifyContent:"flex-end"},children:r.jsx(tf,{buttonClassName:"btn btn-primary",allowFolderInput:!0,onUploaded:()=>d(R=>R+1)})})]}),r.jsxs("div",{className:"dash-item",style:{display:"flex",flexWrap:"wrap",gap:8},children:[r.jsx(D,{className:"btn btn-primary",to:"/admin/tareas",title:"Ver y gestionar tareas",children:`Tareas: (${Q})`}),r.jsx(D,{className:"btn btn-primary btn-sm",to:"/admin/clientes-activos",title:"Clientes",children:"Clientes"}),r.jsxs("div",{style:{position:"relative"},ref:ce,children:[r.jsx("button",{type:"button",className:"btn btn-orange btn-sm",onClick:()=>de(R=>!R),"aria-haspopup":"menu","aria-expanded":ee?"true":"false",children:"Consultas"}),ee&&r.jsxs("div",{role:"menu",className:"quick-menu",style:{position:"absolute",top:"calc(100% + 6px)",right:0,zIndex:1010,background:"#0f172a",color:"#e2e8f0",border:"1px solid rgba(148,163,184,0.25)",borderRadius:12,boxShadow:"0 10px 24px rgba(0,0,0,0.45)",minWidth:320,padding:8},onClick:R=>R.stopPropagation(),children:[r.jsx("button",{type:"button",className:"btn btn-secondary btn-sm",style:{width:"100%",justifyContent:"flex-start",marginBottom:6},onClick:()=>{typeof window<"u"&&window.open("https://consultaprocesos.ramajudicial.gov.co/Procesos/Index","_blank","noopener"),de(!1)},role:"menuitem",children:"1. Consulta de procesos Rama Judicial"}),r.jsx("button",{type:"button",className:"btn btn-secondary btn-sm",style:{width:"100%",justifyContent:"flex-start",marginBottom:6},onClick:()=>{typeof window<"u"&&window.open("https://publicacionesprocesales.ramajudicial.gov.co/","_blank","noopener"),de(!1)},role:"menuitem",children:"2. Publicaciones Procesales Rama Judicial"}),r.jsx("button",{type:"button",className:"btn btn-secondary btn-sm",style:{width:"100%",justifyContent:"flex-start",marginBottom:6},onClick:()=>{typeof window<"u"&&window.open("https://siugj.ramajudicial.gov.co/principalPortal/index.php","_blank","noopener"),de(!1)},role:"menuitem",children:"3. Siugj"}),r.jsx("button",{type:"button",className:"btn btn-secondary btn-sm",style:{width:"100%",justifyContent:"flex-start",marginBottom:6},onClick:()=>{typeof window<"u"&&window.open("https://consulta-web.fiscalia.gov.co/","_blank","noopener"),de(!1)},role:"menuitem",children:"4. Consultas Fiscalía"}),r.jsx("button",{type:"button",className:"btn btn-secondary btn-sm",style:{width:"100%",justifyContent:"flex-start"},onClick:()=>{typeof window<"u"&&window.open("https://www.superfinanciera.gov.co/formulesuqueja/faces/consulta/jurisdiccional.xhtml","_blank","noopener"),de(!1)},role:"menuitem",children:"5. Consultas Jurisdiccionales SuperFinanciera"})]})]}),r.jsx(D,{className:"btn btn-secondary btn-sm",to:"/admin/usuarios",title:"Administrar usuarios",children:"Administrar usuarios"})]}),r.jsx("div",{className:"kpi-grid",style:{marginTop:16},children:r.jsx(Mv,{label:"Casos activos",value:(K==null?void 0:K.length)??0})}),r.jsxs("div",{className:"admin-main-grid",style:{marginTop:16},children:[r.jsxs("div",{className:"admin-main-left",children:[r.jsxs("div",{className:"dash-item",children:[r.jsx("div",{className:"font-semibold mb-2",style:{fontWeight:600,marginBottom:8},children:"Centro administrativo"}),r.jsx("p",{style:{marginBottom:12},children:"Supervisa la operacion del portal, gestiona usuarios y da seguimiento a la informacion mas reciente."}),r.jsxs("div",{style:{display:"flex",flexWrap:"wrap",gap:8},children:[r.jsx(D,{className:"btn btn-primary btn-sm",to:"/admin/usuarios",title:"Administrar usuarios",children:"Administrar usuarios"}),r.jsx(D,{className:"btn btn-secondary btn-sm",to:"/mi-expediente",title:"Revisar expedientes",children:"Revisar expedientes"})]})]}),r.jsx(af,{value:g,onChange:pe,events:p}),r.jsx("div",{style:{display:"grid",gap:10},children:T.map(R=>r.jsx("div",{className:"dash-item",style:{padding:0,display:"flex",alignItems:"stretch"},children:R.to?r.jsx(D,{className:"btn btn-primary",to:R.to,style:A,children:R.label}):r.jsx("button",{type:"button",className:"btn btn-primary",style:A,onClick:()=>{typeof window<"u"&&R.href&&window.open(R.href,"_blank","noopener")},children:R.label})},R.key))})]}),r.jsxs("div",{className:"admin-main-right",children:[r.jsx(Pv,{title:"Asistente IA",systemPrompt:"Eres un asistente interno de Koop Strategic Advisory. Responde de forma breve, clara y profesional."}),r.jsxs("div",{className:"dash-item compose-panel",children:[r.jsx("div",{className:"font-semibold",style:{fontWeight:600},children:Y||"Selecciona un dia"}),r.jsx("p",{style:{marginTop:4,fontSize:13,opacity:.8},children:"Registra recordatorios o publicaciones para clientes especificos o para todos."}),r.jsx("textarea",{value:x,onChange:R=>w(R.target.value),placeholder:"Agregar nota o detalle del evento",rows:4,style:{width:"100%",marginTop:12,background:"#1b263b",color:"#e2e8f0",border:"1px solid rgba(148,163,184,0.35)",borderRadius:10,padding:"10px 12px",resize:"vertical"}}),r.jsx("div",{style:{marginTop:12},children:r.jsxs("label",{style:{display:"flex",alignItems:"center",gap:8},children:[r.jsx("input",{type:"checkbox",checked:f,onChange:R=>{h(R.target.checked),R.target.checked&&I([])}}),r.jsx("span",{children:"Publicar para todos los clientes"})]})}),!f&&r.jsxs("div",{style:{marginTop:12},children:[r.jsx("input",{type:"search",placeholder:"Buscar por nombre, email o ID",value:b,onChange:R=>k(R.target.value),style:{width:"100%",padding:"8px 12px",borderRadius:10,border:"1px solid rgba(148,163,184,0.35)",background:"#1b263b",color:"#e2e8f0"}}),P&&r.jsx("div",{style:{color:"#fecaca",background:"#7f1d1d",padding:8,borderRadius:8,marginTop:8},children:P}),r.jsxs("div",{className:"admin-clients-list",style:{marginTop:8},children:[ye&&r.jsx("div",{style:{opacity:.7},children:"Cargando clientes..."}),!ye&&se.length===0&&r.jsx("div",{style:{opacity:.7},children:"No se encontraron clientes"}),se.map(R=>{const j=E.includes(R.id);return r.jsxs("label",{className:"admin-clients-item",children:[r.jsxs("span",{style:{display:"flex",flexDirection:"column"},children:[r.jsx("span",{style:{fontWeight:600},children:R.name}),r.jsx("span",{style:{fontSize:12,opacity:.75},children:R.id})]}),r.jsx("input",{type:"checkbox",checked:j,onChange:()=>G(R.id)})]},R.id)})]}),E.length>0&&r.jsxs("div",{style:{marginTop:8,fontSize:12,opacity:.7},children:["Seleccionados: ",E.join(", ")]})]}),r.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",gap:10,marginTop:12},children:[r.jsx("button",{type:"button",className:"btn btn-secondary",onClick:()=>{w(""),h(!0),I([])},children:"Limpiar"}),r.jsx("button",{type:"button",className:"btn btn-danger",onClick:ge,disabled:!v||M.length===0,children:"Borrar anotaciones"}),r.jsx("button",{type:"button",className:"btn btn-primary",onClick:W,disabled:!x.trim()||!f&&E.length===0,children:"Guardar anotacion"})]}),M.length>0&&r.jsxs("div",{style:{marginTop:16},children:[r.jsx("div",{style:{fontWeight:600,marginBottom:8},children:"Anotaciones del dia"}),r.jsx("div",{style:{display:"flex",flexDirection:"column",gap:8},children:M.map(R=>{var j,Z;return r.jsxs("div",{style:{border:"1px solid rgba(148,163,184,0.35)",borderRadius:10,padding:10,background:"#1b263b"},children:[r.jsx("div",{style:{marginBottom:6},children:R.note}),r.jsx("div",{style:{fontSize:12,opacity:.7},children:((j=R.audience)==null?void 0:j.type)==="all"?"Visible para todos los clientes":`Visible para: ${Array.isArray((Z=R.audience)==null?void 0:Z.clientIds)&&R.audience.clientIds.length>0?R.audience.clientIds.join(", "):"—"}`})]},R.id)})})]})]}),r.jsxs("div",{className:"dash-item",children:[r.jsx("div",{className:"font-semibold mb-2",style:{fontWeight:600,marginBottom:8},children:"Recordatorios del equipo"}),r.jsx("p",{style:{marginBottom:0},children:"Comparte novedades internas, carga reportes de gestion o establece tareas prioritarias para tu equipo desde esta seccion."})]}),r.jsxs("div",{className:"dash-item",children:[r.jsx("div",{className:"font-semibold mb-2",style:{fontWeight:600,marginBottom:8},children:"Reproductor Spotify"}),r.jsx("p",{style:{marginBottom:0,fontSize:13,opacity:.8},children:"El reproductor de Spotify está disponible como ventana flotante en la esquina inferior izquierda. La música continuará reproduciéndose mientras navegas entre páginas."})]})]})]}),r.jsx("div",{style:{marginTop:16},children:r.jsx(of,{refreshKey:c})}),s&&r.jsx("pre",{className:"text-red-600 text-sm mt-2",style:{color:"#fecaca",background:"#7f1d1d",padding:12,borderRadius:8,marginTop:12},children:typeof s=="string"?s:JSON.stringify(s,null,2)})]}),L&&r.jsx("div",{className:"compose-overlay",role:"dialog","aria-modal":"true",children:r.jsxs("div",{className:"compose-modal",style:{marginBottom:F>0?F:0,maxHeight:`calc(100dvh - ${F}px)`,paddingBottom:"calc(16px + env(safe-area-inset-bottom))"},children:[r.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8},children:[r.jsx("div",{style:{fontWeight:700},children:Y||"Selecciona un dia"}),r.jsx("button",{type:"button",className:"btn btn-secondary btn-sm",onClick:()=>z(!1),"aria-label":"Cerrar",children:"Cerrar"})]}),r.jsxs("div",{className:"dash-item",style:{padding:0},children:[r.jsx("p",{style:{marginTop:4,fontSize:13,opacity:.8},children:"Registra recordatorios o publicaciones para clientes especificos o para todos."}),r.jsx("textarea",{value:x,onChange:R=>w(R.target.value),placeholder:"Agregar nota o detalle del evento",rows:4,style:{width:"100%",marginTop:12,background:"#1b263b",color:"#e2e8f0",border:"1px solid rgba(148,163,184,0.35)",borderRadius:10,padding:"10px 12px",resize:"vertical"}}),r.jsx("div",{style:{marginTop:12},children:r.jsxs("label",{style:{display:"flex",alignItems:"center",gap:8},children:[r.jsx("input",{type:"checkbox",checked:f,onChange:R=>{h(R.target.checked),R.target.checked&&I([])}}),r.jsx("span",{children:"Publicar para todos los clientes"})]})}),!f&&r.jsxs("div",{style:{marginTop:12},children:[r.jsx("input",{type:"search",placeholder:"Buscar por nombre, email o ID",value:b,onChange:R=>k(R.target.value),style:{width:"100%",padding:"8px 12px",borderRadius:10,border:"1px solid rgba(148,163,184,0.35)",background:"#1b263b",color:"#e2e8f0"}}),P&&r.jsx("div",{style:{color:"#fecaca",background:"#7f1d1d",padding:8,borderRadius:8,marginTop:8},children:P}),r.jsxs("div",{className:"admin-clients-list",style:{marginTop:8},children:[ye&&r.jsx("div",{style:{opacity:.7},children:"Cargando clientes..."}),!ye&&se.length===0&&r.jsx("div",{style:{opacity:.7},children:"No se encontraron clientes"}),se.map(R=>{const j=E.includes(R.id);return r.jsxs("label",{className:"admin-clients-item",children:[r.jsxs("span",{style:{display:"flex",flexDirection:"column"},children:[r.jsx("span",{style:{fontWeight:600},children:R.name}),r.jsx("span",{style:{fontSize:12,opacity:.75},children:R.id})]}),r.jsx("input",{type:"checkbox",checked:j,onChange:()=>G(R.id)})]},R.id)})]}),E.length>0&&r.jsxs("div",{style:{marginTop:8,fontSize:12,opacity:.7},children:["Seleccionados: ",E.join(", ")]})]}),r.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",gap:10,marginTop:12},children:[r.jsx("button",{type:"button",className:"btn btn-secondary",onClick:()=>{w(""),h(!0),I([])},children:"Limpiar"}),r.jsx("button",{type:"button",className:"btn btn-danger",onClick:ge,disabled:!v||M.length===0,children:"Borrar anotaciones"}),r.jsx("button",{type:"button",className:"btn btn-primary",onClick:W,disabled:!x.trim()||!f&&E.length===0,children:"Guardar anotacion"})]}),M.length>0&&r.jsxs("div",{style:{marginTop:16},children:[r.jsx("div",{style:{fontWeight:600,marginBottom:8},children:"Anotaciones del dia"}),r.jsx("div",{style:{display:"flex",flexDirection:"column",gap:8},children:M.map(R=>{var j,Z;return r.jsxs("div",{style:{border:"1px solid rgba(148,163,184,0.35)",borderRadius:10,padding:10,background:"#1b263b"},children:[r.jsx("div",{style:{marginBottom:6},children:R.note}),r.jsx("div",{style:{fontSize:12,opacity:.7},children:((j=R.audience)==null?void 0:j.type)==="all"?"Visible para todos los clientes":`Visible para: ${Array.isArray((Z=R.audience)==null?void 0:Z.clientIds)&&R.audience.clientIds.length>0?R.audience.clientIds.join(", "):"-"}`})]},R.id)})})]})]})]})})]})}function Fv({src:e,heightDesktop:n=560,heightMobile:t=480,className:a}){const[i,o]=m.useState(!1),[s,l]=m.useState(!1),c=m.useRef(null);m.useEffect(()=>{try{const x=window.matchMedia("(max-width: 768px)"),w=f=>{o(f.matches),f.matches&&l(!1)};return o(x.matches),x.matches&&l(!1),x.addEventListener?x.addEventListener("change",w):x.addListener&&x.addListener(w),()=>{x.removeEventListener?x.removeEventListener("change",w):x.removeListener&&x.removeListener(w)}}catch{o(!1)}},[]),m.useEffect(()=>{if(!s){c.current!==null&&(document.body.style.overflow=c.current,c.current=null);return}return c.current===null&&(c.current=document.body.style.overflow||""),document.body.style.overflow="hidden",()=>{c.current!==null?(document.body.style.overflow=c.current,c.current=null):document.body.style.overflow=""}},[s]);const d=m.useMemo(()=>{try{return new URL(e,window.location.origin).toString()}catch{return e}},[e]),p=()=>l(x=>!x),u=["Te compartimos que ya tienes acceso a nuestro Portal de Clientes Koop.","","Desde alli podras:","- Consultar el estado de tus procesos en tiempo real.","- Descargar documentos relevantes de manera segura.","- Recibir notificaciones de audiencias y plazos importantes.","- Comunicarte directamente con nuestro equipo para resolver cualquier inquietud.","","Estamos seguros de que esta alianza marcara un camino de crecimiento y tranquilidad."].join(`
`);if(i)return r.jsxs("div",{className:a,style:{width:"100%",height:t,display:"flex",flexDirection:"column"},children:[r.jsxs("div",{style:{padding:16},children:[r.jsx("div",{style:{fontWeight:700,marginBottom:8},children:"Gracias por elegirnos. Nos alegra iniciar este camino contigo."}),r.jsx("div",{className:"muted",style:{marginBottom:12,whiteSpace:"pre-line"},children:u})]}),r.jsx("div",{style:{marginTop:"auto",padding:16,display:"flex",justifyContent:"flex-end"},children:r.jsx("a",{className:"btn btn-primary",href:d,target:"_blank",rel:"noopener noreferrer",children:"Cordial saludo"})})]});const g=s?{position:"fixed",inset:0,zIndex:1e3,backgroundColor:"rgba(6, 11, 25, 0.92)",padding:"48px 64px",display:"flex",flexDirection:"column",gap:16}:{width:"100%",height:n,position:"relative"},y=s?{flex:1,position:"relative",borderRadius:16,overflow:"hidden",boxShadow:"0 24px 48px rgba(0,0,0,0.45)"}:{width:"100%",height:"100%",position:"relative",borderRadius:12,overflow:"hidden"},v={position:"absolute",top:s?24:12,right:s?24:12,zIndex:1001};return r.jsxs("div",{className:a,style:g,children:[r.jsx("button",{type:"button",className:"btn btn-primary btn-sm",onClick:p,style:v,children:s?"Minimizar":"Maximizar"}),r.jsx("div",{style:y,children:r.jsxs("object",{data:e,type:"application/pdf",width:"100%",height:"100%",style:{width:"100%",height:"100%"},children:[r.jsx("iframe",{title:"PDF",src:d,style:{width:"100%",height:"100%",border:0}}),r.jsxs("div",{style:{padding:16},children:["No se pudo mostrar el PDF. ",r.jsx("a",{href:e,target:"_blank",rel:"noopener noreferrer",children:"Abrir en nueva pestana"})]})]})})]})}function Uv(){return r.jsxs("div",{className:"dash-item",children:[r.jsx("div",{className:"font-semibold mb-2",style:{fontWeight:600,marginBottom:8},children:"Mensajes no leídos"}),r.jsx("div",{className:"text-sm opacity-60",style:{fontSize:14,opacity:.8},children:"Sin datos."})]})}function Zv(e){if(!(e instanceof Date))return null;const n=e.getFullYear(),t=`${e.getMonth()+1}`.padStart(2,"0"),a=`${e.getDate()}`.padStart(2,"0");return`${n}-${t}-${a}`}function Kv(){const{user:e}=We(),n=jo((e==null?void 0:e.name)||"Bienvenido"),[t,a]=m.useState(0),[i]=rf(),[o,s]=m.useState(()=>new Date),l=m.useMemo(()=>{const y=[e==null?void 0:e.id,e==null?void 0:e.sub,e==null?void 0:e._id,e==null?void 0:e.documentNumber,e==null?void 0:e.document_number,e==null?void 0:e.documento,e==null?void 0:e.clienteId].map(v=>v==null?"":String(v).trim()).filter(v=>!!v);return Array.from(new Set(y))},[e]),c=m.useMemo(()=>Zv(o),[o]),d=m.useMemo(()=>l.length?i.filter(g=>{var y,v,x;return((y=g==null?void 0:g.audience)==null?void 0:y.type)==="all"?!0:((v=g==null?void 0:g.audience)==null?void 0:v.type)==="clients"?(Array.isArray((x=g.audience)==null?void 0:x.clientIds)?g.audience.clientIds.map(f=>f==null?"":String(f).trim()).filter(f=>!!f):[]).some(f=>l.includes(f)):!1}):i.filter(g=>{var y;return((y=g==null?void 0:g.audience)==null?void 0:y.type)==="all"}),[i,l]),p=m.useMemo(()=>d.filter(g=>(g==null?void 0:g.date)===c),[d,c]),u=m.useMemo(()=>o==null?void 0:o.toLocaleDateString("es-ES",{weekday:"long",day:"numeric",month:"long",year:"numeric"}),[o]);return r.jsx("div",{className:"dash-page",style:{backgroundImage:"linear-gradient(rgba(13,27,42,0.65), rgba(27,38,59,0.65)), url('/fondodashboard.jpg')",backgroundSize:"cover",backgroundAttachment:"fixed",backgroundPosition:"center"},children:r.jsxs("div",{className:"dash-card",style:{maxWidth:1080},children:[r.jsx("style",{children:`
        ...
        `}),r.jsxs("div",{className:"dash-header",children:[r.jsx("div",{className:"dash-title",children:n}),r.jsx(tf,{buttonClassName:"btn btn-primary",allowFolderInput:!1,onUploaded:()=>a(g=>g+1)})]}),r.jsxs("div",{className:"user-main-grid",children:[r.jsxs("div",{className:"user-main-left",children:[r.jsxs("div",{className:"dash-item",children:[r.jsx("p",{style:{marginBottom:8},children:"Aqui puedes revisar tu material mas reciente y mantenerte al dia con tu caso. Si necesitas asistencia adicional, nuestro equipo esta disponible para ayudarte."}),r.jsx(D,{className:"btn btn-primary btn-sm",to:"/mis-casos",children:"Ver mis casos"})]}),r.jsx("div",{className:"dash-item",style:{padding:0},children:r.jsx(Fv,{src:"/Saludobienvenidaportal.pdf",heightDesktop:480,heightMobile:420})}),r.jsx(Uv,{}),r.jsx(of,{refreshKey:t})]}),r.jsxs("div",{className:"user-main-right",children:[r.jsx(af,{value:o,onChange:s,events:d}),r.jsxs("div",{className:"dash-item",children:[r.jsx("div",{style:{fontWeight:600,marginBottom:8},children:u}),p.length===0&&r.jsx("p",{style:{margin:0,opacity:.7,fontSize:14},children:"No hay anotaciones programadas para este dia."}),p.length>0&&r.jsx("div",{style:{display:"flex",flexDirection:"column",gap:8},children:p.map(g=>r.jsx("div",{style:{border:"1px solid rgba(148,163,184,0.35)",borderRadius:10,padding:10,background:"#1b263b"},children:r.jsx("div",{children:g.note})},g.id))})]})]})]})]})})}function qd(){return r.jsx("div",{className:"dash-page",style:{background:"linear-gradient(rgba(24,31,56,0.9), rgba(15,23,42,0.95))",display:"flex",alignItems:"center",justifyContent:"center",minHeight:"60vh",textAlign:"center",padding:24},children:r.jsxs("div",{className:"dash-card",style:{maxWidth:520},children:[r.jsx("h2",{className:"dash-title",children:"Acceso restringido"}),r.jsx("p",{style:{marginTop:12},children:"Tu cuenta no tiene un rol asignado para ingresar al portal. Comunicate con el administrador para solicitar acceso."})]})})}function Yd(e,n){if(!(e!=null&&e.roles))return!1;const t=Array.isArray(e.roles)?e.roles:[e.roles],a=String(n||"").toLowerCase();return t.some(i=>String(i||"").toLowerCase()===a)}function Wv(){const{user:e,loading:n}=We(),t=m.useMemo(()=>e?Yd(e,"admin")?"admin":Yd(e,"user")?"user":"no-access":"none",[e]);return n&&!e?null:t==="admin"?r.jsx(Bv,{}):t==="user"?r.jsx(Kv,{}):t==="no-access"?r.jsx(qd,{}):r.jsx(qd,{})}const $v=[{id:"CJ-001",titulo:"Acción de tutela — derecho a la salud",estado:"En curso",juzgado:"Juzgado 12 Municipal",fecha:"2025-07-10"},{id:"CJ-002",titulo:"Proceso laboral — despido sin justa causa",estado:"Audiencia programada",juzgado:"Juzgado 3 Laboral del Circuito",fecha:"2025-08-02"},{id:"CJ-003",titulo:"Responsabilidad fiscal — recursos",estado:"Recurso interpuesto",juzgado:"Contraloría Distrital",fecha:"2025-08-21"},{id:"CJ-004",titulo:"Proceso de alimentos — fijación de cuota",estado:"Admitido",juzgado:"Juzgado 5 de Familia",fecha:"2025-09-01"}];function Hv(){const[e,n]=m.useState(null);m.useEffect(()=>{if(!e)return;const i=o=>{o.key==="Escape"&&n(null)};return window.addEventListener("keydown",i),()=>window.removeEventListener("keydown",i)},[e]);const t=m.useMemo(()=>["Reunión de documentos e investigación","En escrito de demanda","En radicación","Al despacho: en espera de decisión del juez"],[]),a=i=>{if(!i)return 1;const o=String(i).toLowerCase();return/(reun|investig)/.test(o)?1:/(escrito|demanda)/.test(o)?2:/(radicaci[óo]n|admitid)/.test(o)?3:/(despacho|juez|decisi[óo]n|audiencia|recurso)/.test(o)?4:(/curso/.test(o),2)};return r.jsxs("div",{className:"dash-page",style:{backgroundImage:"linear-gradient(rgba(13,27,42,0.65), rgba(27,38,59,0.65)), url('/fondodashboard.jpg')",backgroundSize:"cover",backgroundAttachment:"fixed",backgroundPosition:"center"},children:[r.jsxs("div",{className:"dash-card",style:{maxWidth:900},children:[r.jsx("div",{className:"dash-header",children:r.jsx("div",{className:"dash-title",children:"Mis casos"})}),r.jsx("div",{className:"dash-item",style:{padding:0},children:r.jsx("div",{style:{overflowX:"auto"},children:r.jsxs("table",{className:"cases-table",style:{width:"100%",borderCollapse:"collapse"},children:[r.jsx("thead",{children:r.jsxs("tr",{style:{background:"#1e2a3a"},children:[r.jsx("th",{style:Yt,children:"Radicado"}),r.jsx("th",{style:Yt,children:"Título"}),r.jsx("th",{style:Yt,children:"Estado"}),r.jsx("th",{style:Yt,children:"Despacho"}),r.jsx("th",{style:Yt,children:"Última actuación"})]})}),r.jsx("tbody",{children:$v.map(i=>r.jsxs("tr",{onClick:()=>n(i),className:"row-clickable",children:[r.jsx("td",{style:Gt,children:i.id}),r.jsx("td",{style:Gt,children:i.titulo}),r.jsx("td",{style:Gt,children:r.jsx("span",{className:"badge",style:Gd(i.estado),children:i.estado})}),r.jsx("td",{style:Gt,children:i.juzgado}),r.jsx("td",{style:Gt,children:new Date(i.fecha).toLocaleDateString()})]},i.id))})]})})})]}),e&&r.jsx("div",{className:"modal-overlay",role:"dialog","aria-modal":"true","aria-labelledby":"caso-title",onClick:i=>{i.target===i.currentTarget&&n(null)},children:r.jsxs("div",{className:"modal-card",children:[r.jsxs("div",{className:"modal-header",children:[r.jsx("div",{className:"modal-title",id:"caso-title",children:e.titulo}),r.jsx("button",{className:"btn btn-primary",onClick:()=>n(null),children:"Cerrar"})]}),r.jsxs("div",{className:"modal-body",children:[r.jsxs("div",{className:"case-grid",children:[r.jsxs("div",{children:[r.jsx("div",{className:"muted",children:"Radicado"}),r.jsx("div",{children:e.id})]}),r.jsxs("div",{children:[r.jsx("div",{className:"muted",children:"Estado"}),r.jsx("div",{children:r.jsx("span",{className:"badge",style:Gd(e.estado),children:e.estado})})]}),r.jsxs("div",{children:[r.jsx("div",{className:"muted",children:"Despacho"}),r.jsx("div",{children:e.juzgado})]}),r.jsxs("div",{children:[r.jsx("div",{className:"muted",children:"Última actuación"}),r.jsx("div",{children:new Date(e.fecha).toLocaleString()})]})]}),r.jsx("div",{className:"timeline",children:t.map((i,o)=>{const s=o+1,l=a(e.estado),c=s<l,d=s===l;return r.jsxs("div",{className:`timeline-step ${c?"done":""} ${d?"active":""}`,children:[r.jsx("div",{className:`dot ${c?"done":""} ${d?"active":""}`}),s<t.length&&r.jsx("div",{className:`bar ${s<l?"done":""}`}),r.jsxs("div",{className:"label",children:[s,". ",i]})]},s)})})]})]})})]})}const Yt={textAlign:"left",padding:"12px 14px",borderBottom:"1px solid #394b61",fontWeight:600,color:"#e2e8f0",whiteSpace:"nowrap"},Gt={padding:"12px 14px",borderBottom:"1px solid #34465a",color:"#e5edf7",verticalAlign:"top"};function Gd(e){let n="#3b82f6";return/curso/i.test(e)&&(n="#f59e0b"),/programada|programado/i.test(e)&&(n="#10b981"),/recurso/i.test(e)&&(n="#8b5cf6"),{display:"inline-block",padding:"4px 8px",borderRadius:8,background:n,color:"#fff",fontSize:12,fontWeight:600}}function qv(){var a,i;const{logout:e}=We(),n=Vn();m.useEffect(()=>{(async()=>{try{await e()}catch{}try{sessionStorage.removeItem("koop_hasVisited")}catch{}try{document.documentElement.classList.remove("skip-splash")}catch{}})()},[e]);const t=(i=(a=n.state)==null?void 0:a.from)==null?void 0:i.pathname;return r.jsx(Fe,{to:"/",replace:!0,state:{from:t}})}function Yv(){const e=Lr(),[n]=Vg(),{user:t}=We();m.useEffect(()=>{const i=n.get("code"),o=n.get("error");if(o){console.error("Spotify authorization error:",o),e("/dashboard");return}i?a(i):e("/dashboard")},[n,e]);const a=async i=>{try{if(console.log("🔄 Iniciando intercambio de código por token:",{code:(i==null?void 0:i.substring(0,10))+"...",user:!!t}),!t){console.error("❌ Usuario no autenticado"),e("/login");return}console.log("📤 Enviando petición al backend...");const o=localStorage.getItem("accessToken");console.log("🔑 Token disponible:",!!o,(o==null?void 0:o.substring(0,20))+"..."),console.log("📋 Headers que se enviarán:",{Authorization:`Bearer ${o==null?void 0:o.substring(0,20)}...`}),console.log("📡 Enviando petición POST a /spotify/auth/token...");const s=await je.post("/spotify/auth/token",{code:i},{headers:{Authorization:`Bearer ${o}`}});if(console.log("✅ Respuesta recibida:",s.status,s.data),s.status===200){const{access_token:l,refresh_token:c,expires_in:d}=s.data;localStorage.setItem("spotifyAccessToken",l),localStorage.setItem("spotifyRefreshToken",c),localStorage.setItem("spotifyTokenExpiry",Date.now()+d*1e3),console.log("💾 Tokens de Spotify guardados en localStorage"),e("/dashboard")}else console.error("Error exchanging code for token"),e("/dashboard")}catch(o){console.error("Error exchanging code for token:",o),e("/dashboard")}};return r.jsxs("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",height:"100vh",backgroundColor:"#191414"},children:[r.jsxs("div",{style:{textAlign:"center",color:"#1db954"},children:[r.jsx("div",{style:{fontSize:"24px",marginBottom:"16px"},children:"Conectando con Spotify..."}),r.jsx("div",{style:{width:"40px",height:"40px",border:"4px solid #1db954",borderTop:"4px solid transparent",borderRadius:"50%",animation:"spin 1s linear infinite",margin:"0 auto"}})]}),r.jsx("style",{children:`
        @keyframes spin {
          0% { transform: rotate(0deg); }
          100% { transform: rotate(360deg); }
        }
      `})]})}function pr({children:e}){const{isAuthenticated:n}=We(),t=Vn();return n?e:r.jsx(Fe,{to:"/login",replace:!0,state:{from:t}})}function Gv(){const{isAuthenticated:e,user:n,logout:t}=We(),i=(Array.isArray(n==null?void 0:n.roles)?n.roles:n!=null&&n.roles?[n.roles]:[]).map(y=>String(y||"").trim().toLowerCase()).includes("admin"),[o,s]=m.useState(!1),[l,c]=m.useState(!1),[d,p]=m.useState(!1);Lr();const u=()=>{c(y=>{const v=!y;return v||p(!1),v})},g=y=>{const v=y.target.closest("a");v&&!v.classList.contains("drop-btn")&&(c(!1),p(!1))};return r.jsx("nav",{className:"navbar",children:r.jsxs("div",{className:"navbar-content",children:[r.jsxs(D,{to:"/",className:"logo",children:[r.jsx("img",{src:"/Koop Logo.png",alt:"Logo Koop",className:"logo-img"}),r.jsx("div",{className:"logo-text",children:"KOOP STRATEGIC ADVISORY"})]}),r.jsxs("div",{className:"menu-toggle",id:"menu-toggle",onClick:u,"aria-controls":"nav-menu","aria-expanded":l?"true":"false",role:"button",children:[r.jsx("span",{}),r.jsx("span",{}),r.jsx("span",{})]}),r.jsxs("div",{className:`nav-menu ${l?"open":""}`,id:"nav-menu",onClick:g,"data-auth":e?"1":"0",children:[r.jsxs("div",{className:"main-links",children:[r.jsx(D,{to:"/#inicio",children:"INICIO"}),r.jsxs("div",{className:`dropdown ${d?"open":""}`,children:[r.jsx(D,{to:"/#areas",className:"drop-btn",id:"areas-toggle","aria-expanded":d?"true":"false",onClick:y=>{y.preventDefault(),p(v=>!v)},children:"ÁREAS DE PRÁCTICA"}),r.jsxs("div",{className:"dropdown-content",children:[r.jsxs("div",{className:"dropdown-group",children:[r.jsx(D,{to:"/derecho",className:"dropdown-title",children:"Derecho"}),r.jsx(D,{to:"/derecho-laboral",children:"Derecho Laboral"}),r.jsx(D,{to:"/derecho-penal",children:"Derecho Penal"}),r.jsx(D,{to:"/tramites-notariales",children:"Trámites notariales"}),r.jsx(D,{to:"/derecho-administrativo",children:"Derecho Administrativo"}),r.jsx(D,{to:"/derecho-familia",children:"Derecho de Familia"}),r.jsx(D,{to:"/contratacion-publica",children:"Contratación Pública"}),r.jsx(D,{to:"/resolucion-disputas",children:"Resolución de Disputas"}),r.jsx(D,{to:"/acciones-de-tutela",children:"Acciones de Tutela"}),r.jsx(D,{to:"/insolvencia",children:"Insolvencia"})]}),r.jsxs("div",{className:"dropdown-group",children:[r.jsx(D,{to:"/contabilidad",className:"dropdown-title",children:"Contabilidad"}),r.jsx(D,{to:"/auditoria",children:"Auditoría"}),r.jsx(D,{to:"/impuestos",children:"Impuestos"}),r.jsx(D,{to:"/asesoria-contable",children:"Asesoría Contable"})]})]})]}),!e&&r.jsx(D,{to:"/#vision",children:"NUESTRA VISIÓN"})]}),e?r.jsxs("div",{className:`dropdown ${o?"open":""}`,children:[r.jsx("button",{className:"drop-btn","aria-haspopup":"true","aria-expanded":o?"true":"false",onClick:()=>s(y=>!y),children:jo((n==null?void 0:n.name)||"Mi cuenta")}),r.jsx("div",{className:"dropdown-content",children:r.jsxs("div",{className:"dropdown-group",children:[r.jsx(D,{to:"/dashboard",children:"Perfil"}),i&&r.jsx(D,{to:"/admin/clientes-activos",children:"Clientes"}),i&&r.jsx(D,{to:"/admin/usuarios",children:"Usuarios"}),r.jsx(D,{to:"/mi-expediente",children:i?"Mis expedientes":"Mi expediente"}),i&&r.jsx(D,{to:"/admin/tareas",children:"Tareas"}),r.jsx(D,{to:"/mis-casos",children:"Mis casos"}),r.jsx(D,{to:"/logout",children:"Cerrar sesión"})]})})]}):r.jsx(D,{to:"/login",className:"koop-cta","aria-label":"CLIENTE KOOP",translate:"no",children:"CLIENTE KOOP".split("").map((y,v)=>r.jsx("span",{className:"letter",style:{"--i":v},children:y===" "?" ":y},v))})]})]})})}function Jv({base:e="'Montserrat', Arial, sans-serif",heading:n,accent:t,children:a}){return m.useEffect(()=>{const i=document.documentElement;e&&i.style.setProperty("--ff-base",e),n&&i.style.setProperty("--ff-heading",n),t&&i.style.setProperty("--ff-accent",t)},[e,n,t]),a||null}function Qv(){var W;const{user:e}=We(),[n,t]=m.useState(!1),[a,i]=m.useState(null),[o,s]=m.useState(!1),[l,c]=m.useState([]),[d,p]=m.useState(!1),[u,g]=m.useState({x:window.innerWidth-80,y:window.innerHeight-80}),[y,v]=m.useState(!1),[x,w]=m.useState({x:0,y:0}),[f,h]=m.useState(!1),[b,k]=m.useState({x:0,y:0}),[E,I]=m.useState(!1),[L,z]=m.useState(!1),[F,_]=m.useState("1Zf1rz0XX6fyNxKOq4XvgN"),ee=m.useRef(null),de=m.useRef(null),ce=(W=e==null?void 0:e.roles)==null?void 0:W.includes("admin");m.useEffect(()=>{const A=localStorage.getItem("spotifyWidgetPosition");A&&g(JSON.parse(A));const T=localStorage.getItem("spotifyWidgetExpanded");T&&s(JSON.parse(T));const Y=localStorage.getItem("spotifyWidgetMinimized");Y&&I(JSON.parse(Y));const pe=localStorage.getItem("spotifyCurrentPlaylistId");pe&&_(pe)},[]),m.useEffect(()=>{localStorage.setItem("spotifyWidgetPosition",JSON.stringify(u))},[u]),m.useEffect(()=>{localStorage.setItem("spotifyWidgetExpanded",JSON.stringify(o))},[o]),m.useEffect(()=>{localStorage.setItem("spotifyWidgetMinimized",JSON.stringify(E))},[E]),m.useEffect(()=>{localStorage.setItem("spotifyCurrentPlaylistId",F)},[F]),m.useEffect(()=>{if(ce){K();const A=()=>{K()};return window.addEventListener("focus",A),()=>{window.removeEventListener("focus",A)}}},[ce]);const K=async()=>{try{const A=localStorage.getItem("spotifyAccessToken"),T=localStorage.getItem("spotifyTokenExpiry");if(A&&T&&Date.now()<parseInt(T)){console.log("🎵 Usando tokens de Spotify del localStorage");const Y=await fetch("https://api.spotify.com/v1/me",{headers:{Authorization:`Bearer ${A}`}});if(Y.ok){const pe=await Y.json();i(pe),t(!0),console.log("✅ Usuario de Spotify autenticado:",pe.display_name),await an(A)}else throw new Error("Token de Spotify inválido")}else{const Y=await je.get("/spotify/me");i(Y.data),t(!0)}}catch{console.log("No hay sesión de Spotify activa"),t(!1),i(null)}},an=async A=>{try{const T=await fetch("https://api.spotify.com/v1/me/playlists?limit=20",{headers:{Authorization:`Bearer ${A}`}});if(T.ok){const Y=await T.json();c(Y.items),console.log("📋 Playlists cargadas:",Y.items.length)}}catch(T){console.error("Error cargando playlists:",T)}},ye=async()=>{try{const A=await je.get("/spotify/auth/url");window.location.href=A.data.authUrl}catch(A){console.error("Error getting auth URL:",A)}},Oe=A=>{const T=A.type==="mousedown"?A.clientX:A.touches[0].clientX,Y=A.type==="mousedown"?A.clientY:A.touches[0].clientY;v(!0),h(!1),k({x:T,y:Y}),w({x:T-u.x,y:Y-u.y})},P=A=>{if(!y)return;const T=A.type==="mousemove"?A.clientX:A.touches[0].clientX,Y=A.type==="mousemove"?A.clientY:A.touches[0].clientY,pe=T-x.x,ge=Y-x.y,R=Math.abs(T-b.x),j=Math.abs(Y-b.y);(R>5||j>5)&&h(!0);const Z=10,te=window.innerWidth-(o?300:60)-Z,Be=window.innerHeight-(o?350:60)-Z;g({x:Math.max(Z,Math.min(pe,te)),y:Math.max(Z,Math.min(ge,Be))})},$=()=>{v(!1)};m.useEffect(()=>(y&&(document.addEventListener("mousemove",P),document.addEventListener("mouseup",$),document.addEventListener("touchmove",P),document.addEventListener("touchend",$)),()=>{document.removeEventListener("mousemove",P),document.removeEventListener("mouseup",$),document.removeEventListener("touchmove",P),document.removeEventListener("touchend",$)}),[y,x,b]),m.useEffect(()=>{const A=T=>{ee.current&&!ee.current.contains(T.target)&&o&&(s(!1),I(!0))};return o&&(document.addEventListener("mousedown",A),document.addEventListener("touchstart",A)),()=>{document.removeEventListener("mousedown",A),document.removeEventListener("touchstart",A)}},[o]),m.useEffect(()=>{const A=T=>{T.origin==="https://open.spotify.com"&&(T.data&&T.data.type==="playback_started"?z(!0):T.data&&T.data.type==="playback_paused"&&z(!1))};return window.addEventListener("message",A),()=>window.removeEventListener("message",A)},[]);const Q=A=>{_(A),de.current&&(de.current.src=`https://open.spotify.com/embed/playlist/${A}?utm_source=generator&theme=0`),p(!1)};if(!ce)return null;const se=()=>{const A=window.innerWidth-u.x,T=window.innerHeight-u.y;return A<300&&T<350?"top-left":A<300?"left":T<350?"top":"default"},G=o?(()=>{const A=se(),T=10;switch(A){case"top-left":return{x:Math.max(T,u.x-240),y:Math.max(T,u.y-290)};case"left":return{x:Math.max(T,u.x-240),y:u.y};case"top":return{x:u.x,y:Math.max(T,u.y-290)};default:return u}})():u;return r.jsxs(r.Fragment,{children:[n&&r.jsx("iframe",{ref:de,src:`https://open.spotify.com/embed/playlist/${F}?utm_source=generator&theme=0`,width:o?"100%":"1",height:o?"220":"1",frameBorder:"0",allowtransparency:"true",allow:"encrypted-media",style:{position:"fixed",top:o?`${G.y+60}px`:"-1000px",left:o?`${G.x+12}px`:"-1000px",opacity:o?1:0,pointerEvents:o?"auto":"none",zIndex:o?1001:-1,borderRadius:o?"6px":"0",border:o?"1px solid rgba(255, 255, 255, 0.1)":"none",backgroundColor:o?"rgba(40, 40, 40, 0.8)":"transparent",width:o?"276px":"1px",height:o?"220px":"1px"}}),r.jsxs("div",{ref:ee,style:{position:"fixed",left:G.x,top:G.y,zIndex:1e3,width:o?"300px":"60px",height:o?"350px":"60px",backgroundColor:"rgba(15, 23, 42, 0.95)",backdropFilter:"blur(10px)",border:"1px solid rgba(148, 163, 184, 0.2)",borderRadius:"12px",boxShadow:"0 10px 25px rgba(0, 0, 0, 0.3)",transition:y?"none":"all 0.3s ease",cursor:y?"grabbing":"grab",touchAction:"none",userSelect:"none",pointerEvents:y?"none":"auto"},onMouseDown:Oe,onTouchStart:Oe,children:[!o&&r.jsxs("div",{onClick:A=>{A.stopPropagation(),f||(s(!0),I(!1))},style:{width:"100%",height:"100%",display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer",transition:"transform 0.2s ease",pointerEvents:"auto"},onMouseEnter:A=>{y||(A.target.style.transform="scale(1.1)")},onMouseLeave:A=>{y||(A.target.style.transform="scale(1)")},children:[r.jsx("span",{style:{fontSize:"24px",color:E&&n?"#1db954":"#fc771c",fontWeight:"bold"},children:"♪"}),E&&n&&r.jsx("div",{style:{position:"absolute",top:"5px",right:"5px",width:"8px",height:"8px",backgroundColor:L?"#1db954":"#ff6b6b",borderRadius:"50%",animation:L?"pulse 2s infinite":"none"}})]}),o&&r.jsxs("div",{style:{display:"flex",flexDirection:"column",height:"100%",justifyContent:"space-between",pointerEvents:"auto"},children:[r.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:"12px",padding:"8px 0"},children:[r.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[r.jsx("h4",{style:{color:"#1db954",margin:0,fontSize:"14px",fontWeight:"bold"},children:"Spotify"}),n&&r.jsx("p",{style:{color:"#94a3b8",margin:0,fontSize:"11px"},children:a==null?void 0:a.display_name})]}),r.jsxs("div",{style:{display:"flex",gap:"6px",alignItems:"center"},children:[n&&r.jsx("button",{onClick:()=>p(!d),style:{background:d?"#1db954":"rgba(255, 255, 255, 0.1)",border:"none",color:"white",fontSize:"11px",fontWeight:"bold",cursor:"pointer",padding:"4px 8px",borderRadius:"12px",transition:"all 0.2s ease"},children:"📋"}),!n&&r.jsx("button",{onClick:ye,style:{background:"#fc771c",border:"none",color:"#fff",fontSize:"12px",fontWeight:"bold",cursor:"pointer",padding:"6px 12px",borderRadius:"15px",transition:"all 0.2s ease"},onMouseEnter:A=>{A.target.style.background="#f97316",A.target.style.transform="scale(1.05)"},onMouseLeave:A=>{A.target.style.background="#fc771c",A.target.style.transform="scale(1)"},children:"Conectar"}),r.jsx("button",{onClick:A=>{A.stopPropagation(),s(!1),I(!0);const T=10,Y=60,pe=window.innerWidth-Y-T,ge=window.innerHeight-Y-T;g(R=>({x:Math.max(T,Math.min(R.x,pe)),y:Math.max(T,Math.min(R.y,ge))}))},style:{background:"transparent",border:"none",color:"#94a3b8",fontSize:"16px",cursor:"pointer",padding:"4px",borderRadius:"4px",transition:"all 0.2s ease"},onMouseEnter:A=>{A.target.style.color="#e2e8f0",A.target.style.backgroundColor="rgba(148, 163, 184, 0.1)"},onMouseLeave:A=>{A.target.style.color="#94a3b8",A.target.style.backgroundColor="transparent"},children:"×"})]})]}),r.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"8px",flex:1,justifyContent:"center"},children:n?r.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"8px",height:"100%"},children:d?r.jsxs("div",{style:{height:"100%",overflowY:"auto",padding:"6px",backgroundColor:"rgba(40, 40, 40, 0.8)",borderRadius:"6px",border:"1px solid rgba(255, 255, 255, 0.1)"},children:[r.jsx("h4",{style:{color:"#1db954",margin:"0 0 8px 0",fontSize:"12px"},children:"Tus Playlists"}),l.map(A=>{var T;return r.jsxs("div",{onClick:()=>Q(A.id),style:{padding:"6px",backgroundColor:A.id===F?"rgba(29, 185, 84, 0.2)":"rgba(0, 0, 0, 0.3)",marginBottom:"4px",borderRadius:"4px",cursor:"pointer",display:"flex",alignItems:"center",gap:"6px",transition:"all 0.2s ease"},onMouseEnter:Y=>{Y.target.style.backgroundColor="rgba(29, 185, 84, 0.2)",Y.target.style.transform="scale(1.02)"},onMouseLeave:Y=>{Y.target.style.backgroundColor=A.id===F?"rgba(29, 185, 84, 0.2)":"rgba(0, 0, 0, 0.3)",Y.target.style.transform="scale(1)"},children:[r.jsx("img",{src:((T=A.images[0])==null?void 0:T.url)||"/img/default-playlist.png",alt:"Playlist",style:{width:"32px",height:"32px",borderRadius:"3px"}}),r.jsxs("div",{style:{flex:1,minWidth:0},children:[r.jsx("p",{style:{color:"white",margin:"0",fontSize:"11px",whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"},children:A.name}),r.jsxs("p",{style:{color:"#b3b3b3",margin:"0",fontSize:"9px"},children:[A.tracks.total," canciones"]})]})]},A.id)})]}):r.jsx("div",{style:{width:"100%",height:"220px",borderRadius:"6px",overflow:"hidden",backgroundColor:"rgba(40, 40, 40, 0.8)",border:"1px solid rgba(255, 255, 255, 0.1)",position:"relative"}})}):r.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:"8px",padding:"15px 0"},children:[r.jsx("div",{style:{fontSize:"36px",color:"#1db954"},children:"♪"}),r.jsx("h3",{style:{color:"#1db954",margin:0,fontSize:"16px",textAlign:"center"},children:"Reproductor de Spotify"}),r.jsx("p",{style:{color:"#94a3b8",margin:0,fontSize:"12px",textAlign:"center",lineHeight:"1.4"},children:"Conecta tu cuenta de Spotify para disfrutar de tu música favorita"}),r.jsx("button",{onClick:ye,style:{background:"#1db954",border:"none",color:"#fff",fontSize:"14px",fontWeight:"bold",cursor:"pointer",padding:"10px 20px",borderRadius:"20px",transition:"all 0.2s ease",marginTop:"6px"},onMouseEnter:A=>{A.target.style.background="#1ed760",A.target.style.transform="scale(1.05)"},onMouseLeave:A=>{A.target.style.background="#1db954",A.target.style.transform="scale(1)"},children:"Conectar con Spotify"})]})})]})]}),r.jsx("style",{jsx:!0,children:`
        @keyframes pulse {
          0% {
            transform: scale(1);
            opacity: 1;
