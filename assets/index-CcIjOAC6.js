 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(M,q){var G=M.length;M.push(q);e:for(;0<G;){var ie=G-1>>>1,k=M[ie];if(0<i(k,q))M[ie]=q,M[G]=k,G=ie;else break e}}function t(M){return M.length===0?null:M[0]}function a(M){if(M.length===0)return null;var q=M[0],G=M.pop();if(G!==q){M[0]=G;e:for(var ie=0,k=M.length,D=k>>>1;ie<D;){var P=2*(ie+1)-1,ee=M[P],B=P+1,ce=M[B];if(0>i(ee,G))B<k&&0>i(ce,ee)?(M[ie]=ce,M[B]=G,ie=B):(M[ie]=ee,M[P]=G,ie=P);else if(B<k&&0>i(ce,G))M[ie]=ce,M[B]=G,ie=B;else break e}}return q}function i(M,q){var G=M.sortIndex-q.sortIndex;return G!==0?G:M.id-q.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var s=Date,l=s.now();e.unstable_now=function(){return s.now()-l}}var c=[],d=[],p=1,u=null,m=3,y=!1,v=!1,x=!1,w=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,h=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function b(M){for(var q=t(d);q!==null;){if(q.callback===null)a(d);else if(q.startTime<=M)a(d),q.sortIndex=q.expirationTime,n(c,q);else break;q=t(d)}}function C(M){if(x=!1,b(M),!v)if(t(c)!==null)v=!0,xe(A);else{var q=t(d);q!==null&&Me(C,q.startTime-M)}}function A(M,q){v=!1,x&&(x=!1,f(R),R=-1),y=!0;var G=m;try{for(b(q),u=t(c);u!==null&&(!(u.expirationTime>q)||M&&!Q());){var ie=u.callback;if(typeof ie=="function"){u.callback=null,m=u.priorityLevel;var k=ie(u.expirationTime<=q);q=e.unstable_now(),typeof k=="function"?u.callback=k:u===t(c)&&a(c),b(q)}else a(c);u=t(c)}if(u!==null)var D=!0;else{var P=t(d);P!==null&&Me(C,P.startTime-q),D=!1}return D}finally{u=null,m=G,y=!1}}var T=!1,L=null,R=-1,U=5,_=-1;function Q(){return!(e.unstable_now()-_<U)}function pe(){if(L!==null){var M=e.unstable_now();_=M;var q=!0;try{q=L(!0,M)}finally{q?le():(T=!1,L=null)}}else T=!1}var le;if(typeof h=="function")le=function(){h(pe)};else if(typeof MessageChannel<"u"){var K=new MessageChannel,Be=K.port2;K.port1.onmessage=pe,le=function(){Be.postMessage(null)}}else le=function(){w(pe,0)};function xe(M){L=M,T||(T=!0,le())}function Me(M,q){R=w(function(){M(e.unstable_now())},q)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(M){M.callback=null},e.unstable_continueExecution=function(){v||y||(v=!0,xe(A))},e.unstable_forceFrameRate=function(M){0>M||125<M?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):U=0<M?Math.floor(1e3/M):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return t(c)},e.unstable_next=function(M){switch(m){case 1:case 2:case 3:var q=3;break;default:q=m}var G=m;m=q;try{return M()}finally{m=G}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(M,q){switch(M){case 1:case 2:case 3:case 4:case 5:break;default:M=3}var G=m;m=M;try{return q()}finally{m=G}},e.unstable_scheduleCallback=function(M,q,G){var ie=e.unstable_now();switch(typeof G=="object"&&G!==null?(G=G.delay,G=typeof G=="number"&&0<G?ie+G:ie):G=ie,M){case 1:var k=-1;break;case 2:k=250;break;case 5:k=1073741823;break;case 4:k=1e4;break;default:k=5e3}return k=G+k,M={id:p++,callback:q,priorityLevel:M,startTime:G,expirationTime:k,sortIndex:-1},G>ie?(M.sortIndex=G,n(d,M),t(c)===null&&M===t(d)&&(x?(f(R),R=-1):x=!0,Me(C,G-ie))):(M.sortIndex=k,n(c,M),v||y||(v=!0,xe(A))),M},e.unstable_shouldYield=Q,e.unstable_wrapCallback=function(M){var q=m;return function(){var G=m;m=q;try{return M.apply(this,arguments)}finally{m=G}}}})(dp);cp.exports=dp;var zf=cp.exports;/**
 * @license React
...
`+o):a.stack=o}catch{}}throw a}}_request(n,t){typeof n=="string"?(t=t||{},t.url=n):t=n||{},t=Jr(this.defaults,t);const{transitional:a,paramsSerializer:i,headers:o}=t;a!==void 0&&ki.assertOptions(a,{silentJSONParsing:Zn.transitional(Zn.boolean),forcedJSONParsing:Zn.transitional(Zn.boolean),clarifyTimeoutError:Zn.transitional(Zn.boolean)},!1),i!=null&&(S.isFunction(i)?t.paramsSerializer={serialize:i}:ki.assertOptions(i,{encode:Zn.function,serialize:Zn.function},!0)),t.allowAbsoluteUrls!==void 0||(this.defaults.allowAbsoluteUrls!==void 0?t.allowAbsoluteUrls=this.defaults.allowAbsoluteUrls:t.allowAbsoluteUrls=!0),ki.assertOptions(t,{baseUrl:Zn.spelling("baseURL"),withXsrfToken:Zn.spelling("withXSRFToken")},!0),t.method=(t.method||this.defaults.method||"get").toLowerCase();let s=o&&S.merge(o.common,o[t.method]);o&&S.forEach(["delete","get","head","post","put","patch","common"],v=>{delete o[v]}),t.headers=un.concat(s,o);const l=[];let c=!0;this.interceptors.request.forEach(function(x){typeof x.runWhen=="function"&&x.runWhen(t)===!1||(c=c&&x.synchronous,l.unshift(x.fulfilled,x.rejected))});const d=[];this.interceptors.response.forEach(function(x){d.push(x.fulfilled,x.rejected)});let p,u=0,m;if(!c){const v=[Vd.bind(this),void 0];for(v.unshift(...l),v.push(...d),m=v.length,p=Promise.resolve(t);u<m;)p=p.then(v[u++],v[u++]);return p}m=l.length;let y=t;for(u=0;u<m;){const v=l[u++],x=l[u++];try{y=v(y)}catch(w){x.call(this,w);break}}try{p=Vd.call(this,y)}catch(v){return Promise.reject(v)}for(u=0,m=d.length;u<m;)p=p.then(d[u++],d[u++]);return p}getUri(n){n=Jr(this.defaults,n);const t=_h(n.baseURL,n.url,n.allowAbsoluteUrls);return Oh(t,n.params,n.paramsSerializer)}};S.forEach(["delete","get","head","options"],function(n){Wr.prototype[n]=function(t,a){return this.request(Jr(a||{},{method:n,url:t,data:(a||{}).data}))}});S.forEach(["post","put","patch"],function(n){function t(a){return function(o,s,l){return this.request(Jr(l||{},{method:n,headers:a?{"Content-Type":"multipart/form-data"}:{},url:o,data:s}))}}Wr.prototype[n]=t(),Wr.prototype[n+"Form"]=t(!0)});let Yx=class Kh{constructor(n){if(typeof n!="function")throw new TypeError("executor must be a function.");let t;this.promise=new Promise(function(o){t=o});const a=this;this.promise.then(i=>{if(!a._listeners)return;let o=a._listeners.length;for(;o-- >0;)a._listeners[o](i);a._listeners=null}),this.promise.then=i=>{let o;const s=new Promise(l=>{a.subscribe(l),o=l}).then(i);return s.cancel=function(){a.unsubscribe(o)},s},n(function(o,s,l){a.reason||(a.reason=new _t(o,s,l),t(a.reason))})}throwIfRequested(){if(this.reason)throw this.reason}subscribe(n){if(this.reason){n(this.reason);return}this._listeners?this._listeners.push(n):this._listeners=[n]}unsubscribe(n){if(!this._listeners)return;const t=this._listeners.indexOf(n);t!==-1&&this._listeners.splice(t,1)}toAbortSignal(){const n=new AbortController,t=a=>{n.abort(a)};return this.subscribe(t),n.signal.unsubscribe=()=>this.unsubscribe(t),n.signal}static source(){let n;return{token:new Kh(function(i){n=i}),cancel:n}}};function Gx(e){return function(t){return e.apply(null,t)}}function Jx(e){return S.isObject(e)&&e.isAxiosError===!0}const rl={Continue:100,SwitchingProtocols:101,Processing:102,EarlyHints:103,Ok:200,Created:201,Accepted:202,NonAuthoritativeInformation:203,NoContent:204,ResetContent:205,PartialContent:206,MultiStatus:207,AlreadyReported:208,ImUsed:226,MultipleChoices:300,MovedPermanently:301,Found:302,SeeOther:303,NotModified:304,UseProxy:305,Unused:306,TemporaryRedirect:307,PermanentRedirect:308,BadRequest:400,Unauthorized:401,PaymentRequired:402,Forbidden:403,NotFound:404,MethodNotAllowed:405,NotAcceptable:406,ProxyAuthenticationRequired:407,RequestTimeout:408,Conflict:409,Gone:410,LengthRequired:411,PreconditionFailed:412,PayloadTooLarge:413,UriTooLong:414,UnsupportedMediaType:415,RangeNotSatisfiable:416,ExpectationFailed:417,ImATeapot:418,MisdirectedRequest:421,UnprocessableEntity:422,Locked:423,FailedDependency:424,TooEarly:425,UpgradeRequired:426,PreconditionRequired:428,TooManyRequests:429,RequestHeaderFieldsTooLarge:431,UnavailableForLegalReasons:451,InternalServerError:500,NotImplemented:501,BadGateway:502,ServiceUnavailable:503,GatewayTimeout:504,HttpVersionNotSupported:505,VariantAlsoNegotiates:506,InsufficientStorage:507,LoopDetected:508,NotExtended:510,NetworkAuthenticationRequired:511};Object.entries(rl).forEach(([e,n])=>{rl[n]=e});function Wh(e){const n=new Wr(e),t=wh(Wr.prototype.request,n);return S.extend(t,Wr.prototype,n,{allOwnKeys:!0}),S.extend(t,n,null,{allOwnKeys:!0}),t.create=function(i){return Wh(Jr(e,i))},t}const Ee=Wh(_a);Ee.Axios=Wr;Ee.CanceledError=_t;Ee.CancelToken=Yx;Ee.isCancel=Ph;Ee.VERSION=Zh;Ee.toFormData=bo;Ee.AxiosError=ne;Ee.Cancel=Ee.CanceledError;Ee.all=function(n){return Promise.all(n)};Ee.spread=Gx;Ee.isAxiosError=Jx;Ee.mergeConfig=Jr;Ee.AxiosHeaders=un;Ee.formToJSON=e=>Lh(S.isHTMLForm(e)?new FormData(e):e);Ee.getAdapter=Uh.getAdapter;Ee.HttpStatusCode=rl;Ee.default=Ee;const{Axios:t2,AxiosError:a2,CanceledError:i2,isCancel:o2,CancelToken:s2,VERSION:l2,all:c2,Cancel:d2,isAxiosError:p2,spread:u2,toFormData:h2,AxiosHeaders:f2,HttpStatusCode:m2,formToJSON:g2,getAdapter:x2,mergeConfig:v2}=Ee,$h="https://koop-api-a28ac382dd56.herokuapp.com/api",je=Ee.create({baseURL:$h,withCredentials:!0}),Qx=Ee.create({baseURL:$h,withCredentials:!0});let es=!1,tl=[];function Xx(e){tl.push(e)}function ev(e){tl.forEach(n=>{try{n(e)}catch{}}),tl=[]}function nv({getAccessToken:e,setAccessToken:n,onLogout:t}){je.interceptors.request.use(a=>{var i,o;try{let s;try{s=e==null?void 0:e()}catch{}if(!s&&typeof window<"u")try{s=(i=window.localStorage)==null?void 0:i.getItem("accessToken")}catch{}s&&!((o=a.headers)!=null&&o.Authorization)&&(a.headers=a.headers||{},a.headers.Authorization=`Bearer ${s}`)}catch(s){console.error("[axios] Request interceptor error:",s)}return a}),je.interceptors.response.use(a=>a,async a=>{var p,u;const{response:i,config:o}=a||{},s=i==null?void 0:i.status,l=o||{},c=String((l==null?void 0:l.url)||""),d=c.includes("/auth/login")||c.includes("/auth/register")||c.includes("/auth/refresh");if(s!==401||d||l._retry)return Promise.reject(a);if(l._retry=!0,es)return new Promise((m,y)=>{Xx(v=>{try{l.headers=l.headers||{},v&&(l.headers.Authorization=`Bearer ${v}`),m(je(l))}catch(x){y(x)}})});es=!0;try{const m=await Qx.post("/auth/refresh"),y=(p=m==null?void 0:m.data)==null?void 0:p.accessToken;if(!y)throw new Error("No accessToken in refresh");try{n==null||n(y)}catch{}return ev(y),l.headers=l.headers||{},l.headers.Authorization=`Bearer ${y}`,je(l)}catch(m){const y=(u=m==null?void 0:m.response)==null?void 0:u.status;if(y===401||y===403)try{await(t==null?void 0:t())}catch{}return Promise.reject(m)}finally{es=!1}})}const Hh=g.createContext(null),Fd=["admin","user"];function al(e,{defaultRole:n="user"}={}){const t=String(n||"user").trim().toLowerCase(),a=Fd.includes(t)?t:"user",o=(Array.isArray(e)?e:[e]).map(s=>String(s||"").trim().toLowerCase()).filter(s=>Fd.includes(s));return o.includes("admin")?["admin"]:o.includes("user")?["user"]:[a]}function si(e){try{const n=e.split(".")[1],t=atob(n.replace(/-/g,"+").replace(/_/g,"/"));return JSON.parse(t)}catch{return null}}function li(e,n){return e?{id:e.sub,name:e.name,email:e.email,roles:al(e.roles),active:e.active!==!1,driveFolders:e.driveFolders||[]}:n?{id:n.id,name:n.name,email:n.email,roles:al(n.roles),active:n.active!==!1,driveFolders:n.driveFolders||[]}:null}function rv({children:e}){const[n,t]=g.useState(()=>localStorage.getItem("accessToken")||null),[a,i]=g.useState(()=>{const y=localStorage.getItem("accessToken");if(!y)return null;const v=si(y);return li(v,null)}),[o,s]=g.useState(!1),l=!!n;g.useEffect(()=>{if(!n)localStorage.removeItem("accessToken"),i(null);else{localStorage.setItem("accessToken",n);const y=si(n);y&&i(li(y,null))}},[n]);const c=async(y,v)=>{s(!0);try{const{accessToken:x,user:w}=await y1({email:y,password:v});t(x);const f=si(x);return i(li(f,w)),{ok:!0}}catch(x){return{ok:!1,error:x.message}}finally{s(!1)}},d=async(y,v,x,w)=>{s(!0);try{const f=Array.isArray(w)&&w.length>0,h=await v1({name:y,email:v,password:x,roles:f?al(w):void 0});if(h!=null&&h.accessToken){t(h.accessToken);const b=si(h.accessToken);i(li(b,h.user))}return{ok:!0,data:h}}catch(f){return{ok:!1,error:f.message}}finally{s(!1)}},p=async()=>{try{await w1()}catch{}finally{t(null),i(null)}},u=g.useMemo(()=>({accessToken:n,user:a,isAuthenticated:l,loading:o,login:c,register:d,logout:p,refresh:b1}),[n,a,l,o]),m=g.useRef(!1);return g.useEffect(()=>{m.current||(nv({getAccessToken:()=>n,setAccessToken:y=>t(y),onLogout:()=>p()}),m.current=!0)},[]),r.jsx(Hh.Provider,{value:u,children:e})}function We(){const e=g.useContext(Hh);if(!e)throw new Error("useAuth debe usarse dentro de AuthProvider");return e}const qh="/assets/Koop%20Logo-DEFOyNWT.png";function tv(){var m,y;const{login:e,loading:n}=We(),t=Lr(),i=((y=(m=Vn().state)==null?void 0:m.from)==null?void 0:y.pathname)||"/dashboard",[o,s]=g.useState(""),[l,c]=g.useState(""),[d,p]=g.useState(""),u=async v=>{v.preventDefault(),p(""),console.log("Submitting login form, Hola q ac",o);const x=await e(o,l);if(!x.ok){p(x.error||"Error al iniciar sesión");return}t(i,{replace:!0})};return g.useEffect(()=>(document.body.classList.add("no-scroll"),()=>{document.body.classList.remove("no-scroll")}),[]),r.jsxs("div",{className:"auth-page",children:[r.jsx("video",{className:"auth-bg-video",autoPlay:!0,muted:!0,loop:!0,playsInline:!0,preload:"auto",children:r.jsx("source",{src:"/KoopCentroInternacional.mp4",type:"video/mp4"})}),r.jsx("div",{className:"auth-bg-overlay"}),r.jsxs("div",{className:"auth-card",children:[r.jsx(O,{to:"/",children:r.jsx("img",{src:qh,alt:"Logo KOOP",className:"logo"})}),r.jsx("h2",{children:"Login KOOP"}),d&&r.jsx("div",{className:"auth-error",children:d}),r.jsxs("form",{onSubmit:u,children:[r.jsxs("div",{className:"input-group",children:[r.jsx("label",{htmlFor:"email",children:"Correo"}),r.jsx("input",{id:"email",type:"email",placeholder:"Ingrese su correo",value:o,onChange:v=>s(v.target.value),required:!0})]}),r.jsxs("div",{className:"input-group",children:[r.jsx("label",{htmlFor:"password",children:"Contraseña"}),r.jsx("input",{id:"password",type:"password",placeholder:"Ingrese su contraseña",value:l,onChange:v=>c(v.target.value),required:!0})]}),r.jsx("button",{type:"submit",className:"login-button",disabled:n,children:n?"Ingresando...":"Iniciar sesión"})]}),r.jsxs("div",{className:"auth-actions",children:["¿No tienes cuenta? ",r.jsx(O,{to:"/register",children:"Regístrate"})," · ",r.jsx(O,{to:"/",children:"Volver al inicio"})]})]})]})}function av(){const[e,n]=g.useState({name:"",email:"",password:""}),[t,a]=g.useState(!1),[i,o]=g.useState(""),[s,l]=g.useState(""),{register:c}=We(),d=Lr(),p=m=>n({...e,[m.target.name]:m.target.value}),u=async m=>{m.preventDefault(),o(""),l(""),a(!0);try{const y=await c(e.name,e.email,e.password);if(y.ok){const v=y.data||{ok:!0};v!=null&&v.accessToken?d("/dashboard"):(l("Tu registro fue recibido. Un administrador activara tu cuenta y te avisaremos por correo."),n({name:"",email:"",password:""}))}else o(y.error||"Error en registro")}catch(y){const v=(y==null?void 0:y.message)||"Error en registro";o(v)}finally{a(!1)}};return g.useEffect(()=>(document.body.classList.add("no-scroll"),()=>{document.body.classList.remove("no-scroll")}),[]),r.jsxs("div",{className:"auth-page",children:[r.jsx("video",{className:"auth-bg-video",autoPlay:!0,muted:!0,loop:!0,playsInline:!0,preload:"auto",children:r.jsx("source",{src:"/KoopCentroInternacional.mp4",type:"video/mp4"})}),r.jsx("div",{className:"auth-bg-overlay"}),r.jsxs("div",{className:"auth-card",children:[r.jsx("img",{src:qh,alt:"Logo KOOP",className:"logo"}),r.jsx("h2",{children:"Crear Cuenta"}),i&&r.jsx("div",{className:"auth-error",children:i}),s&&r.jsx("div",{className:"auth-info",children:s}),r.jsxs("form",{onSubmit:u,children:[r.jsxs("div",{className:"input-group",children:[r.jsx("label",{htmlFor:"name",children:"Nombre"}),r.jsx("input",{id:"name",name:"name",type:"text",placeholder:"Tu nombre",value:e.name,onChange:p})]}),r.jsxs("div",{className:"input-group",children:[r.jsx("label",{htmlFor:"email",children:"Correo"}),r.jsx("input",{id:"email",name:"email",type:"email",placeholder:"tu@email.com",value:e.email,onChange:p,required:!0})]}),r.jsxs("div",{className:"input-group",children:[r.jsx("label",{htmlFor:"password",children:"Contrasena"}),r.jsx("input",{id:"password",name:"password",type:"password",placeholder:"Minimo 8 caracteres",value:e.password,onChange:p,required:!0})]}),r.jsx("button",{type:"submit",className:"login-button",disabled:t,children:t?"Creando...":"Registrarme"})]}),r.jsxs("div",{className:"auth-actions",children:["Ya tienes cuenta? ",r.jsx(O,{to:"/login",children:"Inicia sesion"})]})]})]})}function iv(e){return e!=null&&e.roles?(Array.isArray(e.roles)?e.roles:[e.roles]).map(n=>String(n||"").toLowerCase()).includes("admin"):!1}function ov(){const{user:e,logout:n}=We(),t=iv(e);return e?r.jsxs("div",{style:{padding:24,display:"flex",flexDirection:"column",gap:16},children:[r.jsx("h1",{children:"Panel Privado"}),r.jsxs("div",{children:[r.jsxs("p",{children:["Bienvenido: ",e.email]}),r.jsxs("p",{children:["Roles: ",Array.isArray(e.roles)?e.roles.join(", "):"N/A"]}),r.jsxs("p",{children:["Estado: ",e.active===!1?"Inactivo":"Activo"]})]}),t&&r.jsx("div",{style:{display:"flex",gap:12},children:r.jsx(O,{className:"btn btn-primary",to:"/admin/usuarios",children:"Gestionar usuarios"})}),r.jsx("div",{children:r.jsx("button",{className:"btn btn-secondary",onClick:n,children:"Cerrar sesion"})})]}):r.jsxs("div",{style:{padding:24},children:[r.jsx("h1",{children:"Panel Privado"}),r.jsx("p",{children:"No hay usuario."})]})}async function Yh(){const{data:e}=await je.get("/admin/users");return e}async function sv(e,n){const{data:t}=await je.patch(`/admin/users/${e}/active`,{active:n});return t}async function lv(e){const{data:n}=await je.post(`/admin/users/${e}/grant-admin`);return n}async function cv(e){const{data:n}=await je.post(`/admin/users/${e}/revoke-admin`);return n}async function dv(e){const{data:n}=await je.delete(`/admin/users/${e}`);return n}async function lc(){const{data:e}=await je.get("/admin/clients/active");return e}async function pv(e,n){const{data:t}=await je.patch(`/admin/clients/${e}`,n);return t}async function uv(e,n){const{data:t}=await je.patch(`/admin/clients/${e}/assign`,{adminUserId:n});return t}async function hv(e,n){const{data:t}=await je.post(`/admin/clients/from-user/${e}`,n);return t}async function fv(e,n){const t={};n&&(t["x-delete-pass"]=n);const{data:a}=await je.delete(`/admin/clients/${e}`,{headers:t});return a}const Ud={success:{bg:"#064e3b",fg:"#a7f3d0",border:"rgba(16,185,129,0.35)"},danger:{bg:"#7f1d1d",fg:"#fecaca",border:"rgba(248,113,113,0.35)"}};function Gh({kind:e="success",children:n,autoHideMs:t,onClose:a,style:i,className:o}){const[s,l]=g.useState(!1);g.useEffect(()=>{const u=setTimeout(()=>l(!0),10);return()=>clearTimeout(u)},[]),g.useEffect(()=>{if(!t)return;const u=setTimeout(()=>{l(!1);const m=setTimeout(()=>a==null?void 0:a(),220);return()=>clearTimeout(m)},t);return()=>clearTimeout(u)},[t,a]);const c=Ud[e]||Ud.success,d={background:c.bg,color:c.fg,border:`1px solid ${c.border}`,padding:12,borderRadius:8,marginBottom:16,boxShadow:"0 6px 18px rgba(0,0,0,0.25) inset",transition:"opacity 200ms ease, transform 200ms ease",opacity:s?1:0,transform:s?"translateY(0)":"translateY(-6px)",display:"flex",alignItems:"center",justifyContent:"space-between",gap:10},p=()=>{l(!1),setTimeout(()=>a==null?void 0:a(),200)};return r.jsxs("div",{role:"alert",className:o,style:{...d,...i||{}},children:[r.jsx("div",{style:{lineHeight:1.4},children:n}),a&&r.jsx("button",{type:"button",onClick:p,"aria-label":"Cerrar aviso",style:{background:"transparent",color:c.fg,border:"none",fontSize:18,lineHeight:1,cursor:"pointer",padding:"2px 4px"},children:"×"})]})}function Jh(e){return r.jsx(Gh,{kind:"success",...e})}function Ji(e){return r.jsx(Gh,{kind:"danger",...e})}const Qh={background:"#1b263b",color:"#e2e8f0",border:"1px solid rgba(148,163,184,0.35)",borderRadius:8,padding:"8px 10px"};function Xh({children:e,style:n}){return r.jsx("div",{style:{display:"grid",gap:10,...n||{}},children:e})}function il({children:e,cols:n=2,style:t}){return r.jsx("div",{style:{display:"grid",gap:10,gridTemplateColumns:`repeat(${n}, 1fr)`,...t||{}},children:e})}function Dn({label:e,type:n="text",value:t,onChange:a,placeholder:i,readOnly:o,inputProps:s,children:l}){return r.jsxs("label",{style:{display:"grid",gap:6},children:[e!=null&&r.jsx("span",{children:e}),l||r.jsx("input",{type:n,value:t,onChange:a,placeholder:i,readOnly:o,style:Qh,...s||{}})]})}function mv({label:e,value:n,onChange:t,rows:a=3,placeholder:i,textareaProps:o}){return r.jsxs("label",{style:{display:"grid",gap:6},children:[e!=null&&r.jsx("span",{children:e}),r.jsx("textarea",{rows:a,value:n,onChange:t,placeholder:i,style:{...Qh,resize:"vertical"},...o||{}})]})}const Zd=["admin","user"];function at(e,{defaultRole:n="user"}={}){const t=String(n||"user").trim().toLowerCase(),a=Zd.includes(t)?t:"user",o=(Array.isArray(e)?e:[e]).map(s=>String(s||"").trim().toLowerCase()).filter(s=>Zd.includes(s));return o.includes("admin")?["admin"]:o.includes("user")?["user"]:[a]}function gv(e){return at(e==null?void 0:e.roles).includes("admin")}function xv(){const{user:e}=We(),n=gv(e),[t,a]=g.useState([]),[i,o]=g.useState(!1),[s,l]=g.useState(null),[c,d]=g.useState(null),[p,u]=g.useState(null),[m,y]=g.useState(null),[v,x]=g.useState(null),[w,f]=g.useState(!1),[h,b]=g.useState(null),[C,A]=g.useState(null),[T,L]=g.useState(!0),[R,U]=g.useState(!1),[_,Q]=g.useState(""),[pe,le]=g.useState(null),K=e==null?void 0:e.id,Be=async()=>{var k,D;if(n){o(!0),l(null);try{const P=await Yh();a(Array.isArray(P==null?void 0:P.items)?P.items.map(ee=>({...ee,roles:at(ee.roles)})):[])}catch(P){l(((D=(k=P==null?void 0:P.response)==null?void 0:k.data)==null?void 0:D.message)||(P==null?void 0:P.message)||"No se pudo cargar la lista")}finally{o(!1)}}};g.useEffect(()=>{Be()},[n]);const xe=async(k,D)=>{var P,ee;try{d(k),await sv(k,D),a(B=>B.map(ce=>ce.id===k?{...ce,active:D}:ce))}catch(B){l(((ee=(P=B==null?void 0:B.response)==null?void 0:P.data)==null?void 0:ee.message)||(B==null?void 0:B.message)||"No se pudo actualizar el usuario")}finally{d(null)}},Me=async k=>{var P,ee;if(window.confirm("Deseas otorgar rol de administrador a este usuario?"))try{l(null),u(k);const B=await lv(k);B!=null&&B.user&&a(ce=>ce.map(fe=>fe.id===k?{...fe,...B.user,roles:at(B.user.roles)}:fe))}catch(B){l(((ee=(P=B==null?void 0:B.response)==null?void 0:P.data)==null?void 0:ee.message)||(B==null?void 0:B.message)||"No se pudo actualizar los roles")}finally{u(null)}},M=async k=>{var P,ee;if(window.confirm("Deseas quitar el rol de administrador a este usuario?"))try{l(null),u(k);const B=await cv(k);B!=null&&B.user&&a(ce=>ce.map(fe=>fe.id===k?{...fe,...B.user,roles:at(B.user.roles)}:fe))}catch(B){l(((ee=(P=B==null?void 0:B.response)==null?void 0:P.data)==null?void 0:ee.message)||(B==null?void 0:B.message)||"No se pudo actualizar los roles")}finally{u(null)}},q=async k=>{var P,ee;if(window.confirm("Deseas eliminar este usuario? Esta accion es permanente."))try{y(k),await dv(k),a(B=>B.filter(ce=>ce.id!==k))}catch(B){l(((ee=(P=B==null?void 0:B.response)==null?void 0:P.data)==null?void 0:ee.message)||(B==null?void 0:B.message)||"No se pudo eliminar el usuario")}finally{y(null)}},G=k=>{b(null),x({userId:k.id,fullName:k.name||"",documentType:"",documentNumber:"",birthDate:"",phone:"",email:k.email||"",address:"",contactInfo:""})},ie=async()=>{var k,D;if(v!=null&&v.userId){b(null);try{f(!0);const P={fullName:String(v.fullName||"").trim(),documentType:String(v.documentType||"").trim(),documentNumber:String(v.documentNumber||"").trim(),birthDate:v.birthDate?new Date(v.birthDate).toISOString():void 0,phone:String(v.phone||"").trim(),email:String(v.email||"").trim(),address:String(v.address||"").trim(),contactInfo:String(v.contactInfo||"").trim()};if(!P.fullName){b("El nombre completo es requerido"),f(!1);return}await hv(v.userId,P),x(null);try{clearTimeout(ie._t)}catch{}le("Cliente creado y carpeta asignada"),ie._t=setTimeout(()=>le(null),3500);try{window.scrollTo({top:0,behavior:"smooth"})}catch{}}catch(P){b(((D=(k=P==null?void 0:P.response)==null?void 0:k.data)==null?void 0:D.message)||(P==null?void 0:P.message)||"No se pudo crear el cliente")}finally{f(!1)}}};return n?r.jsxs("div",{className:"dash-page",style:{backgroundImage:"linear-gradient(rgba(13,27,42,0.65), rgba(27,38,59,0.65)), url('/fondodashboard.jpg')",backgroundSize:"cover",backgroundAttachment:"fixed",backgroundPosition:"center",paddingLeft:16,paddingRight:16,paddingBottom:16},children:[r.jsxs("div",{className:"dash-card",style:{width:"100%",maxWidth:1200},children:[r.jsx("style",{children:`
        ...
        `}),r.jsxs("div",{className:"dash-header",style:{marginBottom:16,gap:12},children:[r.jsx("div",{className:"dash-title",children:"Administrar usuarios"}),r.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[r.jsx("input",{className:"input",placeholder:"Buscar por nombre, cédula o correo",value:_,onChange:k=>Q(k.target.value),style:{width:260}}),_&&r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>Q(""),children:"Limpiar"}),r.jsx("button",{className:"btn btn-secondary",onClick:Be,disabled:i,children:i?"Actualizando...":"Refrescar"})]})]}),pe&&r.jsx(Jh,{autoHideMs:3500,children:pe}),s&&r.jsx(Ji,{children:s}),(()=>{const k=j=>String(j||"").toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,""),D=k(_),P=j=>{if(!D)return!0;const W=[j.document,j.documentNumber,j.cedula,j.dni,j.idNumber,j.numeroDocumento];return[j.name,j.email,...W].some(Qe=>k(Qe).includes(D))},ee=t.filter(P),B=(j,W)=>{const oe=j!=null&&j.createdAt?new Date(j.createdAt).getTime():0;return(W!=null&&W.createdAt?new Date(W.createdAt).getTime():0)-oe},ce=j=>(j==null?void 0:j.active)===!1||(j==null?void 0:j.isActive)===!1,fe=ee.filter(ce).sort(B),me=ee.filter(j=>!ce(j)).sort(B),I=j=>{const W=j.createdAt?new Date(j.createdAt):null,oe=at(j.roles),Qe=oe.includes("admin"),re=j.active!==!1&&j.isActive!==!1,$e=K===j.id,Xe=oe.length>0?oe.join(", "):"-";return r.jsxs("tr",{children:[r.jsx("td",{children:j.name||"-"}),r.jsx("td",{children:j.email}),r.jsx("td",{children:Xe}),r.jsx("td",{children:r.jsx("span",{className:`me-badge ${re?"me-badge-success":"me-badge-error"}`,children:re?"Activo":"Inactivo"})}),r.jsx("td",{children:W?W.toLocaleString():"-"}),r.jsx("td",{children:r.jsxs("div",{style:{display:"flex",flexWrap:"wrap",gap:8},children:[r.jsx("button",{className:"btn btn-primary btn-sm",onClick:()=>xe(j.id,!re),disabled:c===j.id,children:c===j.id?"Guardando...":re?"Desactivar":"Activar"}),r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>G(j),children:"Convertir a cliente"}),Qe?r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>M(j.id),disabled:p===j.id||$e,title:$e?"No puedes modificar tu propio rol":"Quitar rol admin",children:p===j.id?"Quitando...":"Quitar admin"}):r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>Me(j.id),disabled:p===j.id,children:p===j.id?"Asignando...":"Hacer admin"}),r.jsx("button",{className:"btn btn-danger btn-sm",onClick:()=>q(j.id),disabled:m===j.id||$e,title:$e?"No puedes eliminar tu propio usuario":"Eliminar usuario",children:m===j.id?"Eliminando...":"Eliminar"})]})})]},j.id)};return r.jsxs(r.Fragment,{children:[r.jsxs("div",{className:"dash-item only-desktop",style:{marginBottom:16},children:[r.jsxs("div",{className:"dash-header",style:{marginBottom:8},children:[r.jsxs("h4",{style:{margin:0},children:["Usuarios creados (no activados)",fe.length?` · ${fe.length}`:""]}),r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>L(j=>!j),children:T?"Ocultar":"Mostrar"})]}),T&&r.jsx("div",{style:{overflowX:"auto"},children:r.jsxs("table",{className:"me-table",style:{minWidth:720},children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:"Nombre"}),r.jsx("th",{children:"Email"}),r.jsx("th",{children:"Roles"}),r.jsx("th",{children:"Activo"}),r.jsx("th",{children:"Creado"}),r.jsx("th",{children:"Acciones"})]})}),r.jsxs("tbody",{children:[fe.length===0&&r.jsx("tr",{children:r.jsx("td",{colSpan:6,style:{textAlign:"center",padding:16},children:i?"Cargando...":"No hay usuarios no activados"})}),fe.map(I)]})]})})]}),r.jsxs("div",{className:"dash-item only-desktop",children:[r.jsxs("div",{className:"dash-header",style:{marginBottom:8},children:[r.jsxs("h4",{style:{margin:0},children:["Usuarios activados",me.length?` · ${me.length}`:""]}),r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>U(j=>!j),children:R?"Ocultar":"Mostrar"})]}),R&&r.jsx("div",{style:{overflowX:"auto"},children:r.jsxs("table",{className:"me-table",style:{minWidth:720},children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:"Nombre"}),r.jsx("th",{children:"Email"}),r.jsx("th",{children:"Roles"}),r.jsx("th",{children:"Activo"}),r.jsx("th",{children:"Creado"}),r.jsx("th",{children:"Acciones"})]})}),r.jsxs("tbody",{children:[me.length===0&&r.jsx("tr",{children:r.jsx("td",{colSpan:6,style:{textAlign:"center",padding:16},children:i?"Cargando...":"No hay usuarios activados"})}),me.map(I)]})]})})]})]})})(),(()=>{const k=j=>String(j||"").toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,""),D=k(_),P=j=>{if(!D)return!0;const W=[j.document,j.documentNumber,j.cedula,j.dni,j.idNumber,j.numeroDocumento];return[j.name,j.email,...W].some(Qe=>k(Qe).includes(D))},ee=t.filter(P),B=(j,W)=>{const oe=j!=null&&j.createdAt?new Date(j.createdAt).getTime():0;return(W!=null&&W.createdAt?new Date(W.createdAt).getTime():0)-oe},ce=j=>(j==null?void 0:j.active)===!1||(j==null?void 0:j.isActive)===!1,fe=ee.filter(ce).sort(B),me=ee.filter(j=>!ce(j)).sort(B),I=j=>{const W=j.createdAt?new Date(j.createdAt):null,oe=at(j.roles),Qe=oe.includes("admin"),re=j.active!==!1&&j.isActive!==!1,$e=K===j.id,Xe=C===j.id,en=oe.length>0?oe.join(", "):"-";return r.jsxs("div",{className:"mobile-item",children:[r.jsxs("button",{type:"button",className:"btn btn-primary btn-sm mobile-item-header",onClick:()=>A(Cn=>Cn===j.id?null:j.id),"aria-expanded":Xe,style:{width:"100%",display:"flex",alignItems:"center",justifyContent:"space-between"},children:[r.jsx("div",{className:"mobile-item-title",children:j.name||"-"}),r.jsx("div",{style:{opacity:.9,fontSize:12,paddingRight:10},children:Xe?"−":"+"})]}),Xe&&r.jsxs("div",{className:"mobile-item-details",children:[r.jsxs("div",{className:"kv",children:[r.jsx("span",{children:"Email"}),r.jsx("div",{children:j.email||"-"})]}),r.jsxs("div",{className:"kv",style:{marginTop:6},children:[r.jsx("span",{children:"Roles"}),r.jsx("div",{children:en})]}),r.jsxs("div",{className:"kv",style:{marginTop:6},children:[r.jsx("span",{children:"Estado"}),r.jsx("div",{children:r.jsx("span",{className:`me-badge ${re?"me-badge-success":"me-badge-error"}`,children:re?"Activo":"Inactivo"})})]}),r.jsxs("div",{className:"kv",style:{marginTop:6},children:[r.jsx("span",{children:"Creado"}),r.jsx("div",{children:W?W.toLocaleString():"-"})]}),r.jsxs("div",{style:{display:"flex",flexWrap:"wrap",gap:8,marginTop:10,justifyContent:"flex-end"},children:[r.jsx("button",{className:"btn btn-primary btn-sm",onClick:()=>xe(j.id,!re),disabled:c===j.id,children:c===j.id?"Guardando...":re?"Desactivar":"Activar"}),r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>G(j),children:"Convertir a cliente"}),Qe?r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>M(j.id),disabled:p===j.id||$e,title:$e?"No puedes modificar tu propio rol":"Quitar rol admin",children:p===j.id?"Quitando...":"Quitar admin"}):r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>Me(j.id),disabled:p===j.id,children:p===j.id?"Asignando...":"Hacer admin"}),r.jsx("button",{className:"btn btn-danger btn-sm",onClick:()=>q(j.id),disabled:m===j.id||$e,title:$e?"No puedes eliminar tu propio usuario":"Eliminar usuario",children:m===j.id?"Eliminando...":"Eliminar"})]})]})]},j.id)};return r.jsxs(r.Fragment,{children:[r.jsxs("div",{className:"dash-item only-mobile",style:{marginBottom:16},children:[r.jsxs("div",{className:"dash-header",style:{marginBottom:8},children:[r.jsxs("h4",{style:{margin:0},children:["Usuarios creados (no activados)",fe.length?` · ${fe.length}`:""]}),r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>L(j=>!j),children:T?"Ocultar":"Mostrar"})]}),T&&r.jsxs("div",{className:"mobile-list",children:[fe.length===0&&r.jsx("div",{style:{textAlign:"center",padding:8},children:i?"Cargando...":"No hay usuarios no activados"}),fe.map(I)]})]}),r.jsxs("div",{className:"dash-item only-mobile",children:[r.jsxs("div",{className:"dash-header",style:{marginBottom:8},children:[r.jsxs("h4",{style:{margin:0},children:["Usuarios activados",me.length?` · ${me.length}`:""]}),r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>U(j=>!j),children:R?"Ocultar":"Mostrar"})]}),R&&r.jsxs("div",{className:"mobile-list",children:[me.length===0&&r.jsx("div",{style:{textAlign:"center",padding:8},children:i?"Cargando...":"No hay usuarios activados"}),me.map(I)]})]})]})})()]}),v&&r.jsx("div",{role:"dialog","aria-modal":"true",className:"modal-overlay",onClick:k=>{k.target===k.currentTarget&&x(null)},children:r.jsxs("div",{className:"modal-card",role:"document",children:[r.jsxs("div",{className:"modal-header",children:[r.jsx("div",{className:"dash-title",children:"Convertir usuario en cliente"}),r.jsx("button",{type:"button",className:"btn btn-secondary btn-sm",onClick:()=>x(null),"aria-label":"Cerrar",children:"Cerrar"})]}),h&&r.jsx(Ji,{onClose:()=>b(null),children:h}),r.jsx("style",{children:`
        ...
        `}),r.jsxs("div",{className:"tasks-container",children:[r.jsxs("div",{className:"tasks-header",children:[r.jsxs("div",{className:"brand","aria-label":"Koop Strategic Advisory",children:[r.jsx("div",{className:"logo","aria-hidden":"true",children:r.jsxs("svg",{width:"22",height:"22",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[r.jsx("path",{d:"M12 2L20 6V18L12 22L4 18V6L12 2Z",stroke:"white",strokeWidth:"2"}),r.jsx("path",{d:"M12 7V17",stroke:"white",strokeWidth:"2"}),r.jsx("path",{d:"M7 9L12 12L17 9",stroke:"white",strokeWidth:"2"})]})}),r.jsx("h1",{children:"Tablero de Tareas"})]}),r.jsxs("div",{className:"toolbar",role:"search",children:[r.jsx("div",{className:"field",children:r.jsx("input",{className:"tasks-input",type:"search",placeholder:"Buscar por asunto, cliente o radicado…","aria-label":"Buscar",value:t,onChange:x=>a(x.target.value)})}),r.jsx("div",{className:"field",children:r.jsxs("select",{className:"tasks-select","aria-label":"Usuario actual",value:i,onChange:x=>o(x.target.value),children:[r.jsx("option",{value:"derly",children:"Derly Ramírez (Abogada)"}),r.jsx("option",{value:"juan",children:"Juan F. Rey (Socio)"}),r.jsx("option",{value:"valentina",children:"Valentina Martínez (Asistente)"})]})}),r.jsx("div",{className:"field",children:r.jsxs("select",{className:"tasks-select","aria-label":"Estado",value:s,onChange:x=>l(x.target.value),children:[r.jsx("option",{value:"all",children:"Todos los estados"}),r.jsx("option",{value:"pendiente",children:"Pendiente"}),r.jsx("option",{value:"en-curso",children:"En curso"}),r.jsx("option",{value:"hecho",children:"Hecho"})]})})]})]}),r.jsxs("main",{className:"grid","aria-live":"polite",children:[r.jsxs("aside",{className:"sidebar panel",children:[r.jsx("h2",{children:"Filtros rápidos"}),r.jsxs("div",{className:"chips",children:[r.jsx("button",{className:"chip",onClick:()=>l("all"),children:"Hoy"}),r.jsx("button",{className:"chip",onClick:()=>l("all"),children:"Vencidos"}),r.jsx("button",{className:"chip",onClick:()=>l("all"),children:"Alta prioridad"}),r.jsx("button",{className:"chip",onClick:()=>l("all"),children:"Cliente corporativo"})]}),r.jsx("h2",{style:{marginTop:18},children:"Vistas"}),r.jsxs("div",{className:"chips",children:[r.jsx("button",{className:"chip","data-active":c?"true":"false",onClick:()=>d(!0),children:"Mis tareas"}),r.jsx("button",{className:"chip","data-active":c?"false":"true",onClick:()=>d(!1),children:"Todas"})]})]}),r.jsxs("section",{className:"board panel",children:[r.jsxs("div",{className:"board-header",children:[r.jsx("h3",{children:c?"Mis tareas":"Todas las tareas"}),r.jsx("span",{className:"count",children:v})]}),y.length===0?r.jsxs("div",{className:"empty",children:[r.jsxs("svg",{width:"72",height:"72",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[r.jsx("path",{d:"M4 7H20V19C20 20.1046 19.1046 21 18 21H6C4.89543 21 4 20.1046 4 19V7Z",stroke:"#67e8f9",strokeWidth:"1.5"}),r.jsx("path",{d:"M9 3H15V7H9V3Z",stroke:"#67e8f9",strokeWidth:"1.5"}),r.jsx("path",{d:"M8 12H16",stroke:"#94a3b8",strokeWidth:"1.5"}),r.jsx("path",{d:"M8 16H13",stroke:"#94a3b8",strokeWidth:"1.5"})]}),r.jsxs("div",{children:[r.jsx("strong",{children:"No tienes tareas asignadas"}),r.jsx("p",{style:{margin:".35rem 0 0",fontSize:14,color:"#a5b4fc"},children:"Cuando te asignen una tarea aparecerá aquí."})]})]}):r.jsx("div",{className:"cards",children:y.map(x=>{const w=yv[x.assignee]||{name:x.assignee,initials:(x.assignee||"?").slice(0,2).toUpperCase(),color:"#0ea5e9"},f=x.priority==="alta"?"high":x.priority==="media"?"medium":"low",h=x.status==="en-curso"?"En curso":x.status==="hecho"?"Hecho":"Pendiente";return r.jsxs("article",{className:"card",role:"article","aria-label":x.title,children:[r.jsx("h4",{className:"title",children:x.title}),r.jsxs("div",{className:"meta",children:[r.jsxs("span",{className:"badge","data-variant":f,children:["Prioridad: ",x.priority]}),r.jsxs("span",{className:"badge","data-variant":"due",children:[kv(x.due)?"Vencida":"Vence",": ",jv(x.due)]}),r.jsxs("span",{className:"badge",children:["Estado: ",h]}),x.radicado?r.jsxs("span",{className:"badge",children:["Radicado: ",x.radicado]}):null,r.jsxs("span",{className:"badge",children:["Cliente: ",x.client]}),(x.tags||[]).map(b=>r.jsx("span",{className:"badge",children:b},b))]}),r.jsxs("div",{className:"assignee","aria-label":"Responsable",children:[r.jsx("div",{className:"avatar",style:{background:w.color},"aria-hidden":"true",children:w.initials}),r.jsxs("small",{children:["Asignada a ",r.jsx("strong",{children:w.name})]})]})]},x.id)})}),r.jsx("div",{className:"footer-actions",children:r.jsx("button",{className:"link",onClick:()=>u(x=>!x),children:"(Demo) Alternar escenario sin tareas"})})]})]})]})]})}):r.jsx("div",{className:"dash-page",style:{padding:40},children:r.jsxs("div",{className:"dash-card",style:{maxWidth:560},children:[r.jsx("h2",{className:"dash-title",children:"Acceso restringido"}),r.jsx("p",{style:{marginTop:12},children:"Esta sección está disponible solo para administradores."})]})})}async function it({limit:e,subfolder:n}={}){const t={};typeof e=="number"&&(t.limit=e),n&&(t.subfolder=n);const{data:a}=await je.get("/docs/recent",{params:t});return a}async function ef(e,{subfolder:n}={}){if(!e)throw new Error("Archivo requerido");const t=new FormData;t.append("file",e),n&&t.append("subfolder",n);const{data:a}=await je.post("/docs/upload",t,{headers:{"Content-Type":"multipart/form-data"}});return a}async function Nv(e,n=600){if(!e)throw new Error("Key requerida");const t={key:e,expires:n},{data:a}=await je.get("/docs/download-url",{params:t});return a}async function Sv({subfolder:e}={}){const n={};e&&(n.subfolder=e);const{data:t}=await je.get("/docs/diag",{params:n});return t}function jo(e){if(e==null)return"";try{return String(e).normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/[\u0000-\u001F\u007F-\u009F]/g,"").replace(/\u00A0/g," ").replace(/[\u200B-\u200D\uFEFF]/g,"").replace(/\uFFFD/g,"").replace(/\s+/g," ").trim().toUpperCase()}catch{return String(e).toUpperCase()}}function ol({selectedClient:e,isModal:n=!1,onClose:t}){var lr,cr,nt;const[a,i]=g.useState("docs"),{user:o,accessToken:s}=We(),l=jo((o==null?void 0:o.name)||""),c="clientes",p=(Array.isArray(o==null?void 0:o.roles)?o.roles:o!=null&&o.roles?[o==null?void 0:o.roles]:[]).map(N=>String(N||"").trim().toLowerCase()).includes("admin"),[u,m]=g.useState([]),[y,v]=g.useState(!1),[x,w]=g.useState(null),[f,h]=g.useState([]),[b,C]=g.useState(!1),[A,T]=g.useState(null),[L,R]=g.useState(null),U=g.useRef(null),[_,Q]=g.useState(e||null),[pe,le]=g.useState({}),[K,Be]=g.useState(null),[xe,Me]=g.useState(!1),[M,q]=g.useState(new Set),[G,ie]=g.useState([]),[k,D]=g.useState(null),[P,ee]=g.useState(!1),[B,ce]=g.useState(new Set),[fe,me]=g.useState(!1),[I,j]=g.useState(!1),[W,oe]=g.useState(!1),[Qe,re]=g.useState(!1),[$e,Xe]=g.useState(!1),[en,Cn]=g.useState(null),[Pr,et]=g.useState(""),[Fn,sr]=g.useState({radicado:"",clase:"",demandante:"",demandado:"",juzgado:"",estado:""}),Vt=async()=>{C(!0),T(null),R(null);try{const N=await it({limit:20,subfolder:c});h(Array.isArray(N==null?void 0:N.items)?N.items:[]),N!=null&&N.warning&&R(N.warning)}catch(N){T((N==null?void 0:N.message)||"Error cargando documentos")}finally{C(!1)}};g.useEffect(()=>{a==="docs"&&(p?Vt():Y())},[a,p]),g.useEffect(()=>{e&&n&&(Q(e),Ba(e))},[e,n]),g.useEffect(()=>{if(!p)return;let N=!1;return(async()=>{var F,$;try{v(!0),w(null);const H=await lc();if(N)return;const te=Array.isArray(H==null?void 0:H.items)?H.items:[],hn=String((o==null?void 0:o.id)||(o==null?void 0:o.sub)||"").trim();m(te.filter(Ae=>{var Te;return String(((Te=Ae==null?void 0:Ae.assignedAdmin)==null?void 0:Te.id)||"").trim()===hn}))}catch(H){N||w((($=(F=H==null?void 0:H.response)==null?void 0:F.data)==null?void 0:$.message)||(H==null?void 0:H.message)||"No se pudo cargar clientes asignados")}finally{N||v(!1)}})(),()=>{N=!0}},[p,o]);const ko=()=>{var N;return(N=U.current)==null?void 0:N.click()},Va=async N=>{var $,H;const F=(H=($=N.target)==null?void 0:$.files)==null?void 0:H[0];if(F)try{C(!0),T(null);const te=await ef(F,{subfolder:c});te!=null&&te.file&&h(hn=>[te.file,...hn]),await Vt()}catch(te){T((te==null?void 0:te.message)||"Error subiendo documento")}finally{C(!1);try{N.target.value=null}catch{}}},qn=async(N,F)=>{try{const{url:$}=await Nv(N,600);window.open($||F,"_blank")}catch{F&&window.open(F,"_blank")}},Ba=async N=>{if(N!=null&&N.documentNumber){Me(!0);try{const F=await it({limit:100,subfolder:`clientes/${N.documentNumber}`}),$={},H=`clientes/${N.documentNumber}`;Array.isArray(F==null?void 0:F.items)&&F.items.forEach(te=>{var hn,Ae;if(te.isFolder){const Te=(hn=te.key)==null?void 0:hn.replace(/\/$/,"");if(Te&&Te!==H&&Te.startsWith(H+"/")){const he=Te.replace(H+"/","").split("/").pop()||"Carpeta";$[Te]={name:he,path:Te,documents:[],isFolder:!0}}}else{const Te=((Ae=te.key)==null?void 0:Ae.split("/").slice(0,-1).join("/"))||"root";if(Te&&Te!==H&&Te.startsWith(H+"/")){if(!$[Te]){const he=Te.replace(H+"/","").split("/").pop()||"Carpeta";$[Te]={name:he,path:Te,documents:[],isFolder:!1}}$[Te].documents.push(te)}}}),le(te=>({...te,[N.id]:$}))}catch(F){console.error("Error cargando carpetas del cliente:",F),le($=>({...$,[N.id]:{}}))}finally{Me(!1)}}},Fa=async N=>{M.has(N.id)?(q($=>{const H=new Set($);return H.delete(N.id),H}),Q(null),Be(null)):(q($=>new Set($).add(N.id)),Q(N),Be(null),pe[N.id]||await Ba(N))},E=async N=>{if(Be(N),N.documents&&N.documents.length>0)h(N.documents);else{C(!0);try{const F=await it({limit:100,subfolder:N.path}),$=Array.isArray(F==null?void 0:F.items)?F.items.filter(H=>!H.isFolder):[];h($),le(H=>({...H,[_.id]:{...H[_.id],[N.path]:{...N,documents:$}}}))}catch(F){console.error("Error cargando documentos de la carpeta:",F),h([])}finally{C(!1)}}},Y=async()=>{var N,F,$;ee(!0);try{console.log("Usuario actual:",o),console.log("Token de acceso:",s?"Presente":"Ausente"),console.log("Roles del usuario:",o==null?void 0:o.roles),console.log("Intentando verificar conectividad...");try{const he=await Sv();console.log("Health check exitoso:",he)}catch(he){throw console.error("Health check falló:",he),new Error("No se puede conectar con el servidor de documentos")}console.log("Intentando cargar documentos del usuario...");const H=await it({limit:100,subfolder:"clientes"});console.log("Datos de la API para usuario:",H);const te=Array.isArray(H==null?void 0:H.items)?H.items:[];console.log("Items procesados:",te);const hn=new Map;let Ae="clientes";const Te=te.find(he=>he.isFolder&&he.key&&he.key.includes("clientes/"));if(Te){const he=Te.key.split("/");he.length>=2&&(Ae=`${he[0]}/${he[1]}/`)}console.log("Ruta base del cliente:",Ae),console.log("Items encontrados:",te.map(he=>({key:he.key,isFolder:he.isFolder,name:he.name}))),te.forEach(he=>{if(he.isFolder){const Gn=he.key;if(Gn&&Gn.startsWith(Ae)&&Gn!==Ae){const rt=Gn.replace(Ae,"").replace(/^\/+|\/+$/g,"");rt&&!rt.includes("/")&&hn.set(Gn,{name:rt,path:Gn,documents:[],isFolder:!0})}}}),te.forEach(he=>{var Gn;if(!he.isFolder){const rt=((Gn=he.key)==null?void 0:Gn.split("/"))||[];if(rt.length>2){const Za=rt.slice(0,-1).join("/");if(Za.startsWith(Ae)&&Za!==Ae){const cc=Za.replace(Ae,"").replace(/^\/+|\/+$/g,"");if(cc&&!cc.includes("/")){const dc=hn.get(Za);dc&&!he.isFolder&&dc.documents.push(he)}}}}});const Ua=Array.from(hn.values());console.log("Carpetas del usuario cargadas:",Ua),ie(Ua)}catch(H){console.error("Error cargando carpetas del usuario:",H),console.error("Detalles del error:",{message:H.message,status:(N=H.response)==null?void 0:N.status,data:(F=H.response)==null?void 0:F.data}),(($=H.response)==null?void 0:$.status)===401?T("Error de autenticación. Por favor, cierra sesión y vuelve a iniciar sesión."):T("Error cargando carpetas: "+(H.message||"Error desconocido"))}finally{ee(!1)}},J=async N=>{if(D(N),N.documents&&N.documents.length>0)h(N.documents);else try{C(!0);const F=await it({limit:50,subfolder:N.path}),$=Array.isArray(F==null?void 0:F.items)?F.items.filter(H=>!H.isFolder):[];h($),ie(H=>H.map(te=>te.path===N.path?{...te,documents:$}:te))}catch(F){console.error("Error cargando documentos de la carpeta:",F),T("Error cargando documentos de la carpeta")}finally{C(!1)}},V=N=>{B.has(N.path)?(ce($=>{const H=new Set($);return H.delete(N.path),H}),D(null)):(ce($=>new Set($).add(N.path)),J(N))},X=async()=>{try{console.log("Creando nuevo proceso..."),me(!1),T(null)}catch(N){T("Error creando proceso: "+N.message)}},Oe=()=>{j(!0)},Ne=N=>{var F;Cn(N),et(N.name||((F=N.key)==null?void 0:F.split("/").pop())||""),oe(!0)},De=N=>{Cn(N),re(!0)},Yn=async()=>{try{console.log("Guardando información del proceso:",Fn),Xe(!1),T(null)}catch(N){T("Error guardando información: "+N.message)}};return r.jsxs("div",{className:"dash-page",style:{backgroundImage:"linear-gradient(rgba(13,27,42,0.65), rgba(27,38,59,0.65)), url('/fondodashboard.jpg')",backgroundSize:"cover",backgroundAttachment:"fixed",backgroundPosition:"center"},children:[r.jsxs("div",{className:"dash-card",style:{width:"100%",maxWidth:1320},children:[r.jsxs("div",{className:"dash-header",children:[r.jsx("div",{className:"dash-title",children:n?`Expediente - ${(_==null?void 0:_.name)||"Cliente"}`:p?"Mis expedientes":"Mi expediente"}),n&&t&&r.jsx("button",{className:"btn btn-secondary",onClick:t,style:{marginLeft:"auto"},children:"✕ Cerrar"})]}),r.jsxs("div",{className:"dash-item me-subbar",children:[r.jsxs("div",{className:"me-hello",children:["Bienvenido: ",l]}),r.jsxs("select",{className:"me-select","aria-label":"Tipo de b?squeda",children:[r.jsx("option",{children:"Procesos judiciales"}),r.jsx("option",{children:"Demandas"}),r.jsx("option",{children:"Audiencias"})]}),r.jsx("input",{className:"me-input",placeholder:"Buscar..."}),r.jsxs("div",{className:"me-actions",children:[r.jsx("input",{ref:U,type:"file",style:{display:"none"},onChange:Va}),r.jsx("button",{className:"btn btn-primary",onClick:ko,disabled:b,children:b?"Subiendo...":"Radicar documento"}),r.jsx("button",{className:"btn btn-secondary",children:"Ver informaci?n"})]})]}),r.jsxs("div",{className:"me-layout",children:[r.jsxs("aside",{className:"me-left dash-item",children:[r.jsx("div",{className:"me-head",children:p?n?"CARPETAS":"CLIENTE":"CARPETAS"}),r.jsxs("div",{className:"me-tree",children:[!p&&r.jsx(r.Fragment,{children:P?r.jsx("div",{className:"me-leaf",style:{opacity:.8},children:"Cargando carpetas..."}):G.length===0?r.jsx("div",{className:"me-leaf",style:{opacity:.8},children:"No hay carpetas disponibles"}):G.map(N=>{var $;const F=B.has(N.path);return r.jsxs("div",{style:{marginBottom:"8px"},children:[r.jsxs("div",{style:{cursor:"pointer",color:F?"#4fd1c5":"#e5edf7",fontWeight:"600",padding:"8px 4px",borderRadius:"4px",backgroundColor:F?"#2a3a51":"transparent",display:"flex",alignItems:"center",gap:"8px",transition:"all 0.2s ease"},onClick:()=>V(N),children:[r.jsx("span",{style:{display:"inline-block",transform:F?"rotate(90deg)":"rotate(0deg)",transition:"transform 0.2s ease",fontSize:"12px",color:F?"#4fd1c5":"#9fb3cc"},children:"▼"}),N.name]}),F&&r.jsx("div",{style:{marginLeft:"16px",marginTop:"4px"},children:r.jsxs("div",{style:{color:"#9fb3cc",fontSize:"12px"},children:[(($=N.documents)==null?void 0:$.length)||0," documentos"]})})]},N.path)})}),p&&n&&_&&r.jsx(r.Fragment,{children:xe?r.jsx("div",{className:"me-leaf",style:{opacity:.8},children:"Cargando carpetas..."}):r.jsxs("div",{children:[Object.values(pe[_.id]||{}).map((N,F)=>{var $,H;return r.jsxs("div",{style:{cursor:"pointer",backgroundColor:(K==null?void 0:K.path)===N.path?"#2a3a51":"#1e2a3a",borderRadius:"8px",margin:"4px 0",padding:"12px 16px",border:(K==null?void 0:K.path)===N.path?"1px solid #4fd1c5":"1px solid #394b61",transition:"all 0.2s ease",display:"flex",alignItems:"center",gap:"12px"},onClick:()=>E(N),onMouseEnter:te=>{(K==null?void 0:K.path)!==N.path&&(te.target.style.backgroundColor="#2a3a51",te.target.style.borderColor="#4fd1c5")},onMouseLeave:te=>{(K==null?void 0:K.path)!==N.path&&(te.target.style.backgroundColor="#1e2a3a",te.target.style.borderColor="#394b61")},children:[r.jsx("div",{style:{width:"24px",height:"24px",display:"flex",alignItems:"center",justifyContent:"center",color:(K==null?void 0:K.path)===N.path?"#4fd1c5":"#fc771c"},children:r.jsx("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"currentColor",children:r.jsx("path",{d:"M10 4H4c-1.11 0-2 .89-2 2v12c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2h-8l-2-2z"})})}),r.jsxs("div",{style:{flex:1},children:[r.jsx("div",{style:{color:(K==null?void 0:K.path)===N.path?"#4fd1c5":"#e5edf7",fontSize:"14px",fontWeight:"500",marginBottom:"2px"},children:N.name}),r.jsxs("div",{style:{color:"#9fb3cc",fontSize:"11px",display:"flex",alignItems:"center",gap:"4px"},children:[r.jsx("span",{style:{display:"inline-block",width:"4px",height:"4px",borderRadius:"50%",backgroundColor:(($=N.documents)==null?void 0:$.length)>0?"#10b981":"#6b7280"}}),((H=N.documents)==null?void 0:H.length)||0," documentos"]})]})]},F)}),Object.keys(pe[_.id]||{}).length===0&&!xe&&r.jsx("div",{style:{color:"#9fb3cc",fontSize:"12px"},children:"No hay carpetas disponibles"})]})}),p&&!n&&x&&r.jsx("div",{className:"me-leaf",style:{color:"#fecaca"},children:x}),p&&!n&&!x&&y&&r.jsx("div",{className:"me-leaf",style:{opacity:.8},children:"Cargando clientes�"}),p&&!n&&!y&&u.length===0&&r.jsx("div",{className:"me-leaf",style:{opacity:.8},children:"No tienes clientes asignados"}),p&&!n&&u.length>0&&r.jsx(r.Fragment,{children:u.map(N=>{const F=M.has(N.id);return r.jsxs("div",{style:{marginBottom:"8px"},children:[r.jsxs("div",{style:{cursor:"pointer",color:F?"#4fd1c5":"#e5edf7",fontWeight:"600",padding:"8px 4px",borderRadius:"4px",backgroundColor:F?"#2a3a51":"transparent",display:"flex",alignItems:"center",gap:"8px",transition:"all 0.2s ease"},onClick:()=>Fa(N),children:[r.jsx("span",{style:{display:"inline-block",transform:F?"rotate(90deg)":"rotate(0deg)",transition:"transform 0.2s ease",fontSize:"12px",color:F?"#4fd1c5":"#9fb3cc"},children:"▼"}),N.name]}),F&&r.jsx("div",{style:{marginLeft:"16px",marginTop:"4px"},children:xe?r.jsx("div",{style:{color:"#9fb3cc",fontSize:"12px"},children:"Cargando carpetas..."}):r.jsxs("div",{children:[Object.values(pe[N.id]||{}).map(($,H)=>{var te,hn;return r.jsxs("div",{style:{cursor:"pointer",backgroundColor:(K==null?void 0:K.path)===$.path?"#2a3a51":"#1e2a3a",borderRadius:"8px",margin:"4px 0",padding:"12px 16px",border:(K==null?void 0:K.path)===$.path?"1px solid #4fd1c5":"1px solid #394b61",transition:"all 0.2s ease",display:"flex",alignItems:"center",gap:"12px"},onClick:()=>E($),onMouseEnter:Ae=>{(K==null?void 0:K.path)!==$.path&&(Ae.target.style.backgroundColor="#2a3a51",Ae.target.style.borderColor="#4fd1c5")},onMouseLeave:Ae=>{(K==null?void 0:K.path)!==$.path&&(Ae.target.style.backgroundColor="#1e2a3a",Ae.target.style.borderColor="#394b61")},children:[r.jsx("div",{style:{width:"24px",height:"24px",display:"flex",alignItems:"center",justifyContent:"center",color:(K==null?void 0:K.path)===$.path?"#4fd1c5":"#fc771c"},children:r.jsx("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"currentColor",children:r.jsx("path",{d:"M10 4H4c-1.11 0-2 .89-2 2v12c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2h-8l-2-2z"})})}),r.jsxs("div",{style:{flex:1},children:[r.jsx("div",{style:{color:(K==null?void 0:K.path)===$.path?"#4fd1c5":"#e5edf7",fontSize:"14px",fontWeight:"500",marginBottom:"2px"},children:$.name}),r.jsxs("div",{style:{color:"#9fb3cc",fontSize:"11px",display:"flex",alignItems:"center",gap:"4px"},children:[r.jsx("span",{style:{display:"inline-block",width:"4px",height:"4px",borderRadius:"50%",backgroundColor:((te=$.documents)==null?void 0:te.length)>0?"#10b981":"#6b7280"}}),((hn=$.documents)==null?void 0:hn.length)||0," documentos"]})]})]},H)}),Object.keys(pe[N.id]||{}).length===0&&!xe&&r.jsx("div",{style:{color:"#9fb3cc",fontSize:"12px"},children:"No hay carpetas disponibles"})]})})]},N.id)})})]})]}),r.jsxs("main",{className:"me-center dash-item",children:[r.jsxs("div",{className:"me-tabs",children:[r.jsx("div",{className:`me-tab ${a==="docs"?"active":""}`,onClick:()=>i("docs"),role:"button",tabIndex:0,children:"Documentos del Proceso"}),r.jsx("div",{className:`me-tab ${a==="aud"?"active":""}`,onClick:()=>i("aud"),role:"button",tabIndex:0,children:"Audiencias"})]}),a==="docs"&&r.jsxs("div",{className:"me-table-wrap",children:[_&&K&&r.jsxs("div",{style:{background:"#1e2a3a",padding:"12px 16px",borderBottom:"1px solid #34465a",color:"#e2e8f0",fontSize:"14px"},children:[r.jsx("strong",{children:"Cliente:"})," ",_.name," |",r.jsx("strong",{children:" Carpeta:"})," ",K.name,r.jsxs("span",{style:{color:"#9fb3cc",marginLeft:"8px"},children:["(",((lr=K.documents)==null?void 0:lr.length)||0," documentos)"]})]}),_&&!K&&r.jsxs("div",{style:{background:"#1e2a3a",padding:"12px 16px",borderBottom:"1px solid #34465a",color:"#e2e8f0",fontSize:"14px"},children:[r.jsx("strong",{children:"Cliente seleccionado:"})," ",_.name," -",r.jsx("span",{style:{color:"#9fb3cc"},children:" Selecciona una carpeta para ver sus documentos"})]}),p&&!_&&r.jsx("div",{style:{background:"#1e2a3a",padding:"12px 16px",borderBottom:"1px solid #34465a",color:"#9fb3cc",fontSize:"14px"},children:"Selecciona un cliente para ver sus carpetas y documentos"}),!p&&!k&&r.jsx("div",{style:{background:"#1e2a3a",padding:"12px 16px",borderBottom:"1px solid #34465a",color:"#9fb3cc",fontSize:"14px"},children:"Selecciona una carpeta para ver sus documentos"}),A&&r.jsx("div",{style:{color:"#ef4444",padding:"8px 12px"},children:String(A)}),L&&r.jsxs("div",{style:{color:"#f59e0b",padding:"8px 12px"},children:["Aviso: ",String(L)==="S3_LIST_FORBIDDEN"?"No hay permisos para listar el bucket. Tus documentos siguen disponibles si conservas el enlace.":String(L)]}),r.jsxs("table",{className:"me-table",children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{style:{width:42},children:r.jsx("input",{type:"checkbox"})}),r.jsx("th",{children:"Fecha de registro"}),r.jsx("th",{children:"Documento"}),r.jsx("th",{children:"Tipo"}),r.jsx("th",{children:"Tama?o"}),r.jsx("th",{children:"Acciones"})]})}),r.jsxs("tbody",{children:[f.length===0&&r.jsx("tr",{children:r.jsx("td",{colSpan:6,style:{color:"#9fb3cc",textAlign:"center",padding:"20px"},children:b?"Cargando...":p?_&&K?`No hay documentos en la carpeta "${K.name}"`:_?"Selecciona una carpeta para ver sus documentos":"Selecciona un cliente para ver sus documentos":k?`No hay documentos en la carpeta "${k.name}"`:"Selecciona una carpeta para ver sus documentos"})}),f.map(N=>{const F=N.lastModified?new Date(N.lastModified):N.createdTime?new Date(N.createdTime):null,$=N.name||(N.key||"").split("/").pop(),H=typeof N.size=="number"?Math.max(1,Math.round(N.size/1024)):null,te=N.mimeType||($&&$.toLowerCase().endsWith(".pdf")?"application/pdf":void 0);return r.jsxs("tr",{children:[r.jsx("td",{children:r.jsx("input",{type:"checkbox"})}),r.jsx("td",{children:F?F.toLocaleString():"-"}),r.jsx("td",{title:$,children:$}),r.jsx("td",{children:te?te.split("/")[1]||te:"-"}),r.jsx("td",{children:H?`${H} KB`:"-"}),r.jsx("td",{children:r.jsxs("div",{style:{display:"flex",gap:"4px",flexWrap:"wrap"},children:[r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>qn(N.key,N.downloadURL||N.downloadUrl||N.webContentLink||N.webViewLink),title:"Descargar archivo",children:n?"📥":"Descargar"}),n&&r.jsxs(r.Fragment,{children:[r.jsx("button",{className:"btn btn-primary btn-sm",onClick:()=>Ne(N),title:"Renombrar archivo",children:"✏️"}),r.jsx("button",{className:"btn btn-danger btn-sm",onClick:()=>De(N),title:"Eliminar archivo",children:"🗑️"})]})]})})]},N.key||N.id)})]})]})]}),a==="aud"&&r.jsx("div",{className:"me-table-wrap",children:r.jsxs("table",{className:"me-table",children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:"Fecha"}),r.jsx("th",{children:"Actuaci?n"}),r.jsx("th",{children:"Juzgado"}),r.jsx("th",{children:"Estado"})]})}),r.jsx("tbody",{children:r.jsxs("tr",{children:[r.jsx("td",{children:"2025-09-03 08:00"}),r.jsx("td",{children:"Audiencia inicial"}),r.jsx("td",{children:"JDO 003 Laboral"}),r.jsx("td",{children:r.jsx("span",{className:"me-badge me-badge-success",children:"Agendada"})})]})})]})})]}),r.jsx("aside",{className:"me-right dash-item",children:n?r.jsxs(r.Fragment,{children:[r.jsx("div",{className:"me-head",children:"Herramientas del Expediente"}),r.jsxs("div",{className:"me-right-content",style:{display:"flex",flexDirection:"column",gap:"12px"},children:[r.jsx("button",{className:"btn btn-primary",onClick:Oe,style:{width:"100%",padding:"12px"},children:"📁 Agregar Archivo"}),r.jsx("button",{className:"btn btn-secondary",onClick:()=>me(!0),style:{width:"100%",padding:"12px"},children:"📋 Crear Proceso"}),r.jsx("button",{className:"btn btn-secondary",onClick:()=>Xe(!0),style:{width:"100%",padding:"12px"},children:"ℹ️ Información del Expediente"}),r.jsx("hr",{className:"me-hr"}),r.jsx("div",{style:{fontSize:"12px",color:"#9fb3cc",textAlign:"center"},children:"Selecciona un archivo en la tabla para renombrar o eliminar"})]})]}):r.jsxs(r.Fragment,{children:[r.jsx("div",{className:"me-head",children:"Datos del Proceso Judicial"}),r.jsxs("div",{className:"me-right-content",children:[r.jsxs("div",{className:"me-proc-grid",children:[r.jsx("div",{className:"me-tag",children:"Radicado"}),r.jsx("div",{children:"110014105009-20250011400"}),r.jsx("div",{className:"me-tag",children:"Clase"}),r.jsx("div",{children:"Laboral - Ordinario"}),r.jsx("div",{className:"me-tag",children:"Demandante"}),r.jsx("div",{children:"Juan Pérez"}),r.jsx("div",{className:"me-tag",children:"Demandado"}),r.jsx("div",{children:"Acme S.A.S."}),r.jsx("div",{className:"me-tag",children:"Juzgado"}),r.jsx("div",{children:"JDO 009 MPC"}),r.jsx("div",{className:"me-tag",children:"Estado"}),r.jsx("div",{children:"En trámite"})]}),r.jsx("hr",{className:"me-hr"}),r.jsx("button",{className:"btn btn-primary",style:{width:"100%"},children:"Descargar expediente"})]})]})})]})]}),n&&fe&&r.jsx("div",{style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:60,padding:16},onClick:()=>me(!1),children:r.jsxs("div",{className:"dash-card",style:{maxWidth:"500px",width:"100%"},onClick:N=>N.stopPropagation(),children:[r.jsx("div",{className:"dash-header",style:{marginBottom:8},children:r.jsx("div",{className:"dash-title",children:"Crear Nuevo Proceso"})}),r.jsxs("div",{className:"dash-item",style:{display:"grid",gap:16},children:[r.jsxs("div",{children:[r.jsx("label",{style:{display:"block",marginBottom:"8px",fontWeight:"500"},children:"Nombre del Proceso:"}),r.jsx("input",{type:"text",className:"me-input",placeholder:"Ej: Demanda por despido injustificado",style:{width:"100%"}})]}),r.jsxs("div",{children:[r.jsx("label",{style:{display:"block",marginBottom:"8px",fontWeight:"500"},children:"Tipo de Proceso:"}),r.jsxs("select",{className:"me-select",style:{width:"100%"},children:[r.jsx("option",{value:"",children:"Selecciona un tipo..."}),r.jsx("option",{value:"laboral",children:"Proceso Laboral"}),r.jsx("option",{value:"penal",children:"Proceso Penal"}),r.jsx("option",{value:"civil",children:"Proceso Civil"}),r.jsx("option",{value:"administrativo",children:"Proceso Administrativo"})]})]})]}),r.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",gap:8,marginTop:12},children:[r.jsx("button",{className:"btn btn-secondary",onClick:()=>me(!1),children:"Cancelar"}),r.jsx("button",{className:"btn btn-primary",onClick:X,children:"Crear Proceso"})]})]})}),n&&I&&r.jsx("div",{style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:60,padding:16},onClick:()=>j(!1),children:r.jsxs("div",{className:"dash-card",style:{maxWidth:"500px",width:"100%"},onClick:N=>N.stopPropagation(),children:[r.jsx("div",{className:"dash-header",style:{marginBottom:8},children:r.jsx("div",{className:"dash-title",children:"Agregar Archivo"})}),r.jsxs("div",{className:"dash-item",style:{display:"grid",gap:16},children:[r.jsxs("div",{children:[r.jsx("label",{style:{display:"block",marginBottom:"8px",fontWeight:"500"},children:"Seleccionar Archivo:"}),r.jsx("input",{type:"file",className:"me-input",style:{width:"100%"},onChange:N=>{var $;const F=($=N.target.files)==null?void 0:$[0];F&&et(F.name)}})]}),r.jsxs("div",{children:[r.jsx("label",{style:{display:"block",marginBottom:"8px",fontWeight:"500"},children:"Nombre del Archivo (opcional):"}),r.jsx("input",{type:"text",className:"me-input",value:Pr,onChange:N=>et(N.target.value),placeholder:"Dejar vacío para usar el nombre original",style:{width:"100%"}})]})]}),r.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",gap:8,marginTop:12},children:[r.jsx("button",{className:"btn btn-secondary",onClick:()=>j(!1),children:"Cancelar"}),r.jsx("button",{className:"btn btn-primary",onClick:()=>{console.log("Subiendo archivo con nombre:",Pr),j(!1)},children:"Subir Archivo"})]})]})}),n&&W&&en&&r.jsx("div",{style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:60,padding:16},onClick:()=>oe(!1),children:r.jsxs("div",{className:"dash-card",style:{maxWidth:"500px",width:"100%"},onClick:N=>N.stopPropagation(),children:[r.jsx("div",{className:"dash-header",style:{marginBottom:8},children:r.jsx("div",{className:"dash-title",children:"Renombrar Archivo"})}),r.jsxs("div",{className:"dash-item",style:{display:"grid",gap:16},children:[r.jsxs("div",{children:[r.jsx("label",{style:{display:"block",marginBottom:"8px",fontWeight:"500"},children:"Archivo actual:"}),r.jsx("div",{style:{background:"#1e2a3a",padding:"8px 12px",borderRadius:"6px",color:"#9fb3cc",fontSize:"14px"},children:en.name||((cr=en.key)==null?void 0:cr.split("/").pop())})]}),r.jsxs("div",{children:[r.jsx("label",{style:{display:"block",marginBottom:"8px",fontWeight:"500"},children:"Nuevo nombre:"}),r.jsx("input",{type:"text",className:"me-input",value:Pr,onChange:N=>et(N.target.value),style:{width:"100%"}})]})]}),r.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",gap:8,marginTop:12},children:[r.jsx("button",{className:"btn btn-secondary",onClick:()=>oe(!1),children:"Cancelar"}),r.jsx("button",{className:"btn btn-primary",onClick:()=>{console.log("Renombrando archivo:",en.key,"a:",Pr),oe(!1)},children:"Renombrar"})]})]})}),n&&Qe&&en&&r.jsx("div",{style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:60,padding:16},onClick:()=>re(!1),children:r.jsxs("div",{className:"dash-card",style:{maxWidth:"500px",width:"100%"},onClick:N=>N.stopPropagation(),children:[r.jsx("div",{className:"dash-header",style:{marginBottom:8},children:r.jsx("div",{className:"dash-title",children:"Confirmar Eliminación"})}),r.jsxs("div",{className:"dash-item",style:{display:"grid",gap:16},children:[r.jsx("div",{children:"¿Estás seguro de que quieres eliminar el archivo?"}),r.jsxs("div",{style:{background:"#1e2a3a",padding:"12px",borderRadius:"6px",color:"#e5edf7",fontSize:"14px"},children:[r.jsx("strong",{children:"Archivo:"})," ",en.name||((nt=en.key)==null?void 0:nt.split("/").pop())]}),r.jsx("div",{style:{background:"#7f1d1d",color:"#fecaca",padding:"8px 12px",borderRadius:"6px",fontSize:"12px"},children:"⚠️ Esta acción no se puede deshacer"})]}),r.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",gap:8,marginTop:12},children:[r.jsx("button",{className:"btn btn-secondary",onClick:()=>re(!1),children:"Cancelar"}),r.jsx("button",{className:"btn btn-danger",onClick:()=>{console.log("Eliminando archivo:",en.key),re(!1)},children:"Eliminar"})]})]})}),n&&$e&&r.jsx("div",{style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:60,padding:16},onClick:()=>Xe(!1),children:r.jsxs("div",{className:"dash-card",style:{maxWidth:"600px",width:"100%"},onClick:N=>N.stopPropagation(),children:[r.jsx("div",{className:"dash-header",style:{marginBottom:8},children:r.jsx("div",{className:"dash-title",children:"Información del Expediente"})}),r.jsxs("div",{className:"dash-item",style:{display:"grid",gap:16},children:[r.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"16px"},children:[r.jsxs("div",{children:[r.jsx("label",{style:{display:"block",marginBottom:"8px",fontWeight:"500"},children:"Radicado:"}),r.jsx("input",{type:"text",className:"me-input",value:Fn.radicado,onChange:N=>sr(F=>({...F,radicado:N.target.value})),placeholder:"110014105009-20250011400",style:{width:"100%"}})]}),r.jsxs("div",{children:[r.jsx("label",{style:{display:"block",marginBottom:"8px",fontWeight:"500"},children:"Clase:"}),r.jsx("input",{type:"text",className:"me-input",value:Fn.clase,onChange:N=>sr(F=>({...F,clase:N.target.value})),placeholder:"Laboral - Ordinario",style:{width:"100%"}})]})]}),r.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"16px"},children:[r.jsxs("div",{children:[r.jsx("label",{style:{display:"block",marginBottom:"8px",fontWeight:"500"},children:"Demandante:"}),r.jsx("input",{type:"text",className:"me-input",value:Fn.demandante,onChange:N=>sr(F=>({...F,demandante:N.target.value})),placeholder:"Juan Pérez",style:{width:"100%"}})]}),r.jsxs("div",{children:[r.jsx("label",{style:{display:"block",marginBottom:"8px",fontWeight:"500"},children:"Demandado:"}),r.jsx("input",{type:"text",className:"me-input",value:Fn.demandado,onChange:N=>sr(F=>({...F,demandado:N.target.value})),placeholder:"Acme S.A.S.",style:{width:"100%"}})]})]}),r.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"16px"},children:[r.jsxs("div",{children:[r.jsx("label",{style:{display:"block",marginBottom:"8px",fontWeight:"500"},children:"Juzgado:"}),r.jsx("input",{type:"text",className:"me-input",value:Fn.juzgado,onChange:N=>sr(F=>({...F,juzgado:N.target.value})),placeholder:"JDO 009 MPC",style:{width:"100%"}})]}),r.jsxs("div",{children:[r.jsx("label",{style:{display:"block",marginBottom:"8px",fontWeight:"500"},children:"Estado:"}),r.jsxs("select",{className:"me-select",value:Fn.estado,onChange:N=>sr(F=>({...F,estado:N.target.value})),style:{width:"100%"},children:[r.jsx("option",{value:"",children:"Selecciona un estado..."}),r.jsx("option",{value:"en-tramite",children:"En trámite"}),r.jsx("option",{value:"sentencia",children:"Sentencia"}),r.jsx("option",{value:"archivado",children:"Archivado"}),r.jsx("option",{value:"suspension",children:"Suspensión"})]})]})]})]}),r.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",gap:8,marginTop:12},children:[r.jsx("button",{className:"btn btn-secondary",onClick:()=>Xe(!1),children:"Cancelar"}),r.jsx("button",{className:"btn btn-primary",onClick:Yn,children:"Guardar Información"})]})]})})]})}const Wd=["admin","user"];function Ev(e,{defaultRole:n="user"}={}){const t=String(n||"user").trim().toLowerCase(),a=Wd.includes(t)?t:"user",o=(Array.isArray(e)?e:[e]).map(s=>String(s||"").trim().toLowerCase()).filter(s=>Wd.includes(s));return o.includes("admin")?["admin"]:o.includes("user")?["user"]:[a]}function Av(e){return Ev(e==null?void 0:e.roles).includes("admin")}function Tv(){const{user:e}=We(),n=Av(e),[t,a]=g.useState([]),[i,o]=g.useState(!1),[s,l]=g.useState(null),[c,d]=g.useState(null),[p,u]=g.useState(!1),[m,y]=g.useState(""),[v,x]=g.useState(null),[w,f]=g.useState(!1),[h,b]=g.useState(null),[C,A]=g.useState([]),[T,L]=g.useState(!1),[R,U]=g.useState(null),[_,Q]=g.useState(""),[pe,le]=g.useState(!1),[K,Be]=g.useState(null),[xe,Me]=g.useState(null),[M,q]=g.useState({}),[G,ie]=g.useState({}),[k,D]=g.useState(!1),[P,ee]=g.useState(null),[B,ce]=g.useState(!1),[fe,me]=g.useState(null),[I,j]=g.useState(""),[W,oe]=g.useState(null),[Qe,re]=g.useState("success"),$e=(E,Y="success")=>{oe(String(E||"")),re(Y);try{clearTimeout($e._t)}catch{}$e._t=setTimeout(()=>oe(null),3500)},Xe=async()=>{var E,Y;if(n){o(!0),l(null);try{const J=await lc(),V=Array.isArray(J==null?void 0:J.items)?J.items:[];a(V)}catch(J){l(((Y=(E=J==null?void 0:J.response)==null?void 0:E.data)==null?void 0:Y.message)||(J==null?void 0:J.message)||"No se pudo cargar la lista de clientes")}finally{o(!1)}}};g.useEffect(()=>{Xe()},[n]);const en=g.useMemo(()=>{const E=String(m||"").trim().toLowerCase();return E?t.filter(Y=>[Y.name,Y.email,Y.documentNumber,Y.phone,Y.id].map(J=>String(J||"").toLowerCase()).some(J=>J.includes(E))):t},[t,m]),Cn=E=>{const Y=t.find(J=>J.id===E);return(Y==null?void 0:Y.assignedAdmin)||null},Pr=async E=>{var Y,J;b(E),f(!0),U(null),L(!0);try{const V=await Yh(),Oe=(Array.isArray(V==null?void 0:V.items)?V.items:[]).filter(De=>(Array.isArray(De.roles)?De.roles:[De.roles]).map(Yn=>String(Yn||"").toLowerCase()).includes("admin"));A(Oe.map(De=>({id:De.id,name:De.name||De.email||De.id,email:De.email})));const Ne=Cn(E.id);Q((Ne==null?void 0:Ne.id)||"")}catch(V){U(((J=(Y=V==null?void 0:V.response)==null?void 0:Y.data)==null?void 0:J.message)||(V==null?void 0:V.message)||"No se pudo cargar administradores")}finally{L(!1)}},et=async()=>{var E,Y;try{const J=_||"";await uv(h.id,J),await Xe(),f(!1),b(null)}catch(J){U(((Y=(E=J==null?void 0:J.response)==null?void 0:E.data)==null?void 0:Y.message)||(J==null?void 0:J.message)||"No se pudo asignar")}},Fn=E=>{d({id:E.id,name:E.name||"",email:E.email||"",documentNumber:E.documentNumber||"",phone:E.phone||""})},sr=async()=>{var Y,J;if(!c)return;const E={name:String(c.name||"").trim(),documentNumber:String(c.documentNumber||"").trim(),phone:String(c.phone||"").trim()};try{u(!0),l(null);const V=await pv(c.id,E),X=(V==null?void 0:V.client)||null;X&&a(Oe=>Oe.map(Ne=>Ne.id===X.id?{...Ne,...X}:Ne)),d(null)}catch(V){l(((J=(Y=V==null?void 0:V.response)==null?void 0:Y.data)==null?void 0:J.message)||(V==null?void 0:V.message)||"No se pudo guardar la informacion")}finally{u(!1)}},Vt=E=>{ee(E),D(!0),me(null),j("")},ko=async()=>{var E,Y,J;if(P)try{ce(!0),me(null);const V=await fv(P.id,I);await Xe(),D(!1),ee(null);const X=(E=V==null?void 0:V.s3)==null?void 0:E.deleted;$e(typeof X=="number"?`Cliente eliminado. Archivos S3 eliminados: ${X}`:"Cliente eliminado correctamente","danger")}catch(V){me(((J=(Y=V==null?void 0:V.response)==null?void 0:Y.data)==null?void 0:J.message)||(V==null?void 0:V.message)||"No se pudo eliminar el cliente")}finally{ce(!1)}},Va=async E=>{Be(E),le(!0)},qn=E=>{const Y=String((E==null?void 0:E.documentNumber)||(E==null?void 0:E.id)||"").trim();return Y?`clientes/${Y}/`:"clientes/sin-id/"},Ba=async E=>{const Y=E.id,J=qn(E);ie(V=>({...V,[Y]:!0}));try{const V=J.startsWith("clientes/")?J.replace(/\/$/,""):J,X=await it({limit:50,subfolder:V}),Oe=Array.isArray(X==null?void 0:X.items)?X.items:[];q(Ne=>({...Ne,[Y]:Oe}))}catch(V){console.error("Error al cargar archivos:",V),q(X=>({...X,[Y]:[]}))}finally{ie(V=>({...V,[Y]:!1}))}},Fa=async E=>{const Y=E.id;xe===Y?Me(null):(Me(Y),M[Y]||await Ba(E))};return n?r.jsxs("div",{className:"dash-page",style:{backgroundImage:"linear-gradient(rgba(13,27,42,0.65), rgba(27,38,59,0.65)), url('/fondodashboard.jpg')",backgroundSize:"cover",backgroundAttachment:"fixed",backgroundPosition:"center",paddingLeft:16,paddingRight:16,paddingBottom:16},children:[r.jsxs("div",{className:"dash-card",style:{width:"100%",maxWidth:1200},children:[r.jsx("style",{children:`
           @keyframes spin {
         ...
         `}),r.jsxs("div",{className:"dash-header clients-header",style:{marginBottom:16},children:[r.jsx("div",{className:"dash-title",children:"Clientes activos"}),r.jsxs("div",{className:"clients-actions",children:[r.jsx("input",{type:"search",name:"q",autoComplete:"off",placeholder:"Buscar por nombre, email, cedula o celular",value:m,onChange:E=>y(E.target.value),style:{background:"#1b263b",color:"#e2e8f0",border:"1px solid rgba(148,163,184,0.35)",borderRadius:8,padding:"6px 10px"}}),r.jsx("button",{className:"btn btn-secondary",onClick:Xe,disabled:i,children:i?"Actualizando...":"Refrescar"})]})]}),W&&(Qe==="danger"?r.jsx(Ji,{autoHideMs:3500,children:W}):r.jsx(Jh,{autoHideMs:3500,children:W})),s&&r.jsx(Ji,{children:s}),r.jsx("div",{className:"dash-item only-desktop",style:{overflowX:"auto"},children:r.jsxs("table",{className:"me-table",style:{minWidth:820},children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:"Nombre"}),r.jsx("th",{children:"Email"}),r.jsx("th",{children:"Cedula"}),r.jsx("th",{children:"Celular"}),r.jsx("th",{children:"Acciones"})]})}),r.jsxs("tbody",{children:[en.length===0&&r.jsx("tr",{children:r.jsx("td",{colSpan:5,style:{textAlign:"center",padding:16},children:i?"Cargando...":"No hay clientes activos para mostrar"})}),en.map(E=>{var Y,J;return r.jsxs(r.Fragment,{children:[r.jsxs("tr",{children:[r.jsxs("td",{children:[r.jsxs("div",{style:{cursor:"pointer",color:"#4fd1c5",fontWeight:"500",textDecoration:"underline"},onClick:()=>Fa(E),onMouseOver:V=>V.target.style.color="#6ee7d7",onMouseOut:V=>V.target.style.color="#4fd1c5",children:[E.name||"-"," ",xe===E.id?"▼":"▶"]}),r.jsxs("div",{style:{fontSize:12,opacity:.75},children:["Admin asignado: ",((Y=E.assignedAdmin)==null?void 0:Y.name)||"—"]})]}),r.jsx("td",{children:E.email||"-"}),r.jsx("td",{children:E.documentNumber||"-"}),r.jsx("td",{children:E.phone||"-"}),r.jsx("td",{children:r.jsxs("div",{style:{display:"flex",flexWrap:"wrap",gap:8},children:[r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>Pr(E),title:Cn(E.id)?`Asignado a ${((J=Cn(E.id))==null?void 0:J.name)||""}`:"Asignar administrador",children:Cn(E.id)?"Asignado":"Asignar"}),r.jsx("button",{className:"btn btn-primary btn-sm",onClick:()=>Va(E),children:"Archivos"}),r.jsx("button",{className:"btn btn-primary btn-sm",onClick:()=>Fn(E),children:"Editar"}),r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>Vt(E),children:"Eliminar"})]})})]},E.id),xe===E.id&&r.jsx("tr",{children:r.jsx("td",{colSpan:5,style:{padding:0,background:"#0c1530"},children:r.jsxs("div",{style:{padding:"20px"},children:[r.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"16px"},children:[r.jsxs("h4",{style:{margin:0,color:"#e2e8f0"},children:["Archivos y Carpetas - ",E.name]}),r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>Me(null),children:"Cerrar"})]}),G[E.id]?r.jsxs("div",{style:{textAlign:"center",padding:"40px",color:"#cbd5e1"},children:[r.jsx("div",{style:{display:"inline-block",width:"20px",height:"20px",border:"2px solid #4fd1c5",borderTop:"2px solid transparent",borderRadius:"50%",animation:"spin 1s linear infinite",marginRight:"8px"}}),"Cargando archivos..."]}):r.jsx("div",{style:{border:"1px solid #394b61",borderRadius:"8px",overflow:"hidden",background:"#1b263b"},children:r.jsxs("table",{style:{width:"100%",borderCollapse:"collapse"},children:[r.jsx("thead",{style:{background:"#0c1530"},children:r.jsxs("tr",{children:[r.jsx("th",{style:{padding:"12px 16px",fontWeight:"600",textAlign:"left"},children:"Nombre"}),r.jsx("th",{style:{padding:"12px 16px",fontWeight:"600",textAlign:"left"},children:"Tipo"}),r.jsx("th",{style:{padding:"12px 16px",fontWeight:"600",textAlign:"left"},children:"Fecha"}),r.jsx("th",{style:{padding:"12px 16px",fontWeight:"600",textAlign:"left"},children:"Tamaño"})]})}),r.jsx("tbody",{children:!M[E.id]||M[E.id].length===0?r.jsx("tr",{children:r.jsx("td",{colSpan:4,style:{textAlign:"center",padding:"40px",color:"#cbd5e1"},children:r.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:"8px"},children:[r.jsx("div",{children:"No hay archivos o carpetas para mostrar"}),r.jsx("div",{style:{fontSize:"14px",opacity:.7},children:'Haz clic en "Archivos" para gestionar documentos'})]})})}):M[E.id].filter(V=>{const X=V.key||"",Oe=qn(E);return!(X===Oe&&V.isFolder)}).map(V=>{var Yn,lr;const X=V.lastModified?new Date(V.lastModified):V.createdTime?new Date(V.createdTime):null,Oe=V.isFolder||((Yn=V.key)==null?void 0:Yn.endsWith("/"))||((lr=V.name)==null?void 0:lr.endsWith("/"));let Ne=V.name||(V.key||"").split("/").pop();if(Oe&&Ne&&qn(E)){const cr=qn(E).replace(/\/$/,"");V.key&&V.key.startsWith(cr)&&(Ne=V.key.replace(cr+"/","").replace(/\/$/,""))}const De=typeof V.size=="number"?Math.max(1,Math.round(V.size/1024)):null;return r.jsxs("tr",{style:{borderBottom:"1px solid #394b61"},children:[r.jsx("td",{style:{padding:"12px 16px"},children:r.jsx("span",{style:{color:Oe?"#fc771c":"#e2e8f0",fontWeight:"500"},children:Ne})}),r.jsx("td",{style:{padding:"12px 16px"},children:r.jsx("span",{style:{color:Oe?"#fc771c":"#4fd1c5",fontWeight:"500"},children:Oe?"Carpeta":"Archivo"})}),r.jsx("td",{style:{padding:"12px 16px",color:"#cbd5e1"},children:X?X.toLocaleDateString("es-CO"):"-"}),r.jsx("td",{style:{padding:"12px 16px",color:"#cbd5e1"},children:De?`${De} KB`:"-"})]},V.key||V.id)})})]})})]})})})]})})]})]})}),r.jsxs("div",{className:"dash-item only-mobile mobile-list",children:[en.length===0&&r.jsx("div",{style:{textAlign:"center",padding:8},children:i?"Cargando...":"No hay clientes activos para mostrar"}),en.map(E=>{var J,V;const Y=v===E.id;return r.jsxs("div",{className:"mobile-item",children:[r.jsxs("button",{type:"button",className:"btn btn-primary btn-sm mobile-item-header",onClick:()=>{x(X=>X===E.id?null:E.id),Y||Fa(E)},"aria-expanded":Y,style:{width:"100%",display:"flex",alignItems:"center",justifyContent:"space-between"},children:[r.jsx("div",{className:"mobile-item-title",children:E.name||"-"}),r.jsx("div",{style:{opacity:.9,fontSize:12,paddingRight:10},children:Y?"▼":"▶"})]}),Y&&r.jsxs("div",{className:"mobile-item-details",children:[r.jsxs("div",{className:"kv",children:[r.jsx("span",{children:"Email"}),r.jsx("div",{children:E.email||"-"})]}),r.jsxs("div",{className:"kv",style:{marginTop:6},children:[r.jsx("span",{children:"Cédula"}),r.jsx("div",{children:E.documentNumber||"-"})]}),r.jsxs("div",{className:"kv",style:{marginTop:6},children:[r.jsx("span",{children:"Celular"}),r.jsx("div",{children:E.phone||"-"})]}),r.jsxs("div",{className:"kv",style:{marginTop:6},children:[r.jsx("span",{children:"Admin asignado"}),r.jsx("div",{children:((J=E.assignedAdmin)==null?void 0:J.name)||"—"})]}),r.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",marginTop:10},children:[r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>Pr(E),style:{marginRight:8},title:Cn(E.id)?`Asignado a ${((V=Cn(E.id))==null?void 0:V.name)||""}`:"Asignar administrador",children:Cn(E.id)?"Asignado":"Asignar"}),r.jsx("button",{className:"btn btn-primary btn-sm",onClick:()=>Va(E),style:{marginRight:8},children:"Archivos"}),r.jsx("button",{className:"btn btn-primary btn-sm",onClick:()=>Fn(E),style:{marginRight:8},children:"Editar"}),r.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>Vt(E),children:"Eliminar"})]}),r.jsxs("div",{style:{marginTop:"16px",paddingTop:"16px",borderTop:"1px solid #394b61"},children:[r.jsx("h5",{style:{margin:"0 0 12px 0",color:"#e2e8f0",fontSize:"16px"},children:"Archivos y Carpetas"}),G[E.id]?r.jsxs("div",{style:{textAlign:"center",padding:"20px",color:"#cbd5e1"},children:[r.jsx("div",{style:{display:"inline-block",width:"16px",height:"16px",border:"2px solid #4fd1c5",borderTop:"2px solid transparent",borderRadius:"50%",animation:"spin 1s linear infinite",marginRight:"8px"}}),"Cargando archivos..."]}):r.jsx("div",{children:!M[E.id]||M[E.id].length===0?r.jsxs("div",{style:{textAlign:"center",padding:"20px",color:"#cbd5e1",fontSize:"14px"},children:[r.jsx("div",{children:"No hay archivos o carpetas para mostrar"}),r.jsx("div",{style:{fontSize:"12px",opacity:.7,marginTop:"4px"},children:'Haz clic en "Archivos" para gestionar documentos'})]}):r.jsx("div",{style:{border:"1px solid #394b61",borderRadius:"6px",overflow:"hidden",background:"#1b263b"},children:M[E.id].filter(X=>{const Oe=X.key||"",Ne=qn(E);return!(Oe===Ne&&X.isFolder)}).map(X=>{var lr,cr;const Oe=X.lastModified?new Date(X.lastModified):X.createdTime?new Date(X.createdTime):null,Ne=X.isFolder||((lr=X.key)==null?void 0:lr.endsWith("/"))||((cr=X.name)==null?void 0:cr.endsWith("/"));let De=X.name||(X.key||"").split("/").pop();if(Ne&&De&&qn(E)){const nt=qn(E).replace(/\/$/,"");X.key&&X.key.startsWith(nt)&&(De=X.key.replace(nt+"/","").replace(/\/$/,""))}const Yn=typeof X.size=="number"?Math.max(1,Math.round(X.size/1024)):null;return r.jsx("div",{style:{padding:"12px",borderBottom:"1px solid #394b61",display:"flex",justifyContent:"space-between",alignItems:"center"},children:r.jsxs("div",{children:[r.jsx("div",{style:{color:Ne?"#fc771c":"#e2e8f0",fontWeight:"500",fontSize:"14px"},children:De}),r.jsxs("div",{style:{color:"#cbd5e1",fontSize:"12px",marginTop:"2px"},children:[Ne?"Carpeta":"Archivo"," • ",Oe?Oe.toLocaleDateString("es-CO"):"-"," • ",Yn?`${Yn} KB`:"-"]})]})},X.key||X.id)})})})]})]})]},E.id)})]})]}),c&&r.jsx("div",{role:"dialog","aria-modal":"true",style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:50},onClick:E=>{E.target===E.currentTarget&&d(null)},children:r.jsxs("div",{className:"dash-card",style:{width:"100%",maxWidth:560,padding:16},children:[r.jsx("div",{className:"dash-header",style:{marginBottom:12},children:r.jsx("div",{className:"dash-title",children:"Editar cliente"})}),r.jsx("div",{className:"dash-item",children:r.jsxs(Xh,{children:[r.jsx(Dn,{label:"Nombre",value:c.name,onChange:E=>d(Y=>({...Y,name:E.target.value})),placeholder:"Nombre y apellidos"}),r.jsx(Dn,{label:"Email",type:"email",value:c.email,onChange:()=>{},inputProps:{readOnly:!0}}),r.jsxs(il,{cols:2,children:[r.jsx(Dn,{label:"Cédula",value:c.documentNumber,onChange:E=>d(Y=>({...Y,documentNumber:E.target.value})),placeholder:"Ej: 80153356"}),r.jsx(Dn,{label:"Celular",value:c.phone,onChange:E=>d(Y=>({...Y,phone:E.target.value})),placeholder:"Ej: 300 123 4567"})]})]})}),r.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",gap:8,marginTop:12},children:[r.jsx("button",{className:"btn btn-secondary",onClick:()=>d(null),disabled:p,children:"Cancelar"}),r.jsx("button",{className:"btn btn-primary",onClick:sr,disabled:p,children:p?"Guardando...":"Guardar cambios"})]})]})}),pe&&r.jsx("div",{style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:60,padding:16},onClick:()=>le(!1),children:r.jsx("div",{style:{width:"100%",maxWidth:"95vw",maxHeight:"95vh",background:"transparent"},onClick:E=>E.stopPropagation(),children:r.jsx(ol,{selectedClient:K,isModal:!0,onClose:()=>le(!1)})})}),w&&h&&r.jsx("div",{role:"dialog","aria-modal":"true",style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:60,padding:16},onClick:E=>{E.target===E.currentTarget&&(f(!1),b(null))},children:r.jsxs("div",{className:"dash-card",style:{width:"100%",maxWidth:560},children:[r.jsx("div",{className:"dash-header",style:{marginBottom:8},children:r.jsx("div",{className:"dash-title",children:"Asignar administrador"})}),r.jsxs("div",{className:"dash-item",style:{display:"grid",gap:10},children:[r.jsxs("div",{style:{fontSize:14,opacity:.85},children:["Cliente: ",r.jsx("strong",{children:h.name})," ",r.jsxs("span",{style:{opacity:.7},children:["(",h.id,")"]})]}),R&&r.jsx("div",{style:{background:"#7f1d1d",color:"#fecaca",padding:8,borderRadius:6},children:R}),r.jsxs("label",{style:{display:"grid",gap:6},children:[r.jsx("span",{children:"Selecciona un admin"}),r.jsxs("select",{value:_,onChange:E=>Q(E.target.value),disabled:T,style:{background:"#1b263b",color:"#e2e8f0",border:"1px solid rgba(148,163,184,0.35)",borderRadius:8,padding:"8px 10px"},children:[r.jsx("option",{value:"",children:"— Sin asignar —"}),C.map(E=>r.jsxs("option",{value:E.id,children:[E.name," — ",E.email]},E.id))]})]})]}),r.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",gap:8,marginTop:12},children:[r.jsx("button",{className:"btn btn-secondary",onClick:()=>{f(!1),b(null)},disabled:T,children:"Cancelar"}),r.jsx("button",{className:"btn btn-primary",onClick:et,disabled:T,children:"Guardar"})]})]})}),k&&P&&r.jsx("div",{role:"dialog","aria-modal":"true",style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:65,padding:16},onClick:E=>{E.target===E.currentTarget&&(D(!1),ee(null))},children:r.jsxs("div",{className:"dash-card",style:{width:"100%",maxWidth:520},children:[r.jsx("div",{className:"dash-header",style:{marginBottom:8},children:r.jsx("div",{className:"dash-title",children:"Confirmar eliminación"})}),r.jsxs("div",{className:"dash-item",style:{display:"grid",gap:10},children:[r.jsxs("div",{children:["¿Eliminar al cliente ",r.jsx("strong",{children:P.name||P.email||P.id}),"?"]}),r.jsxs("div",{style:{fontSize:13,opacity:.85},children:["Esta acción eliminará el contenedor del cliente y su carpeta S3 asociada (clientes/",String(P.documentNumber||"").trim(),")."]}),r.jsx("input",{type:"text",autoComplete:"username",value:" ",readOnly:!0,"aria-hidden":"true",style:{position:"absolute",opacity:0,height:0,width:0,pointerEvents:"none"}}),r.jsxs("label",{style:{display:"grid",gap:6},children:[r.jsx("span",{children:"Contraseña de eliminación"}),r.jsx("input",{type:"password",name:"delete-confirm",autoComplete:"new-password","data-lpignore":"true","data-1p-ignore":"true",value:I,onChange:E=>j(E.target.value),placeholder:"eliminarclientekoop",style:{background:"#1b263b",color:"#e2e8f0",border:"1px solid rgba(148,163,184,0.35)",borderRadius:8,padding:"8px 10px"}})]}),fe&&r.jsx("div",{style:{background:"#7f1d1d",color:"#fecaca",padding:8,borderRadius:6},children:fe})]}),r.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",gap:8,marginTop:12},children:[r.jsx("button",{className:"btn btn-secondary",onClick:()=>{D(!1),ee(null)},disabled:B,children:"Cancelar"}),r.jsx("button",{className:"btn btn-primary",onClick:ko,disabled:B||!I,children:B?"Eliminando...":"Eliminar"})]})]})}),r.jsx("style",{children:`
        @keyframes spin {
          0% { transform: rotate(0deg); }
          100% { transform: rotate(360deg); }
        }
      `})]}):r.jsx("div",{className:"dash-page",style:{padding:40},children:r.jsxs("div",{className:"dash-card",style:{maxWidth:560},children:[r.jsx("h2",{className:"dash-title",children:"Acceso restringido"}),r.jsx("p",{style:{marginTop:12},children:"Esta seccion esta disponible solo para administradores."})]})})}const nf="koop.calendar.events";function $d(){if(typeof window>"u")return[];try{const e=window.localStorage.getItem(nf);if(!e)return[];const n=JSON.parse(e);return Array.isArray(n)?n.filter(Boolean):[]}catch(e){return console.warn("[calendarStorage] load error",e),[]}}function Iv(e){if(!(typeof window>"u"))try{window.localStorage.setItem(nf,JSON.stringify(e??[]))}catch(n){console.warn("[calendarStorage] save error",n)}}const Rv="koop.calendar.events";function rf(){const[e,n]=g.useState(()=>$d());g.useEffect(()=>{const a=i=>{(i==null?void 0:i.key)===Rv&&n($d())};return typeof window<"u"&&window.addEventListener("storage",a),()=>{typeof window<"u"&&window.removeEventListener("storage",a)}},[]);const t=g.useCallback(a=>{n(i=>{const o=typeof a=="function"?a(i):a;return Iv(o),o})},[]);return[e,t]}const zv="documentos_iniciales";function Hd(e){return String(e||"").trim()}function tf({buttonLabel:e="Subir documento",buttonClassName:n="btn btn-primary",defaultFolder:t=zv,allowFolderInput:a=!0,onUploaded:i}){const[o,s]=g.useState(!1),[l,c]=g.useState(null),[d,p]=g.useState(t||""),[u,m]=g.useState(()=>Date.now()),[y,v]=g.useState(null),[x,w]=g.useState(null),[f,h]=g.useState(!1),b=()=>{c(null),p(t||""),m(Date.now()),v(null),w(null),h(!1)},C=()=>{b(),s(!0)},A=()=>{s(!1),b()},T=R=>{var _;const U=((_=R.target.files)==null?void 0:_[0])||null;c(U),v(null),U&&w(null)},L=async R=>{var _,Q,pe;if(R.preventDefault(),!l){v("Selecciona un archivo");return}const U=Hd(a?d:t);try{h(!0),v(null);const le=await ef(l,{subfolder:U||void 0});if(w((_=le==null?void 0:le.file)!=null&&_.key?"Archivo subido correctamente":"Archivo subido"),c(null),m(Date.now()),typeof i=="function")try{i(le)}catch{}}catch(le){v(((pe=(Q=le==null?void 0:le.response)==null?void 0:Q.data)==null?void 0:pe.message)||(le==null?void 0:le.message)||"No se pudo subir el archivo")}finally{h(!1)}};return r.jsxs(r.Fragment,{children:[r.jsx("button",{type:"button",className:n,onClick:C,children:e}),o&&r.jsx("div",{style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:1e3,padding:16},children:r.jsxs("div",{className:"dash-card",style:{width:"100%",maxWidth:480,position:"relative"},children:[r.jsx("button",{type:"button",onClick:A,style:{position:"absolute",top:12,right:12,background:"transparent",border:"none",color:"#334155",fontSize:20,cursor:"pointer"},"aria-label":"Cerrar",children:"X"}),r.jsx("h3",{className:"dash-title",style:{marginBottom:16},children:"Subir documento"}),r.jsxs("form",{onSubmit:L,children:[r.jsxs("div",{style:{marginBottom:12},children:[r.jsx("label",{style:{display:"block",marginBottom:6,fontWeight:600},children:"Archivo"}),r.jsx("input",{type:"file",onChange:T,disabled:f,required:!0,style:{width:"100%"}},u)]}),a?r.jsxs("div",{style:{marginBottom:16},children:[r.jsx("label",{style:{display:"block",marginBottom:6,fontWeight:600},children:"Subcarpeta (opcional)"}),r.jsx("input",{type:"text",placeholder:t||"documentos_iniciales",value:d,onChange:R=>p(R.target.value),disabled:f,style:{width:"100%",padding:"8px 12px",borderRadius:8,border:"1px solid #cbd5f5"}})]}):r.jsxs("div",{style:{marginBottom:16},children:[r.jsx("label",{style:{display:"block",marginBottom:6,fontWeight:600},children:"Carpeta destino"}),r.jsx("input",{type:"text",value:t||"",readOnly:!0,style:{width:"100%",padding:"8px 12px",borderRadius:8,border:"1px solid #cbd5f5",background:"#1f2937",color:"#e2e8f0"}})]}),y&&r.jsx("div",{style:{background:"#7f1d1d",color:"#fecaca",padding:8,borderRadius:6,marginBottom:12},children:y}),x&&r.jsx("div",{style:{background:"#14532d",color:"#bbf7d0",padding:8,borderRadius:6,marginBottom:12},children:x}),r.jsxs("div",{style:{display:"flex",gap:12,justifyContent:"flex-end"},children:[r.jsx("button",{type:"button",className:"btn btn-secondary",onClick:A,disabled:f,children:"Cancelar"}),r.jsx("button",{type:"submit",className:"btn btn-primary",disabled:f||!l,children:f?"Subiendo...":"Subir"})]})]})]})})]})}const Ov=["Lun","Mar","Mie","Jue","Vie","Sab","Dom"];function Dv(e){const n=e.getFullYear(),t=e.getMonth(),i=(new Date(n,t,1).getDay()+6)%7,o=new Date(n,t+1,0).getDate(),s=[];let l=1-i;for(let c=0;c<6;c+=1){const d=[];for(let p=0;p<7;p+=1){const u=new Date(n,t,l),m=l>=1&&l<=o;d.push({date:u,inCurrentMonth:m}),l+=1}s.push(d)}return s}function Lv(e){if(!e)return null;const n=e.getFullYear(),t=`${e.getMonth()+1}`.padStart(2,"0"),a=`${e.getDate()}`.padStart(2,"0");return`${n}-${t}-${a}`}function af({value:e,onChange:n,onDateSelect:t,events:a=[],className:i=""}){const o=g.useMemo(()=>new Date,[]),[s,l]=g.useState(()=>new Date(o.getFullYear(),o.getMonth(),1)),[c,d]=g.useState(o);g.useEffect(()=>{e instanceof Date&&(d(e),l(new Date(e.getFullYear(),e.getMonth(),1)))},[e]);const p=e instanceof Date?e:c,u=typeof n=="function"?n:t,m=g.useMemo(()=>s.toLocaleDateString("es-ES",{month:"long",year:"numeric"}),[s]),y=g.useMemo(()=>Dv(s),[s]),v=g.useMemo(()=>{const h=new Map;return(a||[]).forEach(b=>{const C=(b==null?void 0:b.date)||(b==null?void 0:b.dateKey);C&&(h.has(C)||h.set(C,[]),h.get(C).push(b))}),h},[a]),x=h=>{h instanceof Date&&(e instanceof Date||d(h),typeof u=="function"&&u(h))},w=h=>{l(b=>new Date(b.getFullYear(),b.getMonth()+h,1))},f=["dash-item",i].filter(Boolean).join(" ").trim();return r.jsxs("div",{className:f,children:[r.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:12},children:[r.jsx("button",{type:"button",className:"btn btn-secondary btn-sm",onClick:()=>w(-1),"aria-label":"Mes anterior",children:"◀"}),r.jsx("div",{style:{fontWeight:600,textTransform:"capitalize"},children:m}),r.jsx("button",{type:"button",className:"btn btn-secondary btn-sm",onClick:()=>w(1),"aria-label":"Mes siguiente",children:"▶"})]}),r.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(7, 1fr)",gap:6,marginBottom:8},children:Ov.map(h=>r.jsx("div",{style:{textAlign:"center",fontSize:12,fontWeight:600,opacity:.75},children:h},h))}),r.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(7, 1fr)",gap:6},children:y.map((h,b)=>h.map(({date:C,inCurrentMonth:A},T)=>{const L=Lv(C),R=C.toDateString()===o.toDateString(),U=C.toDateString()===p.toDateString(),_=v.get(L)||[],Q={position:"relative",borderRadius:8,border:"1px solid rgba(148, 163, 184, 0.25)",padding:"8px 0",textAlign:"center",fontSize:13,cursor:A?"pointer":"default",opacity:A?1:.35,background:"#1f2937",color:"#e2e8f0",transition:"transform 0.12s ease"};return R&&(Q.border="1px solid #38bdf8"),U&&(Q.background="linear-gradient(135deg, #38b2ac, #0ea5e9)",Q.color="#0f172a",Q.fontWeight=700),A&&_.length>0&&!U&&(Q.background="#f5b891",Q.color="#0f172a",Q.border="1px solid rgba(245, 184, 145, 0.65)",Q.fontWeight=600),r.jsxs("button",{type:"button",style:Q,disabled:!A,onClick:()=>A&&x(C),children:[C.getDate(),_.length>0&&r.jsx("span",{style:{position:"absolute",bottom:4,left:"50%",transform:"translateX(-50%)",width:6,height:6,borderRadius:"999px",background:U?"#0f172a":A?"#7c3a00":"#38bdf8"}})]},`${b}-${T}`)}))})]})}function Pv({title:e="Asistente IA",systemPrompt:n}){const[t,a]=g.useState(()=>[]),[i,o]=g.useState(""),[s,l]=g.useState(!1),c=g.useRef(null),d=g.useMemo(()=>i.trim().length>0&&!s,[i,s]),p=()=>{try{const y=c.current;y&&(y.scrollTop=y.scrollHeight)}catch{}},u=async()=>{var x,w,f,h,b,C,A,T,L;const y=i.trim();if(!y)return;const v=[...t,{role:"user",content:y}];a(v),o(""),l(!0),setTimeout(p,0);try{const R={messages:[...n?[{role:"system",content:n}]:[],...v]},{data:U}=await je.post("/ai/chat",R),_=(U==null?void 0:U.reply)||((x=U==null?void 0:U.message)==null?void 0:x.content)||((h=(f=(w=U==null?void 0:U.choices)==null?void 0:w[0])==null?void 0:f.message)==null?void 0:h.content)||((A=(C=(b=U==null?void 0:U.choices)==null?void 0:b[0])==null?void 0:C.delta)==null?void 0:A.content)||"",Q=String(_||"").trim()||"Lo siento, no obtuve respuesta.";a(pe=>[...pe,{role:"assistant",content:Q}]),setTimeout(p,0)}catch(R){const U=((L=(T=R==null?void 0:R.response)==null?void 0:T.data)==null?void 0:L.message)||(R==null?void 0:R.message)||"Error al consultar el asistente";a(_=>[..._,{role:"assistant",content:`⚠️ ${U}`}]),setTimeout(p,0)}finally{l(!1)}},m=y=>{y.key==="Enter"&&!y.shiftKey&&(y.preventDefault(),d&&u())};return r.jsxs("div",{className:"dash-item",style:{display:"flex",flexDirection:"column",gap:10},children:[r.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between"},children:[r.jsx("div",{style:{fontWeight:600},children:e}),r.jsx("button",{type:"button",className:"btn btn-secondary btn-sm",onClick:()=>a([]),disabled:s,children:"Limpiar"})]}),r.jsxs("div",{ref:c,style:{background:"#0f172a",border:"1px solid rgba(148,163,184,0.25)",borderRadius:12,padding:10,minHeight:180,maxHeight:260,overflowY:"auto",display:"flex",flexDirection:"column",gap:8},children:[t.length===0&&r.jsx("div",{style:{opacity:.7},children:"Haz una pregunta para comenzar…"}),t.map((y,v)=>r.jsx("div",{style:{display:"flex",justifyContent:y.role==="user"?"flex-end":"flex-start"},children:r.jsx("div",{style:{maxWidth:"80%",background:y.role==="user"?"rgba(34,211,238,0.12)":"rgba(148,163,184,0.12)",border:"1px solid rgba(148,163,184,0.25)",color:"#e2e8f0",padding:"8px 10px",borderRadius:12,whiteSpace:"pre-wrap"},children:y.content})},v))]}),r.jsxs("div",{style:{display:"grid",gap:8},children:[r.jsx("textarea",{className:"textarea",rows:3,placeholder:"Escribe tu mensaje (Enter para enviar)",value:i,onChange:y=>o(y.target.value),onKeyDown:m,disabled:s}),r.jsxs("div",{style:{display:"flex",gap:8,justifyContent:"flex-end"},children:[r.jsx("button",{type:"button",className:"btn btn-secondary btn-sm",onClick:()=>o(""),disabled:s,children:"Borrar"}),r.jsx("button",{type:"button",className:"btn btn-primary",onClick:u,disabled:!d,children:s?"Enviando…":"Enviar"})]})]})]})}function Mv({label:e,value:n,hint:t}){return r.jsxs("div",{className:"dash-item",children:[r.jsx("div",{className:"text-sm opacity-70",style:{fontSize:12,opacity:.8},children:e}),r.jsx("div",{className:"text-2xl font-semibold",style:{fontSize:28,fontWeight:700},children:n}),t&&r.jsx("div",{className:"text-xs opacity-60",style:{fontSize:12,opacity:.7},children:t})]})}function of({refreshKey:e=0}){const{user:n}=We(),t=g.useMemo(()=>{var s,l,c,d;const a=Array.isArray(n==null?void 0:n.driveFolders)?n.driveFolders.filter(p=>p&&p.url):[],i=(l=(s=import.meta)==null?void 0:s.env)==null?void 0:l.VITE_DEFAULT_DRIVE_FOLDER_URL,o=((d=(c=import.meta)==null?void 0:c.env)==null?void 0:d.VITE_DEFAULT_DRIVE_FOLDER_NAME)||"Carpeta KOOP";return(!a||a.length===0)&&i?[{name:o,url:i}]:a},[n,e]);return r.jsxs("div",{className:"dash-item",children:[r.jsx("div",{className:"font-semibold mb-2",style:{fontWeight:600,marginBottom:8},children:"Documentos recientes"}),t.length===0&&r.jsx("div",{className:"text-sm opacity-60",style:{fontSize:14,opacity:.8},children:"Sin carpetas asignadas."}),t.length>0&&r.jsx("ul",{style:{listStyle:"none",padding:0,margin:0,display:"flex",flexDirection:"column",gap:8},children:t.map((a,i)=>r.jsxs("li",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:12},children:[r.jsxs("div",{style:{minWidth:0},children:[r.jsx("div",{style:{fontWeight:600,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:a.name||"Carpeta de Drive"}),r.jsx("div",{className:"muted",style:{fontSize:12,opacity:.8},children:a.url})]}),r.jsx("a",{className:"btn btn-primary",href:a.url,target:"_blank",rel:"noreferrer","data-drive-folder-url":a.url,children:"Abrir carpeta"})]},(a.url||"")+i))})]})}function _v(){var G,ie;const{user:e}=We(),[n,t]=g.useState(!1),[a,i]=g.useState(null),[o,s]=g.useState(!1),[l,c]=g.useState([]),[d,p]=g.useState(!1),[u,m]=g.useState({x:window.innerWidth-80,y:window.innerHeight-80}),[y,v]=g.useState(!1),[x,w]=g.useState({x:0,y:0}),[f,h]=g.useState(!1),[b,C]=g.useState({x:0,y:0}),[A,T]=g.useState(!1),[L,R]=g.useState(!1),U=g.useRef(null),_=(G=e==null?void 0:e.roles)==null?void 0:G.includes("admin");g.useEffect(()=>{const k=localStorage.getItem("spotifyWidgetPosition");k&&m(JSON.parse(k));const D=localStorage.getItem("spotifyWidgetExpanded");D&&s(JSON.parse(D));const P=localStorage.getItem("spotifyWidgetMinimized");P&&T(JSON.parse(P))},[]),g.useEffect(()=>{localStorage.setItem("spotifyWidgetPosition",JSON.stringify(u))},[u]),g.useEffect(()=>{localStorage.setItem("spotifyWidgetExpanded",JSON.stringify(o))},[o]),g.useEffect(()=>{localStorage.setItem("spotifyWidgetMinimized",JSON.stringify(A))},[A]),g.useEffect(()=>{if(_){Q();const k=()=>{Q()};return window.addEventListener("focus",k),()=>{window.removeEventListener("focus",k)}}},[_]);const Q=async()=>{try{const k=localStorage.getItem("spotifyAccessToken"),D=localStorage.getItem("spotifyTokenExpiry");if(k&&D&&Date.now()<parseInt(D)){console.log("🎵 Usando tokens de Spotify del localStorage");const P=await fetch("https://api.spotify.com/v1/me",{headers:{Authorization:`Bearer ${k}`}});if(P.ok){const ee=await P.json();i(ee),t(!0),console.log("✅ Usuario de Spotify autenticado:",ee.display_name),await pe(k)}else throw new Error("Token de Spotify inválido")}else{const P=await je.get("/spotify/me");i(P.data),t(!0)}}catch{console.log("No hay sesión de Spotify activa"),t(!1),i(null)}},pe=async k=>{try{const D=await fetch("https://api.spotify.com/v1/me/playlists?limit=20",{headers:{Authorization:`Bearer ${k}`}});if(D.ok){const P=await D.json();c(P.items),console.log("📋 Playlists cargadas:",P.items.length)}}catch(D){console.error("Error cargando playlists:",D)}},le=async()=>{try{const k=await je.get("/spotify/auth/url");window.location.href=k.data.authUrl}catch(k){console.error("Error getting auth URL:",k)}},K=k=>{const D=k.type==="mousedown"?k.clientX:k.touches[0].clientX,P=k.type==="mousedown"?k.clientY:k.touches[0].clientY;v(!0),h(!1),C({x:D,y:P}),w({x:D-u.x,y:P-u.y})},Be=k=>{if(!y)return;const D=k.type==="mousemove"?k.clientX:k.touches[0].clientX,P=k.type==="mousemove"?k.clientY:k.touches[0].clientY,ee=D-x.x,B=P-x.y,ce=Math.abs(D-b.x),fe=Math.abs(P-b.y);(ce>5||fe>5)&&h(!0);const me=10,I=window.innerWidth-(o?350:60)-me,j=window.innerHeight-(o?400:60)-me;m({x:Math.max(me,Math.min(ee,I)),y:Math.max(me,Math.min(B,j))})},xe=()=>{v(!1)};if(g.useEffect(()=>(y&&(document.addEventListener("mousemove",Be),document.addEventListener("mouseup",xe),document.addEventListener("touchmove",Be),document.addEventListener("touchend",xe)),()=>{document.removeEventListener("mousemove",Be),document.removeEventListener("mouseup",xe),document.removeEventListener("touchmove",Be),document.removeEventListener("touchend",xe)}),[y,x,b]),g.useEffect(()=>{const k=D=>{U.current&&!U.current.contains(D.target)&&o&&(s(!1),T(!0))};return document.addEventListener("mousedown",k),document.addEventListener("touchstart",k),()=>{document.removeEventListener("mousedown",k),document.removeEventListener("touchstart",k)}},[o]),g.useEffect(()=>{const k=D=>{D.origin==="https://open.spotify.com"&&(D.data&&D.data.type==="playback_started"?R(!0):D.data&&D.data.type==="playback_paused"&&R(!1))};return window.addEventListener("message",k),()=>window.removeEventListener("message",k)},[]),!_)return null;const Me=()=>{const k=window.innerWidth-u.x,D=window.innerHeight-u.y;return k<350&&D<400?"top-left":k<350?"left":D<400?"top":"default"},q=o?(()=>{const k=Me(),D=10;switch(k){case"top-left":return{x:Math.max(D,u.x-290),y:Math.max(D,u.y-340)};case"left":return{x:Math.max(D,u.x-290),y:u.y};case"top":return{x:u.x,y:Math.max(D,u.y-340)};default:return u}})():u;return r.jsxs("div",{ref:U,style:{position:"fixed",left:q.x,top:q.y,zIndex:1e3,width:o?"350px":"60px",height:o?"400px":"60px",backgroundColor:"rgba(15, 23, 42, 0.95)",backdropFilter:"blur(10px)",border:"1px solid rgba(148, 163, 184, 0.2)",borderRadius:"12px",boxShadow:"0 10px 25px rgba(0, 0, 0, 0.3)",transition:y?"none":"all 0.3s ease",cursor:y?"grabbing":"grab",touchAction:"none",userSelect:"none"},onMouseDown:K,onTouchStart:K,children:[!o&&r.jsxs("div",{onClick:k=>{k.stopPropagation(),f||(s(!0),T(!1))},style:{width:"100%",height:"100%",display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer",transition:"transform 0.2s ease"},onMouseEnter:k=>{y||(k.target.style.transform="scale(1.1)")},onMouseLeave:k=>{y||(k.target.style.transform="scale(1)")},children:[r.jsx("span",{style:{fontSize:"24px",color:A&&n?"#1db954":"#fc771c",fontWeight:"bold"},children:"♪"}),A&&n&&r.jsx("div",{style:{position:"absolute",top:"5px",right:"5px",width:"8px",height:"8px",backgroundColor:L?"#1db954":"#ff6b6b",borderRadius:"50%",animation:L?"pulse 2s infinite":"none"}})]}),o&&r.jsxs("div",{style:{display:"flex",flexDirection:"column",height:"100%",justifyContent:"space-between"},children:[r.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:"16px"},children:[r.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[r.jsx("h4",{style:{color:"#1db954",margin:0,fontSize:"16px",fontWeight:"bold"},children:"Spotify"}),n&&r.jsx("p",{style:{color:"#94a3b8",margin:0,fontSize:"12px"},children:a==null?void 0:a.display_name})]}),r.jsxs("div",{style:{display:"flex",gap:"8px",alignItems:"center"},children:[n&&r.jsx("button",{onClick:()=>p(!d),style:{background:d?"#1db954":"rgba(255, 255, 255, 0.1)",border:"none",color:"white",fontSize:"12px",fontWeight:"bold",cursor:"pointer",padding:"6px 12px",borderRadius:"15px",transition:"all 0.2s ease"},children:"📋"}),!n&&r.jsx("button",{onClick:le,style:{background:"#fc771c",border:"none",color:"#fff",fontSize:"14px",fontWeight:"bold",cursor:"pointer",padding:"8px 16px",borderRadius:"20px",transition:"all 0.2s ease"},onMouseEnter:k=>{k.target.style.background="#f97316",k.target.style.transform="scale(1.05)"},onMouseLeave:k=>{k.target.style.background="#fc771c",k.target.style.transform="scale(1)"},children:"Conectar"}),r.jsx("button",{onClick:k=>{k.stopPropagation(),s(!1),T(!0);const D=10,P=60,ee=window.innerWidth-P-D,B=window.innerHeight-P-D;m(ce=>({x:Math.max(D,Math.min(ce.x,ee)),y:Math.max(D,Math.min(ce.y,B))}))},style:{background:"transparent",border:"none",color:"#94a3b8",fontSize:"18px",cursor:"pointer",padding:"6px",borderRadius:"6px",transition:"all 0.2s ease"},onMouseEnter:k=>{k.target.style.color="#e2e8f0",k.target.style.backgroundColor="rgba(148, 163, 184, 0.1)"},onMouseLeave:k=>{k.target.style.color="#94a3b8",k.target.style.backgroundColor="transparent"},children:"×"})]})]}),r.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"12px",flex:1,justifyContent:"center"},children:n?r.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"12px",height:"100%"},children:[d?r.jsxs("div",{style:{height:"100%",overflowY:"auto",padding:"8px",backgroundColor:"rgba(40, 40, 40, 0.8)",borderRadius:"8px",border:"1px solid rgba(255, 255, 255, 0.1)"},children:[r.jsx("h4",{style:{color:"#1db954",margin:"0 0 12px 0",fontSize:"14px"},children:"Tus Playlists"}),l.map(k=>{var D;return r.jsxs("div",{onClick:()=>{const P=document.querySelector('iframe[src*="open.spotify.com"]');P&&(P.src=`https://open.spotify.com/embed/playlist/${k.id}?utm_source=generator&theme=0`),p(!1)},style:{padding:"8px",backgroundColor:"rgba(0, 0, 0, 0.3)",marginBottom:"6px",borderRadius:"6px",cursor:"pointer",display:"flex",alignItems:"center",gap:"8px",transition:"all 0.2s ease"},onMouseEnter:P=>{P.target.style.backgroundColor="rgba(29, 185, 84, 0.2)",P.target.style.transform="scale(1.02)"},onMouseLeave:P=>{P.target.style.backgroundColor="rgba(0, 0, 0, 0.3)",P.target.style.transform="scale(1)"},children:[r.jsx("img",{src:((D=k.images[0])==null?void 0:D.url)||"/img/default-playlist.png",alt:"Playlist",style:{width:"40px",height:"40px",borderRadius:"4px"}}),r.jsxs("div",{style:{flex:1,minWidth:0},children:[r.jsx("p",{style:{color:"white",margin:"0",fontSize:"12px",whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"},children:k.name}),r.jsxs("p",{style:{color:"#b3b3b3",margin:"0",fontSize:"10px"},children:[k.tracks.total," canciones"]})]})]},k.id)})]}):r.jsx("div",{style:{width:"100%",height:"250px",borderRadius:"8px",overflow:"hidden",backgroundColor:"rgba(40, 40, 40, 0.8)",border:"1px solid rgba(255, 255, 255, 0.1)"},children:r.jsx("iframe",{src:"https://open.spotify.com/embed/playlist/1Zf1rz0XX6fyNxKOq4XvgN?utm_source=generator&theme=0",width:"100%",height:"250",frameBorder:"0",allowtransparency:"true",allow:"encrypted-media",style:{borderRadius:"8px",border:"none"}})}),r.jsxs("div",{style:{display:"flex",gap:"6px",paddingTop:"8px",borderTop:"1px solid rgba(255, 255, 255, 0.1)"},children:[r.jsx("a",{href:((ie=a==null?void 0:a.external_urls)==null?void 0:ie.spotify)||"https://open.spotify.com",target:"_blank",rel:"noopener noreferrer",style:{flex:1,background:"#1db954",border:"none",color:"#fff",fontSize:"12px",fontWeight:"bold",cursor:"pointer",padding:"8px 12px",borderRadius:"6px",textDecoration:"none",textAlign:"center",transition:"all 0.2s ease"},children:"Abrir"}),r.jsx("button",{onClick:()=>{localStorage.removeItem("spotifyAccessToken"),localStorage.removeItem("spotifyRefreshToken"),localStorage.removeItem("spotifyTokenExpiry"),t(!1),i(null),c([])},style:{flex:1,background:"#ff4444",border:"none",color:"#fff",fontSize:"12px",fontWeight:"bold",cursor:"pointer",padding:"8px 12px",borderRadius:"6px",transition:"all 0.2s ease"},children:"Salir"})]})]}):r.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:"12px",padding:"20px 0"},children:[r.jsx("div",{style:{fontSize:"48px",color:"#1db954"},children:"♪"}),r.jsx("h3",{style:{color:"#1db954",margin:0,fontSize:"18px",textAlign:"center"},children:"Reproductor de Spotify"}),r.jsx("p",{style:{color:"#94a3b8",margin:0,fontSize:"14px",textAlign:"center",lineHeight:"1.5"},children:"Conecta tu cuenta de Spotify para disfrutar de tu música favorita"}),r.jsx("button",{onClick:le,style:{background:"#1db954",border:"none",color:"#fff",fontSize:"16px",fontWeight:"bold",cursor:"pointer",padding:"12px 24px",borderRadius:"25px",transition:"all 0.2s ease",marginTop:"8px"},onMouseEnter:k=>{k.target.style.background="#1ed760",k.target.style.transform="scale(1.05)"},onMouseLeave:k=>{k.target.style.background="#1db954",k.target.style.transform="scale(1)"},children:"Conectar con Spotify"})]})})]}),r.jsx("style",{jsx:!0,children:`
        @keyframes pulse {
          0% {
            transform: scale(1);
            opacity: 1;
      ...
      `})]})}function Vv(e){if(!(e instanceof Date))return null;const n=e.getFullYear(),t=`${e.getMonth()+1}`.padStart(2,"0"),a=`${e.getDate()}`.padStart(2,"0");return`${n}-${t}-${a}`}function Bv(){return typeof crypto<"u"&&crypto.randomUUID?crypto.randomUUID():`evt-${Date.now()}-${Math.random().toString(16).slice(2)}`}function Fv(){const{user:e}=We(),n=jo((e==null?void 0:e.name)||"Dashboard"),[t,a]=g.useState(null),[i,o]=g.useState(!0),[s,l]=g.useState(null),[c,d]=g.useState(0),[p,u]=rf(),[m,y]=g.useState(()=>new Date),v=g.useMemo(()=>Vv(m),[m]),[x,w]=g.useState(""),[f,h]=g.useState(!0),[b,C]=g.useState(""),[A,T]=g.useState([]),[L,R]=g.useState(!1),[U,_]=g.useState(0),[Q,pe]=g.useState(!1),le=g.useRef(null),[K,Be]=g.useState([]),[xe,Me]=g.useState(!1),[M,q]=g.useState(null),G=g.useMemo(()=>Array.isArray(p)?p.length:0,[p]);g.useEffect(()=>{(async()=>{var I;try{const{data:j}=await je.get("/kpis/overview");a(j)}catch(j){l(((I=j==null?void 0:j.response)==null?void 0:I.data)||(j==null?void 0:j.message))}finally{o(!1)}})()},[]),g.useEffect(()=>{let I=!1;return(async()=>{var j,W;try{Me(!0),q(null);const oe=await lc();if(I)return;const Qe=Array.isArray(oe==null?void 0:oe.items)?oe.items:[];Be(Qe.map(re=>({id:String((re==null?void 0:re.id)||(re==null?void 0:re._id)||(re==null?void 0:re.documentNumber)||"").trim(),name:(re==null?void 0:re.name)||(re==null?void 0:re.fullName)||(re==null?void 0:re.email)||"Cliente sin nombre",email:re==null?void 0:re.email})).filter(re=>re.id))}catch(oe){I||q(((W=(j=oe==null?void 0:oe.response)==null?void 0:j.data)==null?void 0:W.message)||(oe==null?void 0:oe.message)||"No se pudo cargar clientes")}finally{I||Me(!1)}})(),()=>{I=!0}},[]),g.useEffect(()=>{if(!Q)return;const I=W=>{try{le.current&&!le.current.contains(W.target)&&pe(!1)}catch{}},j=W=>{W.key==="Escape"&&pe(!1)};return typeof window<"u"&&(window.addEventListener("click",I),window.addEventListener("keydown",j)),()=>{typeof window<"u"&&(window.removeEventListener("click",I),window.removeEventListener("keydown",j))}},[Q]);const ie=g.useMemo(()=>{if(!b)return K;const I=b.trim().toLowerCase();return K.filter(j=>[j.id,j.name,j.email].some(W=>String(W||"").toLowerCase().includes(I)))},[K,b]),k=g.useMemo(()=>p.filter(j=>(j==null?void 0:j.date)===v).sort((j,W)=>(j.createdAt||"").localeCompare(W.createdAt||"")),[p,v]),D=I=>{const j=String(I);T(W=>W.includes(j)?W.filter(oe=>oe!==j):[...W,j])},P=()=>{const I=x.trim();if(!v||!I||!f&&A.length===0)return;const j={id:Bv(),date:v,note:I,audience:f?{type:"all"}:{type:"clients",clientIds:A.map(W=>String(W).trim())},createdAt:new Date().toISOString(),createdBy:(e==null?void 0:e.id)||(e==null?void 0:e.sub)||"admin"};u(W=>[...W,j]),w(""),T([]),h(!0),R(!1)},ee={padding:"10px 14px",fontSize:"14px",minHeight:"52px",borderRadius:"10px",fontWeight:600,display:"flex",alignItems:"center",justifyContent:"center",width:"100%"},B=[{key:"clientes",label:"Clientes",to:"/admin/clientes-activos"},{key:"procesos",label:"Procesos",to:"/mis-casos"},{key:"publicaciones",label:"Publicaciones Procesales",href:"https://koop.com/publicaciones-procesales"}],ce=g.useMemo(()=>m==null?void 0:m.toLocaleDateString("es-ES",{weekday:"long",day:"numeric",month:"long",year:"numeric"}),[m]),fe=I=>{y(I),typeof window<"u"&&window.innerWidth<1024&&R(!0)},me=()=>{if(!v||k.length===0)return;const I=`¿Borrar todas las anotaciones del ${ce}?`;typeof window<"u"&&!window.confirm(I)||u(j=>j.filter(W=>(W==null?void 0:W.date)!==v))};return g.useEffect(()=>{if(!L){_(0);return}const I=()=>{try{const W=window.visualViewport;if(W){const oe=Math.max(0,Math.round(window.innerHeight-W.height));_(oe)}else _(0)}catch{_(0)}};I();const j=window.visualViewport;return j&&j.addEventListener("resize",I),window.addEventListener("resize",I),()=>{j&&j.removeEventListener("resize",I),window.removeEventListener("resize",I)}},[L]),r.jsxs("div",{className:"dash-page",style:{backgroundImage:"linear-gradient(rgba(13,27,42,0.65), rgba(27,38,59,0.65)), url('/fondodashboard.jpg')",backgroundSize:"cover",backgroundAttachment:"fixed",backgroundPosition:"center"},children:[r.jsxs("div",{className:"dash-card",style:{maxWidth:1200},children:[r.jsx("style",{children:`
        ...
        `}),r.jsxs("div",{className:"dash-header",children:[r.jsx("div",{className:"dash-title",children:n}),r.jsx("div",{style:{display:"flex",gap:12,flexWrap:"wrap",justifyContent:"flex-end"},children:r.jsx(tf,{buttonClassName:"btn btn-primary",allowFolderInput:!0,onUploaded:()=>d(I=>I+1)})})]}),r.jsxs("div",{className:"dash-item",style:{display:"flex",flexWrap:"wrap",gap:8},children:[r.jsx(O,{className:"btn btn-primary",to:"/admin/tareas",title:"Ver y gestionar tareas",children:`Tareas: (${G})`}),r.jsx(O,{className:"btn btn-primary btn-sm",to:"/admin/clientes-activos",title:"Clientes",children:"Clientes"}),r.jsxs("div",{style:{position:"relative"},ref:le,children:[r.jsx("button",{type:"button",className:"btn btn-orange btn-sm",onClick:()=>pe(I=>!I),"aria-haspopup":"menu","aria-expanded":Q?"true":"false",children:"Consultas"}),Q&&r.jsxs("div",{role:"menu",className:"quick-menu",style:{position:"absolute",top:"calc(100% + 6px)",right:0,zIndex:1010,background:"#0f172a",color:"#e2e8f0",border:"1px solid rgba(148,163,184,0.25)",borderRadius:12,boxShadow:"0 10px 24px rgba(0,0,0,0.45)",minWidth:320,padding:8},onClick:I=>I.stopPropagation(),children:[r.jsx("button",{type:"button",className:"btn btn-secondary btn-sm",style:{width:"100%",justifyContent:"flex-start",marginBottom:6},onClick:()=>{typeof window<"u"&&window.open("https://consultaprocesos.ramajudicial.gov.co/Procesos/Index","_blank","noopener"),pe(!1)},role:"menuitem",children:"1. Consulta de procesos Rama Judicial"}),r.jsx("button",{type:"button",className:"btn btn-secondary btn-sm",style:{width:"100%",justifyContent:"flex-start",marginBottom:6},onClick:()=>{typeof window<"u"&&window.open("https://publicacionesprocesales.ramajudicial.gov.co/","_blank","noopener"),pe(!1)},role:"menuitem",children:"2. Publicaciones Procesales Rama Judicial"}),r.jsx("button",{type:"button",className:"btn btn-secondary btn-sm",style:{width:"100%",justifyContent:"flex-start",marginBottom:6},onClick:()=>{typeof window<"u"&&window.open("https://siugj.ramajudicial.gov.co/principalPortal/index.php","_blank","noopener"),pe(!1)},role:"menuitem",children:"3. Siugj"}),r.jsx("button",{type:"button",className:"btn btn-secondary btn-sm",style:{width:"100%",justifyContent:"flex-start",marginBottom:6},onClick:()=>{typeof window<"u"&&window.open("https://consulta-web.fiscalia.gov.co/","_blank","noopener"),pe(!1)},role:"menuitem",children:"4. Consultas Fiscalía"}),r.jsx("button",{type:"button",className:"btn btn-secondary btn-sm",style:{width:"100%",justifyContent:"flex-start"},onClick:()=>{typeof window<"u"&&window.open("https://www.superfinanciera.gov.co/formulesuqueja/faces/consulta/jurisdiccional.xhtml","_blank","noopener"),pe(!1)},role:"menuitem",children:"5. Consultas Jurisdiccionales SuperFinanciera"})]})]}),r.jsx(O,{className:"btn btn-secondary btn-sm",to:"/admin/usuarios",title:"Administrar usuarios",children:"Administrar usuarios"})]}),r.jsx("div",{className:"kpi-grid",style:{marginTop:16},children:r.jsx(Mv,{label:"Casos activos",value:(K==null?void 0:K.length)??0})}),r.jsxs("div",{className:"admin-main-grid",style:{marginTop:16},children:[r.jsxs("div",{className:"admin-main-left",children:[r.jsxs("div",{className:"dash-item",children:[r.jsx("div",{className:"font-semibold mb-2",style:{fontWeight:600,marginBottom:8},children:"Centro administrativo"}),r.jsx("p",{style:{marginBottom:12},children:"Supervisa la operacion del portal, gestiona usuarios y da seguimiento a la informacion mas reciente."}),r.jsxs("div",{style:{display:"flex",flexWrap:"wrap",gap:8},children:[r.jsx(O,{className:"btn btn-primary btn-sm",to:"/admin/usuarios",title:"Administrar usuarios",children:"Administrar usuarios"}),r.jsx(O,{className:"btn btn-secondary btn-sm",to:"/mi-expediente",title:"Revisar expedientes",children:"Revisar expedientes"})]})]}),r.jsx(af,{value:m,onChange:fe,events:p}),r.jsx("div",{style:{display:"grid",gap:10},children:B.map(I=>r.jsx("div",{className:"dash-item",style:{padding:0,display:"flex",alignItems:"stretch"},children:I.to?r.jsx(O,{className:"btn btn-primary",to:I.to,style:ee,children:I.label}):r.jsx("button",{type:"button",className:"btn btn-primary",style:ee,onClick:()=>{typeof window<"u"&&I.href&&window.open(I.href,"_blank","noopener")},children:I.label})},I.key))})]}),r.jsxs("div",{className:"admin-main-right",children:[r.jsx(Pv,{title:"Asistente IA",systemPrompt:"Eres un asistente interno de Koop Strategic Advisory. Responde de forma breve, clara y profesional."}),r.jsxs("div",{className:"dash-item compose-panel",children:[r.jsx("div",{className:"font-semibold",style:{fontWeight:600},children:ce||"Selecciona un dia"}),r.jsx("p",{style:{marginTop:4,fontSize:13,opacity:.8},children:"Registra recordatorios o publicaciones para clientes especificos o para todos."}),r.jsx("textarea",{value:x,onChange:I=>w(I.target.value),placeholder:"Agregar nota o detalle del evento",rows:4,style:{width:"100%",marginTop:12,background:"#1b263b",color:"#e2e8f0",border:"1px solid rgba(148,163,184,0.35)",borderRadius:10,padding:"10px 12px",resize:"vertical"}}),r.jsx("div",{style:{marginTop:12},children:r.jsxs("label",{style:{display:"flex",alignItems:"center",gap:8},children:[r.jsx("input",{type:"checkbox",checked:f,onChange:I=>{h(I.target.checked),I.target.checked&&T([])}}),r.jsx("span",{children:"Publicar para todos los clientes"})]})}),!f&&r.jsxs("div",{style:{marginTop:12},children:[r.jsx("input",{type:"search",placeholder:"Buscar por nombre, email o ID",value:b,onChange:I=>C(I.target.value),style:{width:"100%",padding:"8px 12px",borderRadius:10,border:"1px solid rgba(148,163,184,0.35)",background:"#1b263b",color:"#e2e8f0"}}),M&&r.jsx("div",{style:{color:"#fecaca",background:"#7f1d1d",padding:8,borderRadius:8,marginTop:8},children:M}),r.jsxs("div",{className:"admin-clients-list",style:{marginTop:8},children:[xe&&r.jsx("div",{style:{opacity:.7},children:"Cargando clientes..."}),!xe&&ie.length===0&&r.jsx("div",{style:{opacity:.7},children:"No se encontraron clientes"}),ie.map(I=>{const j=A.includes(I.id);return r.jsxs("label",{className:"admin-clients-item",children:[r.jsxs("span",{style:{display:"flex",flexDirection:"column"},children:[r.jsx("span",{style:{fontWeight:600},children:I.name}),r.jsx("span",{style:{fontSize:12,opacity:.75},children:I.id})]}),r.jsx("input",{type:"checkbox",checked:j,onChange:()=>D(I.id)})]},I.id)})]}),A.length>0&&r.jsxs("div",{style:{marginTop:8,fontSize:12,opacity:.7},children:["Seleccionados: ",A.join(", ")]})]}),r.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",gap:10,marginTop:12},children:[r.jsx("button",{type:"button",className:"btn btn-secondary",onClick:()=>{w(""),h(!0),T([])},children:"Limpiar"}),r.jsx("button",{type:"button",className:"btn btn-danger",onClick:me,disabled:!v||k.length===0,children:"Borrar anotaciones"}),r.jsx("button",{type:"button",className:"btn btn-primary",onClick:P,disabled:!x.trim()||!f&&A.length===0,children:"Guardar anotacion"})]}),k.length>0&&r.jsxs("div",{style:{marginTop:16},children:[r.jsx("div",{style:{fontWeight:600,marginBottom:8},children:"Anotaciones del dia"}),r.jsx("div",{style:{display:"flex",flexDirection:"column",gap:8},children:k.map(I=>{var j,W;return r.jsxs("div",{style:{border:"1px solid rgba(148,163,184,0.35)",borderRadius:10,padding:10,background:"#1b263b"},children:[r.jsx("div",{style:{marginBottom:6},children:I.note}),r.jsx("div",{style:{fontSize:12,opacity:.7},children:((j=I.audience)==null?void 0:j.type)==="all"?"Visible para todos los clientes":`Visible para: ${Array.isArray((W=I.audience)==null?void 0:W.clientIds)&&I.audience.clientIds.length>0?I.audience.clientIds.join(", "):"—"}`})]},I.id)})})]})]}),r.jsxs("div",{className:"dash-item",children:[r.jsx("div",{className:"font-semibold mb-2",style:{fontWeight:600,marginBottom:8},children:"Recordatorios del equipo"}),r.jsx("p",{style:{marginBottom:0},children:"Comparte novedades internas, carga reportes de gestion o establece tareas prioritarias para tu equipo desde esta seccion."})]}),r.jsxs("div",{className:"dash-item",children:[r.jsx("div",{className:"font-semibold mb-2",style:{fontWeight:600,marginBottom:8},children:"Reproductor Spotify"}),r.jsx("p",{style:{marginBottom:0,fontSize:13,opacity:.8},children:"El reproductor de Spotify está disponible como ventana flotante en la esquina inferior izquierda. La música continuará reproduciéndose mientras navegas entre páginas."})]})]})]}),r.jsx("div",{style:{marginTop:16},children:r.jsx(of,{refreshKey:c})}),s&&r.jsx("pre",{className:"text-red-600 text-sm mt-2",style:{color:"#fecaca",background:"#7f1d1d",padding:12,borderRadius:8,marginTop:12},children:typeof s=="string"?s:JSON.stringify(s,null,2)})]}),L&&r.jsx("div",{className:"compose-overlay",role:"dialog","aria-modal":"true",children:r.jsxs("div",{className:"compose-modal",style:{marginBottom:U>0?U:0,maxHeight:`calc(100dvh - ${U}px)`,paddingBottom:"calc(16px + env(safe-area-inset-bottom))"},children:[r.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8},children:[r.jsx("div",{style:{fontWeight:700},children:ce||"Selecciona un dia"}),r.jsx("button",{type:"button",className:"btn btn-secondary btn-sm",onClick:()=>R(!1),"aria-label":"Cerrar",children:"Cerrar"})]}),r.jsxs("div",{className:"dash-item",style:{padding:0},children:[r.jsx("p",{style:{marginTop:4,fontSize:13,opacity:.8},children:"Registra recordatorios o publicaciones para clientes especificos o para todos."}),r.jsx("textarea",{value:x,onChange:I=>w(I.target.value),placeholder:"Agregar nota o detalle del evento",rows:4,style:{width:"100%",marginTop:12,background:"#1b263b",color:"#e2e8f0",border:"1px solid rgba(148,163,184,0.35)",borderRadius:10,padding:"10px 12px",resize:"vertical"}}),r.jsx("div",{style:{marginTop:12},children:r.jsxs("label",{style:{display:"flex",alignItems:"center",gap:8},children:[r.jsx("input",{type:"checkbox",checked:f,onChange:I=>{h(I.target.checked),I.target.checked&&T([])}}),r.jsx("span",{children:"Publicar para todos los clientes"})]})}),!f&&r.jsxs("div",{style:{marginTop:12},children:[r.jsx("input",{type:"search",placeholder:"Buscar por nombre, email o ID",value:b,onChange:I=>C(I.target.value),style:{width:"100%",padding:"8px 12px",borderRadius:10,border:"1px solid rgba(148,163,184,0.35)",background:"#1b263b",color:"#e2e8f0"}}),M&&r.jsx("div",{style:{color:"#fecaca",background:"#7f1d1d",padding:8,borderRadius:8,marginTop:8},children:M}),r.jsxs("div",{className:"admin-clients-list",style:{marginTop:8},children:[xe&&r.jsx("div",{style:{opacity:.7},children:"Cargando clientes..."}),!xe&&ie.length===0&&r.jsx("div",{style:{opacity:.7},children:"No se encontraron clientes"}),ie.map(I=>{const j=A.includes(I.id);return r.jsxs("label",{className:"admin-clients-item",children:[r.jsxs("span",{style:{display:"flex",flexDirection:"column"},children:[r.jsx("span",{style:{fontWeight:600},children:I.name}),r.jsx("span",{style:{fontSize:12,opacity:.75},children:I.id})]}),r.jsx("input",{type:"checkbox",checked:j,onChange:()=>D(I.id)})]},I.id)})]}),A.length>0&&r.jsxs("div",{style:{marginTop:8,fontSize:12,opacity:.7},children:["Seleccionados: ",A.join(", ")]})]}),r.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",gap:10,marginTop:12},children:[r.jsx("button",{type:"button",className:"btn btn-secondary",onClick:()=>{w(""),h(!0),T([])},children:"Limpiar"}),r.jsx("button",{type:"button",className:"btn btn-danger",onClick:me,disabled:!v||k.length===0,children:"Borrar anotaciones"}),r.jsx("button",{type:"button",className:"btn btn-primary",onClick:P,disabled:!x.trim()||!f&&A.length===0,children:"Guardar anotacion"})]}),k.length>0&&r.jsxs("div",{style:{marginTop:16},children:[r.jsx("div",{style:{fontWeight:600,marginBottom:8},children:"Anotaciones del dia"}),r.jsx("div",{style:{display:"flex",flexDirection:"column",gap:8},children:k.map(I=>{var j,W;return r.jsxs("div",{style:{border:"1px solid rgba(148,163,184,0.35)",borderRadius:10,padding:10,background:"#1b263b"},children:[r.jsx("div",{style:{marginBottom:6},children:I.note}),r.jsx("div",{style:{fontSize:12,opacity:.7},children:((j=I.audience)==null?void 0:j.type)==="all"?"Visible para todos los clientes":`Visible para: ${Array.isArray((W=I.audience)==null?void 0:W.clientIds)&&I.audience.clientIds.length>0?I.audience.clientIds.join(", "):"-"}`})]},I.id)})})]})]})]})}),r.jsx(_v,{})]})}function Uv({src:e,heightDesktop:n=560,heightMobile:t=480,className:a}){const[i,o]=g.useState(!1),[s,l]=g.useState(!1),c=g.useRef(null);g.useEffect(()=>{try{const x=window.matchMedia("(max-width: 768px)"),w=f=>{o(f.matches),f.matches&&l(!1)};return o(x.matches),x.matches&&l(!1),x.addEventListener?x.addEventListener("change",w):x.addListener&&x.addListener(w),()=>{x.removeEventListener?x.removeEventListener("change",w):x.removeListener&&x.removeListener(w)}}catch{o(!1)}},[]),g.useEffect(()=>{if(!s){c.current!==null&&(document.body.style.overflow=c.current,c.current=null);return}return c.current===null&&(c.current=document.body.style.overflow||""),document.body.style.overflow="hidden",()=>{c.current!==null?(document.body.style.overflow=c.current,c.current=null):document.body.style.overflow=""}},[s]);const d=g.useMemo(()=>{try{return new URL(e,window.location.origin).toString()}catch{return e}},[e]),p=()=>l(x=>!x),u=["Te compartimos que ya tienes acceso a nuestro Portal de Clientes Koop.","","Desde alli podras:","- Consultar el estado de tus procesos en tiempo real.","- Descargar documentos relevantes de manera segura.","- Recibir notificaciones de audiencias y plazos importantes.","- Comunicarte directamente con nuestro equipo para resolver cualquier inquietud.","","Estamos seguros de que esta alianza marcara un camino de crecimiento y tranquilidad."].join(`
