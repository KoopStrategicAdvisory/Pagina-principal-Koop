...
import Derecho from './pages/Derecho/index.jsx';
import Contabilidad from './pages/Contabilidad/index.jsx';
import Auditoria from './pages/Auditoria/index.jsx';
import DerechoAdministrativo from './pages/DerechoAdministrativo/index.jsx';
import DerechoFamilia from './pages/DerechoFamilia/index.jsx';
import DerechoLaboral from './pages/DerechoLaboral/index.jsx';
import DerechoPenal from './pages/DerechoPenal/index.jsx';
import Impuestos from './pages/Impuestos/index.jsx';
import AsesoriaContable from './pages/AsesoriaContable/index.jsx';
import Privacidad from './pages/Privacidad/index.jsx';
import TramitesNotariales from './pages/TramitesNotariales/index.jsx';
...
import MiExpediente from './pages/Miexpediente/index.jsx';
import MisCasos from './pages/MisCasos/index.jsx';
import Logout from './pages/Logout/index.jsx';
import SpotifyCallback from './pages/SpotifyCallback/index.jsx';
