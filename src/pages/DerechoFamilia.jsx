      ...
      <section className="labor-cards-section" id="servicios-familia">
        <div className="labor-cards-container">
          ...
          <div className="labor-grid">
            ...
            <a href="#divorcio" className="labor-card" style={{ '--bg': 'url(\'img/Acompañamiento.png\')' }}>
            ...
            <a href="#custodia" className="labor-card" style={{ '--bg': 'url(\'img/Victimas.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
            ...
            <a href="#alimentos" className="labor-card" style={{ '--bg': 'url(\'img/donacionescambio.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
            ...
            <a href="#sociedad" className="labor-card" style={{ '--bg': 'url(\'img/sucesionescambio.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
                <div className="labor-card-title"><span className="labor-dot"></span>Liquidación de sociedad conyugal</div>
                <div className="labor-card-desc">Distribución equitativa de bienes y obligaciones matrimoniales.</div>
              </div>
            </a>
    
            {/* 5. Adopciones */}
            <a href="#adopciones" className="labor-card" style={{ '--bg': 'url(\'img/Audiencias.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
                <div className="labor-card-title"><span className="labor-dot"></span>Adopciones</div>
                <div className="labor-card-desc">Acompañamiento en procesos de adopción nacional e internacional.</div>
              </div>
            </a>
        ...
        <div className="footer-top">
          ...
          <div className="footer-brand">
            ...
            <div className="footer-cta">
              ...
              <div className="btns">
                <a className="btn btn-whatsapp" href="https://wa.me/573503965755?text=Cordial Saludo%20Koop,%20deseo%20asesor%C3%ADa%20en%20derecho%20de%20familia%20sobre%20el%20siguiente%20tema:" target="_blank" rel="noopener">
                  {/* Ícono WhatsApp (22px) */}
