      ...
      <section className="labor-cards-section" id="servicios-auditoria">
        <div className="labor-cards-container">
          ...
          <div className="labor-grid">
            ...
            <a href="#sistemas" className="labor-card" style={{ '--bg': 'url(\'img/Audiencias.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
                <div className="labor-card-title"><span className="labor-dot"></span>Auditoría de sistemas</div>
                <div className="labor-card-desc">Revisión de procesos y seguridad informática.</div>
              </div>
            </a>
