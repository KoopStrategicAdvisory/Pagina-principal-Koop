  ...
  <>
    {/* Overlay de transición */}
      ...
      <section className="hero-section" id="inicio">
        ...
        <div className="hero-text" aria-label="Resolución de Disputas">
          <div className="hero-headline">Resolución de Disputas</div>
        </div>
      </section>
    
      {/* SECCIÓN CARDS */}
      <section className="labor-cards-section" id="servicios-resolucion">
        <div className="labor-cards-container">
          <div className="labor-tag">SERVICIOS DE RESOLUCIÓN DE DISPUTAS</div>
          <h2 className="labor-title">Cómo te ayudamos</h2>
          <p className="labor-sub">Soluciones efectivas mediante arbitraje, conciliación y mediación.</p>
    
          <div className="labor-grid">
            {/* 1. Arbitraje */}
            <a href="#arbitraje" className="labor-card" style={{ '--bg': 'url(\'img/Acompañamiento.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
                <div className="labor-card-title"><span className="labor-dot"></span>Arbitraje</div>
                <div className="labor-card-desc">Asistencia y representación en tribunales arbitrales.</div>
              </div>
            </a>
    
            {/* 2. Conciliación */}
            <a href="#conciliacion" className="labor-card" style={{ '--bg': 'url(\'img/Victimas.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
                <div className="labor-card-title"><span className="labor-dot"></span>Conciliación</div>
                <div className="labor-card-desc">Facilitación de acuerdos extrajudiciales.</div>
              </div>
            </a>
    
            {/* 3. Mediación */}
            <a href="#mediacion" className="labor-card" style={{ '--bg': 'url(\'img/donacionescambio.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
                <div className="labor-card-title"><span className="labor-dot"></span>Mediación</div>
                <div className="labor-card-desc">Procesos colaborativos para resolver conflictos.</div>
              </div>
            </a>
    
            {/* 4. Litigio estratégico */}
            <a href="#litigio" className="labor-card" style={{ '--bg': 'url(\'img/sucesionescambio.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
                <div className="labor-card-title"><span className="labor-dot"></span>Litigio estratégico</div>
                <div className="labor-card-desc">Estrategias procesales en la jurisdicción ordinaria.</div>
              </div>
            </a>
    
            {/* 5. Negociación asistida */}
            <a href="#negociacion" className="labor-card" style={{ '--bg': 'url(\'img/Audiencias.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
                <div className="labor-card-title"><span className="labor-dot"></span>Negociación asistida</div>
                <div className="labor-card-desc">Diseño y conducción de negociaciones complejas.</div>
              </div>
            </a>
    
            {/* 6. Cláusulas contractuales */}
            <a href="#clausulas" className="labor-card" style={{ '--bg': 'url(\'img/capitulaciones.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
                <div className="labor-card-title"><span className="labor-dot"></span>Cláusulas contractuales</div>
                <div className="labor-card-desc">Redacción de acuerdos de resolución de conflictos.</div>
              </div>
            </a>
          </div>
        </div>
        ...
        <div className="footer-top">
          ...
          <div className="footer-brand">
            ...
            <p className="footer-copy">
              Estudio jurídico & contable. Representación estratégica en controversias.
            </p>
            <div className="footer-cta">
              <h4>¿Necesitas una asesoría en resolución de disputas?</h4>
              <div className="btns">
                <a className="btn btn-whatsapp" href="https://wa.me/573503965755?text=Cordial%20Saludo%20Koop,%20deseo%20asesor%C3%ADa%20en%20resoluci%C3%B3n%20de%20disputas%20sobre%20el%20siguiente%20tema:" target="_blank" rel="noopener">
                  {/* Ícono WhatsApp (22px) */}
                ...
                <a className="btn btn-mail" href="mailto:direccionjuridicakoop@hotmail.com?subject=Asesor%C3%ADa%20Resoluci%C3%B3n%20de%20Disputas%20Koop">
                  {/* ícono mail (22px) */}
