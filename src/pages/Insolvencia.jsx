...
import pageHtml from '../../old/insolvencia.html?raw';
  ...
  <>
    ...
    {/* Overlay de transición */}
      ...
      <section className="hero-section" id="inicio">
        ...
        <div className="hero-text" aria-label="Insolvencia">
          <div className="hero-headline">Insolvencia</div>
        </div>
      </section>
    
      {/* SECCIÓN CARDS */}
      <section className="labor-cards-section" id="servicios-insolvencia">
        <div className="labor-cards-container">
          <div className="labor-tag">SERVICIOS DE INSOLVENCIA</div>
          <h2 className="labor-title">Cómo te ayudamos</h2>
          <p className="labor-sub">Acompañamiento jurídico en procesos de reorganización y liquidación empresarial.</p>
    
          <div className="labor-grid">
            {/* 1. Reorganización empresarial */}
            <a href="#reorganizacion" className="labor-card" style={{ '--bg': 'url(\'img/Acompañamiento.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
                <div className="labor-card-title"><span className="labor-dot"></span>Reorganización empresarial</div>
                <div className="labor-card-desc">Procesos de recuperación y reestructuración de empresas.</div>
              </div>
            </a>
    
            {/* 2. Liquidación judicial */}
            <a href="#liquidacion" className="labor-card" style={{ '--bg': 'url(\'img/Victimas.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
                <div className="labor-card-title"><span className="labor-dot"></span>Liquidación judicial</div>
                <div className="labor-card-desc">Representación en trámites de liquidación obligatoria.</div>
              </div>
            </a>
    
            {/* 3. Acuerdos de acreedores */}
            <a href="#acreedores" className="labor-card" style={{ '--bg': 'url(\'img/donacionescambio.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
                <div className="labor-card-title"><span className="labor-dot"></span>Acuerdos de acreedores</div>
                <div className="labor-card-desc">Negociación y estructuración de acuerdos de pago.</div>
              </div>
            </a>
    
            {/* 4. Protección de activos */}
            <a href="#activos" className="labor-card" style={{ '--bg': 'url(\'img/sucesionescambio.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
                <div className="labor-card-title"><span className="labor-dot"></span>Protección de activos</div>
                <div className="labor-card-desc">Blindaje jurídico del patrimonio empresarial.</div>
              </div>
            </a>
    
            {/* 5. Recuperación de cartera */}
            <a href="#cartera" className="labor-card" style={{ '--bg': 'url(\'img/Audiencias.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
                <div className="labor-card-title"><span className="labor-dot"></span>Recuperación de cartera</div>
                <div className="labor-card-desc">Gestión de cobranzas y acciones judiciales.</div>
              </div>
            </a>
    
            {/* 6. Asesoría preventiva */}
            <a href="#preventiva" className="labor-card" style={{ '--bg': 'url(\'img/capitulaciones.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
                <div className="labor-card-title"><span className="labor-dot"></span>Asesoría preventiva</div>
                <div className="labor-card-desc">Diagnóstico financiero y soluciones tempranas.</div>
              </div>
            </a>
          </div>
        </div>
        ...
        <div className="footer-top">
          ...
          <div className="footer-brand">
            ...
            <p className="footer-copy">
              Estudio jurídico & contable. Litigio estratégico y soluciones 360° para superar crisis financieras.
            </p>
            <div className="footer-cta">
              <h4>¿Necesitas una asesoría en insolvencia?</h4>
              <div className="btns">
                <a className="btn btn-whatsapp" href="https://wa.me/573503965755?text=Cordial Saludo%20Koop,%20deseo%20asesor%C3%ADa%20en%20insolvencia%20sobre%20el%20siguiente%20tema:" target="_blank" rel="noopener">
                  {/* Ícono WhatsApp (22px) */}
                ...
                <a className="btn btn-mail" href="mailto:direccionjuridicakoop@hotmail.com?subject=Asesor%C3%ADa%20Insolvencia%20Koop">
                  {/* ícono mail (22px) */}
