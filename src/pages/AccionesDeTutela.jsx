...
const AccionesDeTutela = () => {
  ...
  <>
    ...
    {/* Overlay de transición */}
      ...
      {/* SECCIÓN CARDS */}
      <section className="labor-cards-section" id="servicios-acciones-de-tutela">
        <div className="labor-cards-container">
          <div className="labor-tag">SERVICIOS EN ACCIONES DE TUTELA</div>
          <h2 className="labor-title">Cómo te ayudamos</h2>
          <p className="labor-sub">Representación y asesoría en la interposición y seguimiento de acciones de tutela.</p>
    
          <div className="labor-grid">
            {/* 1. Redacción de acciones de tutela */}
            <a href="#diagnostico" className="labor-card" style={{ '--bg': 'url(\'img/Acompañamiento.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
                <div className="labor-card-title"><span className="labor-dot"></span>Redacción de acciones de tutela</div>
                <div className="labor-card-desc">Análisis del caso y elaboración del escrito.</div>
              </div>
            </a>
    
            {/* 2. Presentación y seguimiento */}
            <a href="#forense" className="labor-card" style={{ '--bg': 'url(\'img/Victimas.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
                <div className="labor-card-title"><span className="labor-dot"></span>Presentación y seguimiento</div>
                <div className="labor-card-desc">Radicación de la tutela y monitoreo del proceso.</div>
              </div>
            </a>
    
            {/* 3. Impugnación de fallos */}
            <a href="#controles" className="labor-card" style={{ '--bg': 'url(\'img/donacionescambio.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
                <div className="labor-card-title"><span className="labor-dot"></span>Impugnación de fallos</div>
                <div className="labor-card-desc">Elaboración de recursos contra decisiones desfavorables.</div>
              </div>
            </a>
    
            {/* 4. Cumplimiento de sentencias */}
            <a href="#canal" className="labor-card" style={{ '--bg': 'url(\'img/sucesionescambio.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
                <div className="labor-card-title"><span className="labor-dot"></span>Cumplimiento de sentencias</div>
                <div className="labor-card-desc">Gestión ante entidades para hacer efectivo el fallo.</div>
              </div>
            </a>
    
            {/* 5. Asesoría preventiva */}
            <a href="#capacitacion" className="labor-card" style={{ '--bg': 'url(\'img/Audiencias.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
                <div className="labor-card-title"><span className="labor-dot"></span>Asesoría preventiva</div>
                <div className="labor-card-desc">Orientación sobre procedencia y requisitos de la tutela.</div>
              </div>
            </a>
    
            {/* 6. Capacitación en derechos fundamentales */}
            <a href="#litigios" className="labor-card" style={{ '--bg': 'url(\'img/capitulaciones.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
                <div className="labor-card-title"><span className="labor-dot"></span>Capacitación en derechos fundamentales</div>
                <div className="labor-card-desc">Talleres y charlas para empresas y ciudadanos.</div>
              </div>
            </a>
          </div>
        </div>
        ...
        <div className="footer-top">
          ...
          <div className="footer-brand">
            ...
            <p className="footer-copy">
              Estudio jurídico & contable. Gestión integral de acciones de tutela.
            </p>
            <div className="footer-cta">
              <h4>¿Necesitas una asesoría en acciones de tutela?</h4>
              <div className="btns">
                <a className="btn btn-whatsapp" href="https://wa.me/573137213878?text=Cordial Saludo%20Koop,%20deseo%20asesor%C3%ADa%20en%20acciones%20de%20tutela%20sobre%20el%20siguiente%20tema:" target="_blank" rel="noopener">
                  {/* Ícono WhatsApp (22px) */}
                ...
                <a className="btn btn-mail" href="mailto:direccionjuridicakoop@hotmail.com?subject=Asesor%C3%ADa%20Acciones%20de%20Tutela%20Koop">
                  {/* ícono mail (22px) */}
