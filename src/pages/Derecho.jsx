      ...
      <section className="labor-cards-section" id="areas-derecho">
        <div className="labor-cards-container">
          ...
          <div className="labor-grid">
            ...
            <a href="derecho-laboral.html" className="labor-card" style={{ '--bg': 'url(\'Despidoinjustificado.jpg\')' }}>
              <div className="labor-card-content">
            ...
            <a href="tramites-notariales.html" className="labor-card" style={{ '--bg': 'url(\'img/tramitesnotariales.png\')' }}>
              <div className="labor-card-content">
            ...
            <a href="derecho-administrativo.html" className="labor-card" style={{ '--bg': 'url(\'img/contrato estatal.jpg\')' }}>
              <div className="labor-card-content">
        ...
        <div className="footer-top">
          ...
          <div className="footer-col">
            ...
            <ul className="footer-list">
              ...
              <li><a href="tramites-notariales.html">Trámites notariales</a></li>
              <li><a href="derecho-administrativo.html">Derecho administrativo</a></li>
            </ul>
          </div>
