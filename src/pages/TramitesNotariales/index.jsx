        ...
        <div className="footer-top">
          ...
          <div className="footer-col">
            ...
            <ul className="footer-list">
              ...
              <li><a href="#sucesiones">Sucesiones por causa de muerte</a></li>
              <li><a href="#capitulaciones">Capitulaciones matrimoniales y liquidación de sociedad conyugal</a></li>
              <li><a href="#levantamiento">Levantamiento de hipotecas</a></li>
              <li><a href="#donaciones">Donaciones de bienes inmuebles</a></li>
            </ul>
          </div>
