  ...
  <>
    ...
    {/* Overlay de transición */}
      ...
      <section className="hero-section" id="inicio">
        ...
        <div className="hero-text" aria-label="Contratación Pública">
          <div className="hero-headline">Contratación Pública</div>
        </div>
      </section>
    
      {/* SECCIÓN CARDS */}
      <section className="labor-cards-section" id="servicios-contratacion">
        <div className="labor-cards-container">
          <div className="labor-tag">SERVICIOS DE CONTRATACIÓN PÚBLICA</div>
          <h2 className="labor-title">Cómo te ayudamos</h2>
          <p className="labor-sub">Asesoría integral en procesos contractuales estatales y licitaciones.</p>
    
          <div className="labor-grid">
            {/* 1. Preparación de propuestas */}
            <a href="#propuestas" className="labor-card" style={{ '--bg': 'url(\'img/Acompañamiento.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
                <div className="labor-card-title"><span className="labor-dot"></span>Preparación de propuestas</div>
                <div className="labor-card-desc">Estructuración de ofertas competitivas.</div>
              </div>
            </a>
    
            {/* 2. Acompañamiento en licitaciones */}
            <a href="#licitaciones" className="labor-card" style={{ '--bg': 'url(\'img/Victimas.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
                <div className="labor-card-title"><span className="labor-dot"></span>Acompañamiento en licitaciones</div>
                <div className="labor-card-desc">Soporte durante todo el proceso de selección.</div>
              </div>
            </a>
    
            {/* 3. Defensa de oferentes */}
            <a href="#defensa" className="labor-card" style={{ '--bg': 'url(\'img/donacionescambio.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
                <div className="labor-card-title"><span className="labor-dot"></span>Defensa de oferentes</div>
                <div className="labor-card-desc">Recursos y acciones frente a decisiones administrativas.</div>
              </div>
            </a>
    
            {/* 4. Interventoría y supervisión */}
            <a href="#interventoria" className="labor-card" style={{ '--bg': 'url(\'img/sucesionescambio.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
                <div className="labor-card-title"><span className="labor-dot"></span>Interventoría y supervisión</div>
                <div className="labor-card-desc">Control de ejecución contractual.</div>
              </div>
            </a>
    
            {/* 5. Cumplimiento de pliegos */}
            <a href="#pliegos" className="labor-card" style={{ '--bg': 'url(\'img/Audiencias.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
                <div className="labor-card-title"><span className="labor-dot"></span>Cumplimiento de pliegos</div>
                <div className="labor-card-desc">Revisión de requisitos y habilitaciones.</div>
              </div>
            </a>
    
            {/* 6. Gestión de contratos estatales */}
            <a href="#gestion" className="labor-card" style={{ '--bg': 'url(\'img/capitulaciones.png\')' }}>
              <div className="labor-card-content">
                <span className="labor-badge">SERVICIO</span>
                <div className="labor-card-title"><span className="labor-dot"></span>Gestión de contratos estatales</div>
                <div className="labor-card-desc">Negociación, ejecución y cierre de contratos.</div>
              </div>
            </a>
          </div>
        </div>
        ...
        <div className="footer-top">
          ...
          <div className="footer-brand">
            ...
            <p className="footer-copy">
              Estudio jurídico & contable. Experiencia en la interacción con el Estado.
            </p>
            <div className="footer-cta">
              <h4>¿Necesitas una asesoría en contratación pública?</h4>
              <div className="btns">
                <a className="btn btn-whatsapp" href="https://wa.me/573503965755?text=Cordial%20Saludo%20Koop,%20deseo%20asesor%C3%ADa%20en%20contrataci%C3%B3n%20p%C3%BAblica%20sobre%20el%20siguiente%20tema:" target="_blank" rel="noopener">
                  {/* Ícono WhatsApp (22px) */}
                ...
                <a className="btn btn-mail" href="mailto:direccionjuridicakoop@hotmail.com?subject=Asesor%C3%ADa%20Contrataci%C3%B3n%20P%C3%BAblica%20Koop">
                  {/* ícono mail (22px) */}
